'(
  ...
  (stan-mode . [(2 5 1) nil "Major mode for editing Stan files" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languanges")) "melpa-stable"])
  (stan-snippets . [(2 5 1) ((yasnippet (0 8 0)) (stan-mode (2 5 1))) "Yasnippets for Stan" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languages")) "melpa-stable"])
