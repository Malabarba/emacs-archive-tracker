...
1. Additional faces set for temporary highlights." tar nil "melpa-stable"])
  ...
  (scala-outline-popup . [(0 3 2) ((dash (2 9 0)) (popup (0 5 1)) (scala-mode2 (0 22))) "scala file summary popup" single ((:url . "https://github.com/ancane/scala-outline-popup.el") (:keywords "scala" "structure" "summary")) "melpa-stable"])
