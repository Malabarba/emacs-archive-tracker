...
1. Additional faces set for temporary highlights." tar nil "melpa-stable"])
  ...
  (stan-mode . [(2 5 0) nil "Major mode for editing Stan files" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languanges")) "melpa-stable"])
  (stan-snippets . [(2 5 0) ((yasnippet (0 8 0)) (stan-mode (2 5 0))) "Yasnippets for Stan" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languages")) "melpa-stable"])
