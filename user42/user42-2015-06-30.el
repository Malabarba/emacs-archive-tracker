'(
  ...
  (html-sizes [cl-struct-package-desc html-sizes (15) "maintain file sizes shown for html links" nil single "user42" nil ((:url . "http://user42.tuxfamily.org/html-sizes/index.html")) nil])
