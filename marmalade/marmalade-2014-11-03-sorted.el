'(
  ...
  (alchemist . [(0 4 1) ((emacs (24)) (pkg-info (0 5))) "Elixir tooling integration into emacs" tar "marmalade"])
  ...
  (web . [(0 5 1) ((dash (2 9 0)) (s (1 5 0))) "useful HTTP client" single "marmalade"])
