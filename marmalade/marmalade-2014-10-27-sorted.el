'(
  ...
  (flycheck . [(0 21) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar "marmalade"])
  ...
  (noflet . [(0 0 14) nil "locally override functions" single "marmalade"])
