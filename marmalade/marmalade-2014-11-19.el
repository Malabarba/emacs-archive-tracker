'(
  ...
  (alchemist . [(0 6 0) ((emacs (24)) (pkg-info (0 5))) "Elixir tooling integration into emacs" tar "marmalade"])
  ...
  (evil-escape . [(1 3) ((emacs (24)) (evil (1 0 9)) (key-chord (0 6))) "Customizable key sequence to escape from insert state and everything else." single "marmalade"])
