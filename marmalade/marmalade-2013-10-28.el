'(
  ...
  (project-explorer . [(0 8) ((cl-lib (0 3)) (es-lib (0 3))) "A project explorer sidebar -*- lexical-binding: t -*-" single "marmalade"])
  ...
  (auto-indent-mode . [(0 110) nil "Auto indent Minor mode" single "marmalade"])
