'(
  ...
  (ac-nrepl . [(0 18) ((nrepl (0 1)) (auto-complete (1 4))) "auto-complete sources for Clojure using nrepl completions" single "marmalade"])
  ...
  (ack-and-a-half . [(1 1 3) nil "Yet another front-end for ack" single "marmalade"])
  ...
  (ag . [(0 20) nil "A front-end for ag ('the silver searcher'), the C ack replacement." single "marmalade"])
  ...
  (android-mode . [(0 2 3) nil "Minor mode for Android application development" single "marmalade"])
  ...
  (awk-it . [(0 76) nil "Run AWK interactively on region!" single "marmalade"])
  ...
  (bug-reference-github . [(0 1 0) nil "Automatically set `bug-reference-url-format' in Github repositories." single "marmalade"])
  ...
  (clues-theme . [(20130720 559) nil "Emacs 24 theme which is ok I suppose" single "marmalade"])
  ...
  (creole . [(1 0 1) ((noflet (0 0 3)) (kv (0 0 17))) "A parser for the Creole Wiki language" single "marmalade"])
  ...
  (dash . [(1 5 0) nil "A modern list library for Emacs" single "marmalade"])
  ...
  (desktop-registry . [(1 0 0) nil "Keep a central registry of desktop files" single "marmalade"])
  ...
  (elpy . [(1 0) ((auto-complete (1 4)) (fuzzy (0 1)) (yasnippet (0 8)) (virtualenv (1 2)) (highlight-indentation (0 5 0)) (find-file-in-project (3 2)) (idomenu (0 1)) (nose (0 1 1)) (iedit (0 97))) "Emacs Lisp Python Environment" tar "marmalade"])
  ...
  (emmet-mode . [(1 0 0) nil "Unofficial Emmet's support for emacs" single "marmalade"])
  ...
  (evil . [(1 0 6) ((undo-tree (0 6 3))) "Extensible Vi layer for Emacs." tar "marmalade"])
  (evil-leader . [(0 3 3) ((evil (0))) "let there be <leader>" single "marmalade"])
  (evil-nerd-commenter . [(0 0 8) nil "Comment/uncomment lines efficiently. Like Nerd Commenter in Vim" tar "marmalade"])
  ...
  (exec-path-from-shell . [(1 5) nil "Make Emacs use the $PATH set up by the user's shell" single "marmalade"])
  ...
  (fetchmacs . [(1 0 1) nil "A major mode for the Fetchnotes note taking service" single "marmalade"])
  (fic-ext-mode . [(0 1) nil "Show FIXME/TODO/BUG(...) in special face only in comments and strings" single "marmalade"])
  (fill-column-indicator . [(1 83) nil "Graphically indicate the fill column" single "marmalade"])
  ...
  (flycheck . [(0 13) ((s (1 6 0)) (dash (1 2)) (cl-lib (0 1)) (emacs (24 1))) "On-the-fly syntax checking (Flymake done right)" tar "marmalade"])
  ...
  (flymake-coffee . [(0 10) ((flymake-easy (0 1))) "A flymake handler for coffee script" single "marmalade"])
  ...
  (frame-restore . [(0 1) ((dash (1 2)) (emacs (24 1))) "Restore Emacs frame -*- lexical-binding: t; -*-" single "marmalade"])
  ...
  (git-commit-mode . [(0 12) nil "Major mode for editing git commit messages -*- lexical-binding: t; -*-" single "marmalade"])
  (git-gutter . [(0 42) nil "Port of Sublime Text plugin GitGutter" single "marmalade"])
  (git-gutter+ . [(0 1) nil "Manage Git hunks straight from the buffer" single "marmalade"])
  (git-gutter-fringe . [(0 12) ((git-gutter (0 42)) (fringe-helper (0 1 1))) "Fringe version of git-gutter.el" single "marmalade"])
  (git-gutter-fringe+ . [(0 1) ((git-gutter+ (0 1)) (fringe-helper (20130519 1641))) "Fringe version of git-gutter+.el" single "marmalade"])
  (gitconfig . [(1 0 0) nil "Emacs lisp interface to work with git-config variables" single "marmalade"])
  (gitconfig-mode . [(0 3) nil "Major mode for editing .gitconfig files -*- lexical-binding: t; -*-" single "marmalade"])
  ...
  (ido-gnus . [(0 3) ((gnus (5 13))) "Access gnus groups or servers using ido" single "marmalade"])
  ...
  (ido-ubiquitous . [(1 6) nil "Use ido (nearly) everywhere." single "marmalade"])
  ...
  (inf-ruby . [(2 2 7) nil "Run a ruby process in a buffer" single "marmalade"])
  ...
  (kmacro-decision . [(1 3) ((el-x (1 0)) (jb-misc-macros (0 2))) "Add conditional branching to keyboard macros" single "marmalade"])
  ...
  (less-css-mode . [(0 15) nil "Major mode for editing LESS CSS files (lesscss.org)" single "marmalade"])
  ...
  (noflet . [(0 0 8) nil "locally override functions" single "marmalade"])
  ...
  (nrepl . [(0 1 7) ((clojure-mode (2 0 0))) "Client for Clojure nREPL" single "marmalade"])
  ...
  (org-dotemacs . [(0 2) ((org (7 9 3)) (cl-lib (1 0))) "Store your emacs config as an org file, and choose which bits to load." single "marmalade"])
  ...
  (org-journal . [(1 3 4) nil "a simple org-mode based journaling mode" single "marmalade"])
  ...
  (org-trello . [(0 0 5) ((org (7 9 2)) (dash (1 4 0)) (request (0 1 0)) (cl-lib (0 3 0)) (json (1 3))) "Minor mode for org-mode to sync org-mode and trello" tar "marmalade"])
  ...
  (page-break-lines . [(0 7) nil "Display ugly ^L page breaks as tidy horizontal lines" single "marmalade"])
  ...
  (paste-kde . [(0 2 2) ((web (0 3 6))) "paste text to KDE's pastebin service" single "marmalade"])
  ...
  (processing-mode . [(1 1 0) nil "Major mode for Processing 2.0" single "marmalade"])
  ...
  (rbenv . [(0 0 2) nil "Emacs integration for rbenv" single "marmalade"])
  ...
  (redo+ . [(1 15) nil "Redo/undo system for Emacs" single "marmalade"])
  ...
  (robe . [(0 7 4) ((inf-ruby (2 2 4))) "Code navigation, documentation lookup and completion for Ruby" tar "marmalade"])
  ...
  (rubocop . [(0 1) ((dash (1 0 0))) "An Emacs interface for RuboCop" single "marmalade"])
  ...
  (s . [(1 6 1) nil "The long lost Emacs string manipulation library." single "marmalade"])
  ...
  (show-marks . [(0 3) ((fm (1 0))) "Navigate and visualize the mark-ring" single "marmalade"])
  ...
  (smartparens . [(1 4 4) ((dash (1 1 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar "marmalade"])
  ...
  (sourcetalk . [(0 0 2) ((request (0 2 0))) "SourceTalk (http://sourcetalk.net) plugin for Emacs" single "marmalade"])
  ...
  (syslog-mode . [(2 0) ((hide-lines (20130623))) "Major-mode for viewing log files" single "marmalade"])
  ...
  (web-mode . [(6 0 18) nil "major mode for editing html templates" single "marmalade"])
  ...
  (yagist . [(0 8 4) ((json (1 2 0))) "Yet Another Emacs integration for gist.github.com" single "marmalade"])
  (yaml-mode . [(0 0 7) nil "Major mode for editing YAML files" single "marmalade"])
