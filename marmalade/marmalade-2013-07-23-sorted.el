'(
  ...
  (ido-gnus . [(0 2) ((gnus (5 13))) "Access gnus groups or servers using ido" single "marmalade"])
  ...
  (web-mode . [(6 0 10) nil "major mode for editing html templates" single "marmalade"])
