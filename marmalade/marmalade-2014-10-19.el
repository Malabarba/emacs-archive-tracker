'(
  ...
  (circe . [(1 4) ((lui (1 4)) (lcs (1 1))) "Client for IRC in Emacs" tar "marmalade"])
  ...
  (dash . [(2 9 0) nil "A modern list library for Emacs" single "marmalade"])
  ...
  (org-trello . [(0 6 2) ((request-deferred (0 1 0)) (deferred (0 3 2)) (s (1 9 0)) (dash (2 8 0)) (emacs (24))) "Minor mode to synchronize org-mode buffer and trello board" tar "marmalade"])
