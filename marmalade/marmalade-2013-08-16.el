'(
  ...
  (flycheck . [(0 14) ((s (1 6 0)) (dash (1 6 0)) (cl-lib (0 1)) (emacs (24 1))) "On-the-fly syntax checking (Flymake done right)" tar "marmalade"])
  ...
  (dash . [(1 8 0) nil "A modern list library for Emacs" single "marmalade"])
