'(
  ...
  (whitespace-cleanup-mode . [(0 2) nil "Intelligently call whitespace-cleanup on save" single "marmalade"])
  ...
  (ido-ubiquitous . [(2 6) ((emacs (24 1))) "Use ido (nearly) everywhere." single "marmalade"])
