'(
  ...
  (elnode . [(0 9 9 7 8) ((web (0 1 4)) (dash (1 1 0)) (noflet (0 0 7)) (s (1 5 0)) (creole (0 8 14)) (fakir (0 1 6)) (db (0 0 5)) (kv (0 0 17))) "The Emacs webserver." tar "marmalade"])
  ...
  (org-journal . [(1 4 8) nil "a simple org-mode based journaling mode" single "marmalade"])
