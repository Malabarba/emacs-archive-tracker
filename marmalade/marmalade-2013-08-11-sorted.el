'(
  ...
  (processing-mode . [(1 1 2) nil "Major mode for Processing 2.0" single "marmalade"])
  ...
  (wisp-mode . [(0 1) nil "Major mode for editing wisp: Whitespace-to-Lisp" single "marmalade"])
