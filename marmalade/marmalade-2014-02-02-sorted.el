'(
  ...
  (evil-matchit . [(1 2 7) nil "Vim matchit ported into Emacs (requires EVIL)" tar "marmalade"])
  (evil-nerd-commenter . [(1 2 7) nil "Comment/uncomment lines efficiently. Like Nerd Commenter in Vim" tar "marmalade"])
