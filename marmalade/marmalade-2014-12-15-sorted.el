'(
  ...
  (alchemist . [(0 10 1) ((emacs (24))) "Elixir tooling integration into emacs" tar "marmalade"])
  ...
  (android-mode . [(0 3 3) nil "Minor mode for Android application development" single "marmalade"])
