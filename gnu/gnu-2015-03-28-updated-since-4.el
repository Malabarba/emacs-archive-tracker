'(
  ...
  (org [cl-struct-package-desc org (20150323) "Outline-based notes management and organizer" nil tar "gnu" nil nil nil])
  ...
  (js2-mode [cl-struct-package-desc js2-mode (20150202) "Improved JavaScript editing mode" ((emacs (24 1)) (cl-lib (0 5))) tar "gnu" nil ((:keywords "languages" "javascript") (:url . "https://github.com/mooz/js2-mode/")) nil])
  ...
  (ggtags [cl-struct-package-desc ggtags (0 8 9) "emacs frontend to GNU Global source code tagging system" ((emacs (24)) (cl-lib (0 5))) single "gnu" nil ((:url . "https://github.com/leoliu/ggtags") (:keywords "tools" "convenience")) nil])
  ...
  (debbugs [cl-struct-package-desc debbugs (0 6) "SOAP library to access debbugs servers" nil tar "gnu" nil ((:keywords "comm" "hypermedia") (:url . "http://elpa.gnu.org/packages/debbugs.html")) nil])
  (csv-mode [cl-struct-package-desc csv-mode (1 2) "Major mode for editing comma/char separated values" nil single "gnu" nil ((:url . "http://centaur.maths.qmul.ac.uk/Emacs/") (:keywords "convenience")) nil])
  ...
  (auctex [cl-struct-package-desc auctex (11 88 3) "Integrated environment for *TeX*" nil tar "gnu" nil ((:url . "http://www.gnu.org/software/auctex/")) nil])
