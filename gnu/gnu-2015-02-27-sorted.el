'(
  ...
  (ahungry-theme . [(1 0 5) ((emacs (24))) "Ahungry color theme for Emacs.  Make sure to (load-theme 'ahungry)." tar ((:keywords "ahungry" "palette" "color" "theme" "emacs" "color-theme" "deftheme") (:url . "https://github.com/ahungry/color-theme-ahungry")) "gnu"])
  ...
  (company . [(0 8 11) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:keywords "abbrev" "convenience" "matching") (:url . "http://company-mode.github.io/")) "gnu"])
  ...
  (hydra . [(0 9 0) ((cl-lib (0 5))) "Make bindings that stick around" tar ((:keywords "bindings") (:url . "https://github.com/abo-abo/hydra")) "gnu"])
  ...
  (load-relative . [(1 2) nil "relative file load (within a multi-file Emacs package)" single ((:url . "http://github.com/rocky/emacs-load-relative") (:keywords "internal")) "gnu"])
  ...
  (pabbrev . [(4 2) nil "Predictive abbreviation expansion" single ((:url . "http://elpa.gnu.org/packages/pabbrev.html") (:keywords)) "gnu"])
