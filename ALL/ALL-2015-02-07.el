'(
  ...
  (ace-window . [(20150203 730) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  ...
  (browse-at-remote . [(20150202 1107) nil "Open page at github/bitbucket from emacs buffers" single ((:keywords "github" "bitbucket")) "melpa"])
  ...
  (color-theme-sanityinc-solarized . [(20150201 1326) nil "A version of Ethan Schoonover's Solarized themes" tar nil "melpa"])
  (color-theme-sanityinc-tomorrow . [(20150201 1321) nil "A version of Chris Kempson's various Tomorrow themes" tar nil "melpa"])
  ...
  (company-cabal . [(20150121 645) ((cl-lib (0 5)) (company (0 8 0)) (emacs (24))) "company-mode cabal backend" tar ((:url . "https://github.com/iquiw/company-cabal")) "melpa"])
  ...
  (elpy . [(20141031 945) ((company (0 8 2)) (find-file-in-project (3 3)) (highlight-indentation (0 5 0)) (idomenu (0 1)) (pyvenv (1 3)) (yasnippet (0 8 0))) "Emacs Python Development Environment" tar nil "melpa"])
  ...
  (ensime . [(20150131 1620) ((s (1 3 0)) (dash (2 10 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (evil-dvorak . [(20150206 1153) ((evil (1 0 8)) (helm (0)) (helm-swoop (0)) (ace-jump-mode (2 0)) (evil-surround (0))) "evil keybindings for that work with dvorak mode" tar nil "melpa"])
  ...
  (flycheck . [(20150125 601) ((dash (2 4 0)) (pkg-info (0 4)) (let-alist (1 0 1)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (helm . [(20150206 1004) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-projectile . [(20150204 107) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (icicles . [(20150126 1726) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (js2-mode . [(20150206 1359) ((emacs (24 1)) (cl-lib (0 5))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (kakapo-mode . [(20150113 2213) ((cl-lib (0 5))) "TABS (hard or soft) for indentation (leading whitespace), and SPACES for alignment." single ((:url . "https://github.com/listx/kakapo-mode") (:keywords "indentation")) "melpa"])
  ...
  (lentic . [(20150205 1509) ((emacs (24 4)) (m-buffer (0 8)) (dash (2 5 0)) (f (0 17 2))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (neotree . [(20150131 808) nil "A tree plugin like NerdTree for Vim" tar ((:url . "https://github.com/jaypei/emacs-neotree")) "melpa"])
  ...
  (nim-mode . [(20150205 840) ((emacs (24))) "A major mode for the Nim programming language" single ((:keywords "nim" "languages")) "melpa"])
  ...
  (pdf-tools . [(20150206 1056) ((emacs (24 3)) (tablist (0 50))) "Support library for PDF documents." tar ((:keywords "files" "multimedia")) "melpa"])
  ...
  (php-mode . [(20150203 840) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (projectile . [(20150201 1134) ((dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (realgud . [(20150204 457) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (rust-mode . [(20150206 404) nil "A major emacs mode for editing Rust source code" single ((:url . "https://github.com/rust-lang/rust") (:keywords "languages")) "melpa"])
  ...
  (skeletor . [(20150105 1950) ((s (1 7 0)) (f (0 14 0)) (dash (2 2 0)) (cl-lib (0 3)) (let-alist (1 0 3)) (emacs (24 1))) "Provides project skeletons for Emacs" tar nil "melpa"])
  ...
  (smartparens . [(20150206 1045) ((cl-lib (0 3)) (dash (2 10 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (sunshine . [(20150204 339) ((cl-lib (0 5))) "Provide weather and forecast information." single ((:url . "https://github.com/aaronbieber/sunshine.el") (:keywords "tools" "weather")) "melpa"])
  ...
  (sx . [(20150203 1831) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  (symon . [(20150206 405) nil "tiny graphical system monitor" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (web-mode . [(20150204 757) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (zop-to-char . [(20150205 2151) ((cl-lib (0 5))) "A replacement of zap-to-char." single ((:url . "https://github.com/thierryvolpiatto/zop-to-char")) "melpa"])
