'(
  ...
  (abl-mode . [(20140724 635) nil "Python TDD minor mode" tar ((:url . "http://github.com/afroisalreadyinu/abl-mode")) "melpa"])
  ...
  (ace-link . [(20141230 57) ((ace-jump-mode (2 0)) (noflet (0 0 10))) "Quickly follow links using `ace-jump-mode'" single ((:url . "https://github.com/abo-abo/ace-link") (:keywords "convenience" "links")) "melpa"])
  (ace-window . [(20141229 413) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  ...
  (adoc-mode . [(20141220 1104) ((markup-faces (1 0 0))) "a major-mode for editing AsciiDoc files in Emacs" single ((:url . "https://github.com/sensorflo/adoc-mode/wiki") (:keywords "wp" "asciidoc")) "melpa"])
  ...
  (ag . [(20141221 902) ((dash (2 8 0)) (s (1 9 0)) (cl-lib (0 5))) "A front-end for ag ('the silver searcher'), the C ack replacement." single nil "melpa"])
  ...
  (alchemist . [(20141226 1310) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (android-mode . [(20141217 1043) nil "Minor mode for Android application development" single ((:url . "https://github.com/remvee/android-mode") (:keywords "tools" "processes")) "melpa"])
  ...
  (ansible-doc . [(20141223 1215) ((emacs (24 1))) "Ansible documentation Minor Mode" single ((:url . "https://github.com/lunaryorn/ansible-doc.el") (:keywords "tools" "help")) "melpa"])
  ...
  (anzu . [(20141216 146) ((cl-lib (0 5)) (emacs (24))) "Show number of matches in mode-line while searching" single ((:url . "https://github.com/syohex/emacs-anzu")) "melpa"])
  ...
  (auto-complete-sage . [(20141228 2106) ((auto-complete (1 4 0)) (sage-shell-mode (0 0 4))) "An auto-complete source for sage-shell-mode." single ((:url . "https://github.com/stakemori/auto-complete-sage") (:keywords "sage" "math" "auto-complete")) "melpa"])
  ...
  (bind-key . [(20141220 1645) nil "A simple way to manage personal keybindings" single ((:url . "https://github.com/jwiegley/use-package") (:keywords "keys" "keybinding" "config" "dotemacs")) "melpa"])
  ...
  (bookmark+ . [(20141217 1632) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (browse-kill-ring . [(20141104 1240) nil "interactively insert items from kill-ring" single ((:url . "https://github.com/browse-kill-ring/browse-kill-ring") (:keywords "convenience")) "melpa"])
  ...
  (chinese-fonts-setup . [(20141224 2057) nil "A fonts config tool enforcing double-width Chinese character display" single ((:url . "https://github.com/tumashu/chinese-fonts-setup")) "melpa"])
  ...
  (cider . [(20141227 1232) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clj-refactor . [(20141228 751) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 8 1))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (clojure-mode . [(20141219 1217) ((emacs (24 1))) "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "clojure" "clojurescript" "lisp")) "melpa"])
  ...
  (coffee-mode . [(20141216 620) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (company . [(20141229 2029) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-ycmd . [(20141224 136) ((ycmd (0 1)) (company (0 8 3)) (deferred (0 2 0)) (s (1 0 0))) "company-mode backend for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (cpputils-cmake . [(20141217 1652) nil "Easy real time C++ syntax check and intellisense if you use CMake" tar nil "melpa"])
  ...
  (crosshairs . [(20141129 327) ((hl-line+ (0)) (col-highlight (0)) (vline (0))) "Highlight the current line and column." single ((:url . "http://www.emacswiki.org/crosshairs.el") (:keywords "faces" "frames" "emulation" "highlight" "cursor" "accessibility")) "melpa"])
  ...
  (ddskk . [(20141229 2214) ((cdb (20141201 754))) "Simple Kana to Kanji conversion program." tar nil "melpa"])
  ...
  (dic-lookup-w3m . [(20141114 437) ((w3m (20120723 324)) (stem (20120826))) "look up dictionaries on the Internet" tar ((:keywords "emacs-w3m" "w3m" "dictionary")) "melpa"])
  ...
  (diff-hl . [(20141216 1947) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  ...
  (dired+ . [(20141025 2126) nil "Extensions to Dired." single ((:url . "http://www.emacswiki.org/dired+.el") (:keywords "unix" "mouse" "directories" "diredp" "dired")) "melpa"])
  ...
  (dired-subtree . [(20141221 1009) ((dash (2 5 0)) (dired-hacks-utils (0 0 1))) "Insert subdirectories in a tree-like fashion" single ((:keywords "files")) "melpa"])
  ...
  (ebib . [(20141220 113) ((dash (2 5 0)) (parsebib (1 0)) (emacs (24 3))) "a BibTeX database manager" tar ((:keywords "text" "bibtex")) "melpa"])
  ...
  (edit-server . [(20141018 1903) nil "server that responds to edit requests from Chrome" single ((:url . "https://github.com/stsquad/emacs_chrome")) "melpa"])
  ...
  (editorconfig . [(20141220 1810) nil "EditorConfig Emacs extension" single ((:url . "http://github.com/editorconfig/editorconfig-emacs#readme")) "melpa"])
  ...
  (egison-mode . [(20141225 2235) nil "Egison editing mode" single ((:url . "https://github.com/egisatoshi/egison3/blob/master/elisp/egison-mode.el")) "melpa"])
  ...
  (ein . [(20141226 1148) ((websocket (1 3)) (request (0 2))) "Emacs IPython Notebook" tar nil "melpa"])
  ...
  (el-get . [(20141225 943) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elixir-mode . [(20141226 1103) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (elx . [(20141207 523) ((emacs (24 4))) "extract information from Emacs Lisp libraries" single ((:url . "https://github.com/tarsius/elx") (:keywords "docs" "libraries" "packages")) "melpa"])
  ...
  (ensime . [(20141229 1319) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (ess . [(20141226 1023) nil "No description available." tar nil "melpa"])
  ...
  (eval-in-repl . [(20141229 1029) ((dash (0 0 0)) (paredit (0 0 0))) "Consistent ESS-like eval interface for various REPLs" tar nil "melpa"])
  ...
  (evil . [(20141228 901) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-jumper . [(20141223 1217) ((evil (0))) "Jump like vimmers do!" single ((:url . "https://github.com/bling/evil-jumper") (:keywords "evil" "vim" "jumplist" "jump" "list")) "melpa"])
  ...
  (evil-snipe . [(20141224 2315) ((evil (1 0 9))) "emulate vim-sneak & vim-seek" single ((:url . "https://github.com/hlissner/evil-snipe") (:keywords "emulation" "vim" "evil" "sneak" "seek")) "melpa"])
  ...
  (f . [(20140828 716) ((s (1 7 0)) (dash (2 2 0))) "Modern API for working with files and directories" single ((:url . "http://github.com/rejeep/f.el") (:keywords "files" "directories")) "melpa"])
  ...
  (face-remap+ . [(20140928 1644) nil "No description available." single nil "melpa"])
  ...
  (floobits . [(20141213 2328) ((json (1 2)) (highlight (0))) "Floobits plugin for real-time collaborative editing" tar ((:url . "http://github.com/Floobits/floobits-emacs") (:keywords "comm" "tools")) "melpa"])
  ...
  (flycheck . [(20141224 16) ((dash (2 4 0)) (pkg-info (0 4)) (let-alist (1 0 1)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (flycheck-irony . [(20141218 1438) ((emacs (24 1)) (flycheck (0 22 -3 1)) (irony (0 2 0 -3 2))) "Flycheck: C/C++ support via Irony" single ((:url . "https://github.com/Sarcasm/flycheck-irony/") (:keywords "convenience" "tools" "c")) "melpa"])
  ...
  (flycheck-ocaml . [(20141225 547) ((emacs (24 1)) (flycheck (0 22 -3 1)) (merlin (2 0)) (let-alist (1 0 3))) "Flycheck: OCaml support" single ((:url . "https://github.com/flycheck/flycheck-ocaml") (:keywords "convenience" "tools" "languages")) "melpa"])
  (flycheck-package . [(20141229 803) ((cl-lib (0 5)) (flycheck (0 22 -3 1)) (emacs (24))) "A Flycheck checker for elisp package authors" single ((:keywords "lisp")) "melpa"])
  ...
  (flycheck-ycmd . [(20141227 26) ((emacs (24)) (flycheck (0 22)) (ycmd (20141217 453))) "flycheck integration for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (fountain-mode . [(20141214 2139) ((s (1 9 0))) "Major mode for screenwriting in Fountain markup" single ((:url . "https://github.com/rnkn/fountain-mode") (:keywords "wp")) "melpa"])
  (fpaste . [(0 1 3) nil "Send text to http://fpaste.org" single "marmalade"])
  (frame-cmds . [(20141210 105) ((frame-fns (0))) "Frame and window commands (interactive functions)." single ((:url . "http://www.emacswiki.org/frame-cmds.el") (:keywords "internal" "extensions" "mouse" "frames" "windows" "convenience")) "melpa"])
  ...
  (geiser . [(20141228 1746) nil "GNU Emacs and Scheme talk to each other" tar nil "melpa"])
  ...
  (git-gutter . [(20141221 634) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (gnuplot . [(20141222 1003) nil "drive gnuplot from within emacs" tar ((:keywords "gnuplot" "plotting")) "melpa"])
  ...
  (google-translate . [(20141110 1612) nil "Emacs interface to Google Translate." tar nil "melpa"])
  ...
  (goto-last-change . [(20141217 1250) nil "Move point through buffer-undo-list positions" single ((:url . "https://github.com/camdez/goto-last-change.el") (:keywords "convenience")) "melpa"])
  ...
  (guide-key . [(20141214 457) ((dash (2 10 0)) (popwin (0 3 0)) (s (1 9 0))) "Guide the following key bindings automatically and dynamically" single ((:url . "https://github.com/kai2nenobu/guide-key") (:keywords "help" "convenience")) "melpa"])
  ...
  (haskell-mode . [(20141228 359) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141227 2208) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-dash . [(20141218 714) ((helm (0 0 0)) (cl-lib (0 5))) "Offline documentation browser for +150 APIs using Dash docsets." single ((:url . "http://github.com/areina/helm-dash") (:keywords "docs")) "melpa"])
  ...
  (helm-gtags . [(20141229 2129) ((helm (1 5 6)) (cl-lib (0 5))) "GNU GLOBAL helm interface" single ((:url . "https://github.com/syohex/emacs-helm-gtags")) "melpa"])
  ...
  (helm-projectile . [(20141220 739) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (hide-comnt . [(20141105 1922) nil "Hide/show comments in code." single ((:url . "http://www.emacswiki.org/hide-comnt.el") (:keywords "comment" "hide" "show")) "melpa"])
  ...
  (hl-line+ . [(20141129 306) nil "Extensions to hl-line.el." single ((:url . "http://www.emacswiki.org/hl-line+.el") (:keywords "highlight" "cursor" "accessibility")) "melpa"])
  ...
  (hy-mode . [(20141223 810) nil "Major mode for Hy code" single ((:url . "http://github.com/hylang/hy-mode") (:keywords "languages" "lisp")) "melpa"])
  ...
  (icicles . [(20141215 1749) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  (icomplete+ . [(20141122 1832) nil "Extensions to `icomplete.el'." single ((:url . "http://www.emacswiki.org/icomplete+.el") (:keywords "help" "abbrev" "internal" "extensions" "local" "completion" "matching")) "melpa"])
  ...
  (image-archive . [(20141229 1917) ((emacs (24)) (cl-lib (0 5))) "Image thumbnails in archive file with non-blocking" single ((:url . "https://github.com/mhayashi1120/Emacs-image-archive/raw/master/image-archive.el") (:keywords "multimedia")) "melpa"])
  ...
  (inf-clojure . [(20141224 1048) ((emacs (24 1)) (clojure-mode (4 0))) "an inferior-clojure mode" single ((:url . "http://github.com/clojure-emacs/inf-clojure") (:keywords "processes" "clojure")) "melpa"])
  ...
  (iplayer . [(20140724 1140) nil "Browse and download BBC TV/radio shows" single ((:keywords "multimedia")) "melpa"])
  ...
  (jasminejs-mode . [(20141229 1713) nil "A minor mode for manipulating jasmine test files" tar ((:url . "https://github.com/stoltene2/jasminejs-mode") (:keywords "javascript" "jasmine")) "melpa"])
  ...
  (js2-mode . [(20141228 1708) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (julia-mode . [(20141224 402) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (jump-char . [(20140918 1934) nil "navigation by char" single ((:url . "https://github.com/lewang/jump-char")) "melpa"])
  ...
  (lacarte . [(20141128 2014) nil "Execute menu items as commands, with completion." single ((:url . "http://www.emacswiki.org/lacarte.el") (:keywords "menu-bar" "menu" "command" "help" "abbrev" "minibuffer" "keys" "completion" "matching" "local" "internal" "extensions")) "melpa"])
  ...
  (ledger-mode . [(20141227 1612) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  (leerzeichen . [(20141216 1201) nil "Minor mode to display whitespace characters." single ((:url . "http://github.com/fgeller/leerzeichen.el") (:keywords "whitespace" "characters")) "melpa"])
  ...
  (lentic . [(20141227 546) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (leuven-theme . [(20141226 317) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (lispy . [(20141227 937) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (m-buffer . [(20141219 421) ((dash (2 8 0)) (emacs (24 3))) "List-Oriented, Functional Buffer Manipulation" tar nil "melpa"])
  ...
  (malabar-mode . [(20141229 2001) ((fringe-helper (1 0 1))) "A better Java mode for Emacs" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "language" "malabar")) "melpa"])
  (malinka . [(20141219 1537) ((s (1 9 0)) (dash (2 4 0)) (f (0 11 0)) (cl-lib (0 3)) (rtags (0 0)) (projectile (0 11 0))) "A C/C++ project configuration package for Emacs" single ((:url . "https://github.com/LefterisJP/malinka") (:keywords "c" "c++" "project-management")) "melpa"])
  ...
  (mandoku-meta-zb . [(20141225 2152) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (menu-bar+ . [(20141210 2353) nil "Extensions to `menu-bar.el'." single ((:url . "http://www.emacswiki.org/menu-bar+.el") (:keywords "internal" "local" "convenience")) "melpa"])
  (merlin . [(20141225 431) nil "Mode for Merlin, an assistant for OCaml." tar ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (moe-theme . [(20141218 1908) nil "A colorful eye-candy theme. Moe, moe, kyun!" tar nil "melpa"])
  ...
  (multiple-cursors . [(20141226 1042) nil "Multiple cursors for Emacs." tar nil "melpa"])
  ...
  (neotree . [(20141228 1917) nil "A tree plugin like NerdTree for Vim" single ((:url . "https://github.com/jaypei/emacs-neotree")) "melpa"])
  ...
  (niflheim-theme . [(20141215 904) nil "A port of the Nifleim theme to Emacs" single ((:url . "https://github.com/niflheim-theme/emacs") (:keywords "themes")) "melpa"])
  ...
  (omnisharp . [(20141219 950) ((json (1 2)) (flycheck (0 21)) (dash (20141201 2206)) (auto-complete (1 4)) (popup (0 5 1)) (csharp-mode (0 8 7)) (cl-lib (0 5))) "Omnicompletion (intellisense) and more for C#" tar ((:url . "https://github.com/sp3ctum/omnisharp-emacs") (:keywords "csharp" "c#" "ide" "auto-complete" "intellisense")) "melpa"])
  ...
  (org . [(20141229) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-cliplink . [(20141218 1305) nil "insert org-mode link for URL from the clipboard" single ((:url . "http://github.com/rexim/org-cliplink")) "melpa"])
  (org-context . [(20140808 158) nil "Contextual capture and agenda commands for Org-mode" single ((:url . "https://github.com/thisirs/org-context") (:keywords "org" "capture" "agenda" "convenience")) "melpa"])
  (org-cua-dwim . [(20120202 2134) nil "Org-mode and Cua mode compatibility layer" single ((:keywords "org-mode" "cua-mode")) "melpa"])
  (org-dotemacs . [(20141227 622) ((org (7 9 3)) (cl-lib (1 0))) "Store your emacs config as an org file, and choose which bits to load." single ((:url . "https://github.com/vapniks/org-dotemacs") (:keywords "local")) "melpa"])
  ...
  (org-projectile . [(20141220 2045) ((projectile (0 11 0))) "Repository todo management for org-mode" single ((:url . "https://github.com/IvanMalison/org-projectile") (:keywords "org" "projectile" "todo")) "melpa"])
  ...
  (orgtbl-aggregate . [(20141215 1239) nil "Create an aggregated Org table from another one" tar ((:keywords "org" "table" "aggregation" "filtering")) "melpa"])
  ...
  (p4 . [(20141121 842) nil "Simple Perforce-Emacs Integration" single ((:url . "https://github.com/gareth-rees/p4.el")) "melpa"])
  ...
  (package-build . [(20141219 1350) ((cl-lib (0 2))) "Tools for assembling a package archive" single ((:keywords "tools")) "melpa"])
  ...
  (packed . [(20141211 904) ((cl-lib (0 5))) "package manager agnostic Emacs Lisp package utilities" single ((:url . "https://github.com/tarsius/packed") (:keywords "compile" "convenience" "lisp" "package" "library")) "melpa"])
  ...
  (palette . [(20141217 2353) ((hexrgb (0))) "Color palette useful with RGB, HSV, and color names" single ((:url . "http://www.emacswiki.org/palette.el") (:keywords "color" "rgb" "hsv" "hexadecimal" "face" "frame")) "melpa"])
  ...
  (pandoc-mode . [(20141216 1513) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (parsebib . [(20141219 1410) ((emacs (24 3))) "A library for parsing bib files" single ((:keywords "text" "bibtex")) "melpa"])
  ...
  (php-mode . [(20141229 1858) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (popup-switcher . [(20141224 326) ((cl-lib (0 3)) (popup (0 5 0))) "switch to other buffers and files via popup." single ((:url . "https://github.com/kostafey/popup-switcher") (:keywords "popup" "switch" "buffers" "functions")) "melpa"])
  ...
  (projectile . [(20141229 1225) ((s (1 6 0)) (f (0 17 1)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20141229 955) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0)) (rake (0 2 0))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (python-django . [(20140614 2014) nil "A Jazzy package for managing Django projects" single ((:url . "https://github.com/fgallina/python-django.el") (:keywords "languages")) "melpa"])
  ...
  (racket-mode . [(20141229 1217) ((emacs (24 3))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (rake . [(20141229 245) ((f (0 13 0)) (dash (1 5 0)) (cl-lib (0 5))) "Run rake commands" single ((:url . "https://github.com/asok/rake.el") (:keywords "rake" "ruby")) "melpa"])
  ...
  (realgud . [(20141228 1612) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (restclient . [(20141222 543) nil "An interactive HTTP client for Emacs" single ((:keywords "http")) "melpa"])
  ...
  (rspec-mode . [(20141108 929) ((ruby-mode (1 0)) (cl-lib (0 4))) "Enhance ruby-mode for RSpec" tar ((:url . "http://github.com/pezra/rspec-mode") (:keywords "rspec" "ruby")) "melpa"])
  (rtags . [(20141226 1512) nil "No description available." tar nil "melpa"])
  ...
  (rust-mode . [(20141214 337) nil "A major emacs mode for editing Rust source code" single ((:url . "https://github.com/rust-lang/rust") (:keywords "languages")) "melpa"])
  (rvm . [(20140601 458) nil "Emacs integration for rvm" single ((:url . "http://www.emacswiki.org/emacs/RvmEl") (:keywords "ruby" "rvm")) "melpa"])
  ...
  (sage-shell-mode . [(20141228 347) ((cl-lib (0 5)) (deferred (0 3 2))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (shakespeare-mode . [(20141214 923) nil "A major mode for editing Shakespearean templates." single ((:url . "http://github.com/CodyReichert/shakespeare-mode") (:keywords "shakespeare" "hamlet" "lucius" "julius" "mode")) "melpa"])
  ...
  (shelldoc . [(20141222 256) ((cl-lib (0 3)) (s (1 9 0))) "shell command editing support with man page." single ((:url . "http://github.com/mhayashi1120/Emacs-shelldoc/raw/master/shelldoc.el") (:keywords "applications")) "melpa"])
  ...
  (shm . [(20141216 818) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (slime . [(20141224 705) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (sly . [(20141227 1544) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (smart-mode-line . [(20141229 1049) ((emacs (24 3)) (dash (2 2 0)) (rich-minority (0 1))) "A color coded smart mode-line." tar ((:url . "http://github.com/Bruce-Connor/smart-mode-line") (:keywords "mode-line" "faces" "theme" "themes")) "melpa"])
  ...
  (smartparens . [(20141207 1220) ((cl-lib (0 3)) (dash (2 6 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (soundklaus . [(20141225 954) ((dash (1 5 0)) (emacs (24)) (emms (3 0)) (deferred (0 3 2)) (s (1 6 0)) (pkg-info (0 4)) (cl-lib (0 5))) "Play SoundCloud music in Emacs via EMMS" single ((:url . "https://github.com/r0man/soundklaus.el") (:keywords "soundcloud" "music" "emms")) "melpa"])
  ...
  (sparkline . [(20141222 706) ((cl-lib (0 3))) "Make sparkline images from a list of numbers" single ((:keywords "extensions")) "melpa"])
  ...
  (spotify . [(20141214 823) nil "Control the spotify application from emacs" single ((:url . "https://github.com/remvee/spotify-el") (:keywords "convenience")) "melpa"])
  ...
  (sx . [(20141227 1453) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 1))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes." tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tern-django . [(20141208 12) ((emacs (24)) (tern (0 0 1)) (f (0 17 1))) "Create tern projects for django applications." tar ((:url . "https://github.com/proofit404/tern-django")) "melpa"])
  ...
  (traad . [(20141214 2202) ((deferred (0 3 2)) (popup (0 5 0)) (request (0 2 0)) (request-deferred (0 2 0)) (python-environment (0 0 2))) "emacs interface to the traad refactoring server." tar ((:url . "https://github.com/abingham/traad")) "melpa"])
  ...
  (twittering-mode . [(20141214 739) nil "Major mode for Twitter" single ((:url . "http://twmode.sf.net/") (:keywords "twitter" "web")) "melpa"])
  ...
  (use-package . [(20141220 1645) ((bind-key (1 0)) (diminish (0 44))) "A use-package declaration for simplifying your .emacs" single ((:url . "https://github.com/jwiegley/use-package") (:keywords "dotemacs" "startup" "speed" "config" "package")) "melpa"])
  ...
  (vlf . [(20141226 1634) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (web-mode . [(20141229 1212) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (widget-mvc . [(20141226 1625) nil "MVC framework for the emacs widgets" single ((:keywords "lisp" "widget")) "melpa"])
  (wiki . [(20140928 1644) nil "No description available." single nil "melpa"])
  ...
  (wn-mode . [(20141206 1542) nil "No description available." single nil "melpa"])
  ...
  (writeroom-mode . [(20141112 1650) nil "Minor mode for distraction-free writing" tar ((:keywords "text")) "melpa"])
  ...
  (wsd-mode . [(20141221 2302) nil "Emacs major-mode for www.websequencediagrams.com" tar ((:url . "https://github.com/josteink/wsd-mode") (:keywords "wsd" "diagrams" "design" "process" "modelling" "uml")) "melpa"])
