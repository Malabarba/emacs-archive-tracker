'(
  ...
  (alchemist . [(20150113 1109) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (amd-mode . [(20150110 1003) ((projectile (0 10 0)) (s (1 9 0)) (f (0 16 2)) (dash (2 5 0)) (makey (0 3)) (js2-mode (20140114)) (js2-refactor (0 6 1))) "Minor mode for handling JavaScript AMD module requirements." single ((:keywords "javascript" "amd" "projectile")) "melpa"])
  ...
  (anaconda-mode . [(20150111 1101) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (chinese-pyim . [(20150114 1715) ((cl-lib (0 5))) "Chinese pinyin input method" tar ((:url . "https://github.com/tumashu/chinese-pyim") (:keywords "convenience" "chinese" "pinyin" "input-method")) "melpa"])
  ...
  (clocker . [(20150113 2126) ((projectile (0 11 0)) (dash (2 10))) "Note taker and clock-in enforcer" single ((:keywords "org")) "melpa"])
  ...
  (company-anaconda . [(20150111 941) ((company (0 8 0)) (anaconda-mode (0 1 0)) (cl-lib (0 5 0))) "Anaconda backend for company-mode" single ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (dyalog-mode . [(20150114 303) ((cl-lib (0 2))) "Major mode for editing Dyalog APL source code" tar ((:url . "https://bitbucket.org/harsman/dyalog-mode/") (:keywords "languages")) "melpa"])
  ...
  (ensime . [(20150112 1251) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (evil-snipe . [(20150108 2127) ((evil (1 0 9))) "emulate vim-sneak & vim-seek" single ((:url . "https://github.com/hlissner/evil-snipe") (:keywords "emulation" "vim" "evil" "sneak" "seek")) "melpa"])
  ...
  (ewmctrl . [(20150110 1807) nil "use `wmctrl' to manage desktop windows." single ((:keywords "desktop" "windows")) "melpa"])
  ...
  (flycheck . [(20150114 258) ((dash (2 4 0)) (pkg-info (0 4)) (let-alist (1 0 1)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (flycheck-rust . [(20141217 624) ((emacs (24 1)) (flycheck (0 20)) (dash (2 4 0))) "Flycheck: Rust additions and Cargo support" single ((:url . "https://github.com/flycheck/flycheck-rust") (:keywords "tools" "convenience")) "melpa"])
  ...
  (fsharp-mode . [(20141125 1614) ((auto-complete (1 4)) (popup (0 5)) (pos-tip (0 4 5)) (s (1 3 1)) (dash (1 1 0))) "F# mode for Emacs" tar nil "melpa"])
  ...
  (ggtags . [(20141210 1938) ((emacs (24)) (cl-lib (0 5))) "emacs frontend to GNU Global source code tagging system" single ((:url . "https://github.com/leoliu/ggtags") (:keywords "tools" "convenience")) "melpa"])
  ...
  (gotest . [(20150108 127) ((s (1 9 0)) (f (0 11 0)) (go-mode (20131222))) "Launch GO unit tests" single ((:url . "https://github.com/nlamirault/gotest.el") (:keywords "go" "tests")) "melpa"])
  ...
  (haskell-emacs . [(20150105 1229) nil "write emacs extensions in haskell" tar ((:url . "https://github.com/knupfer/haskell-emacs") (:keywords "haskell" "emacs" "ffi")) "melpa"])
  ...
  (hl-anything . [(20150114 906) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more." tar nil "melpa"])
  ...
  (icicles . [(20150111 1915) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (idris-mode . [(20150104 1217) ((emacs (24))) "Major mode for editing Idris code" tar ((:url . "https://github.com/idris-hackers/idris-mode") (:keywords "languages")) "melpa"])
  ...
  (live-code-talks . [(20150114 1725) ((emacs (24)) (cl-lib (0 5)) (narrowed-page-navigation (0 1))) "Support for slides with live code in them" single ((:keywords "docs" "multimedia")) "melpa"])
  ...
  (malabar-mode . [(20150114 810) ((fringe-helper (1 0 1))) "JVM Integration mode for EMACS" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "groovy" "language" "malabar")) "melpa"])
  ...
  (mandoku-meta-zb . [(20150113 2255) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (names . [(20150114 554) ((emacs (24 1)) (cl-lib (0 5))) "Namespaces for emacs-lisp. Avoid name clobbering without hiding symbols." tar ((:url . "http://github.com/Bruce-Connor/names") (:keywords "extensions" "lisp")) "melpa"])
  ...
  (rope-read-mode . [(20150112 718) nil "Rearrange lines to read text smoothly" single ((:url . "https://github.com/marcowahl/rope-read-mode") (:keywords "convenience")) "melpa"])
  ...
  (sage-shell-mode . [(20150113 2131) ((cl-lib (0 5)) (deferred (0 3 1))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (shm . [(20150111 1040) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (tern-django . [(20141207 1036) ((emacs (24)) (tern (0 0 1)) (f (0 17 1))) "Create tern projects for django applications." tar ((:url . "https://github.com/proofit404/tern-django")) "melpa"])
  ...
  (visual-fill-column . [(20150114 1531) ((emacs (24 3))) "fill-column for visual-line-mode" single nil "melpa"])
  ...
  (web-mode . [(20150114 337) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (writeroom-mode . [(20150114 1629) ((emacs (24 1)) (visual-fill-column (1 1))) "Minor mode for distraction-free writing" tar ((:keywords "text")) "melpa"])
  ...
  (wsd-mode . [(20150110 1027) nil "Emacs major-mode for www.websequencediagrams.com" tar ((:url . "https://github.com/josteink/wsd-mode") (:keywords "wsd" "diagrams" "design" "process" "modelling" "uml")) "melpa"])
