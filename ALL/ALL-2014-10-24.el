'(
  ...
  (ace-isearch . [(20141018 340) ((ace-jump-mode (2 0)) (helm-swoop (1 4)) (emacs (24))) "A seamless bridge between isearch and ace-jump-mode" single ((:url . "https://github.com/tam17aki/ace-isearch")) "melpa"])
  ...
  (ace-jump-zap . [(20140923 1913) ((ace-jump-mode (1 0))) "Character zapping, `ace-jump-mode` style" single ((:url . "https://github.com/waymondo/ace-jump-zap") (:keywords "convenience" "tools" "extensions")) "melpa"])
  ...
  (aggressive-indent . [(20141023 213) ((emacs (24 1)) (names (0 5)) (cl-lib (0 5))) "Minor mode to aggressively keep your code always indented" single ((:url . "http://github.com/Bruce-Connor/aggressive-indent-mode") (:keywords "indent" "lisp" "maint" "tools")) "melpa"])
  ...
  (alchemist . [(20141023 1201) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (cask . [(20141023 1218) ((s (1 8 0)) (dash (2 2 0)) (f (0 16 0)) (epl (0 5)) (shut-up (0 1 0)) (cl-lib (0 3)) (package-build (0 1))) "Cask: Project management for Emacs package development" tar ((:url . "http://github.com/cask/cask") (:keywords "speed" "convenience")) "melpa"])
  ...
  (cg . [(20140823 320) nil "major mode for editing Constraint Grammar files" single ((:url . "http://beta.visl.sdu.dk/constraint_grammar.html") (:keywords "languages")) "melpa"])
  ...
  (cider . [(20141023 617) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (company . [(20141018 1230) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-ycmd . [(20140918 337) ((ycmd (0 1)) (company (0 8 3)) (deferred (0 2 0))) "company-mode backend for ycmd ;" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (dired-k . [(20141013 651) ((cl-lib (0 5)) (emacs (24))) "highlight dired buffer by file size, modified time, git status" tar ((:url . "https://github.com/syohex/emacs-dired-k")) "melpa"])
  ...
  (el-get . [(20141023 1608) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elixir-mode . [(20141005 920) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (elpa-mirror . [(20140902 37) nil "ELPA mirror from locally installed packages is easy" tar nil "melpa"])
  ...
  (ensime . [(20141023 140) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (ess . [(20141023 15) nil "No description available." tar nil "melpa"])
  ...
  (evil . [(20141020 150) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-lisp-state . [(20141021 2016) ((evil (1 0 9)) (smartparens (1 6 1))) "An evil state to navigate Lisp code and modify it with smartparens" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  ...
  (fish-mode . [(20140908 2357) ((emacs (24))) "Major mode for fish shell scripts" single ((:keywords "fish" "shell")) "melpa"])
  ...
  (flycheck . [(20141020 724) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (fsharp-mode . [(20140828 859) ((auto-complete (1 4)) (popup (0 5)) (pos-tip (0 4 5)) (s (1 3 1)) (dash (1 1 0))) "F# mode for Emacs" tar nil "melpa"])
  ...
  (git-gutter . [(20141007 2327) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (go-mode . [(20140905 2210) nil "Major mode for the Go programming language" single ((:url . "https://github.com/dominikh/go-mode.el") (:keywords "languages" "go")) "melpa"])
  ...
  (grails-mode . [(20120510 1555) nil "minor-mode that adds some Grails project management to a grails project" single ((:url . "http://blog.wolfman.com")) "melpa"])
  ...
  (haskell-mode . [(20141023 746) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141022 916) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-dash . [(20141020 726) ((helm (0 0 0))) "Helm extension to search dash docsets" single ((:url . "http://github.com/areina/helm-dash") (:keywords "docs")) "melpa"])
  ...
  (helm-projectile . [(20141023 47) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (js2-closure . [(20141023 1453) ((js2-mode (20140114))) "Google Closure dependency manager" single ((:url . "http://github.com/jart/js2-closure")) "melpa"])
  ...
  (json-reformat . [(20141009 1155) nil "Reformatting tool for JSON" single ((:url . "https://github.com/gongo/json-reformat") (:keywords "json")) "melpa"])
  ...
  (leuven-theme . [(20141022 218) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (logstash-conf . [(20141022 1434) nil "basic mode for editing logstash configuration" single nil "melpa"])
  ...
  (lua-mode . [(20141021 1422) nil "a major-mode for editing Lua scripts" single ((:url . "http://immerrr.github.com/lua-mode") (:keywords "languages" "processes" "tools")) "melpa"])
  (lui . [(20141003 434) ((tracking (0))) "Linewise User Interface" tar nil "melpa"])
  (lush-theme . [(20141022 127) ((emacs (24))) "A dark theme with strong colors" single ((:url . "https://github.com/andre-richter/emacs-lush-theme") (:keywords "theme" "dark" "strong colors")) "melpa"])
  ...
  (magit . [(20141023 357) ((cl-lib (0 3)) (git-commit-mode (0 14 0)) (git-rebase-mode (0 14 0))) "control Git from Emacs" tar ((:keywords "vc" "tools")) "melpa"])
  ...
  (maker-mode . [(20141022 731) ((s (1 3 0)) (dash (2 8 0))) "Emacs mode for maker (scala build tool)" single ((:url . "https://github.com/fommil/maker-mode") (:keywords "processes" "tools")) "melpa"])
  ...
  (malinka . [(20140807 1443) ((s (1 9 0)) (dash (2 4 0)) (f (0 11 0)) (cl-lib (0 3)) (rtags (0 0)) (projectile (0 11 0))) "A C/C++ project configuration package for Emacs" single ((:url . "https://github.com/LefterisJP/malinka") (:keywords "c" "c++" "project-management")) "melpa"])
  ...
  (mandoku . [(20141014 2234) ((org (8 0))) "A tool to access repositories of premodern Chinese texts" tar nil "melpa"])
  (mandoku-meta-zb . [(20141022 2322) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (marmalade-upload . [(20141023 425) nil "No description available." tar nil "melpa"])
  ...
  (merlin . [(20141020 1052) nil "Mode for Merlin, an assistant for OCaml." tar ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (monroe . [(20141021 1705) nil "Yet another client for nREPL" single ((:url . "http://www.github.com/sanel/monroe") (:keywords "languages" "clojure" "nrepl" "lisp")) "melpa"])
  ...
  (multiple-cursors . [(20141022 339) nil "Multiple cursors for Emacs." tar nil "melpa"])
  ...
  (names . [(20141019 1833) ((emacs (24 1)) (cl-lib (0 5))) "Namespaces for emacs-lisp. Works like C++ namespaces to avoid name clobbering." tar ((:url . "http://github.com/Bruce-Connor/names")) "melpa"])
  ...
  (noflet . [(20141023 856) nil "locally override functions" single ((:url . "https://github.com/nicferrier/emacs-noflet") (:keywords "lisp")) "melpa"])
  (nose . [(20140520 948) nil "Easy Python test running in Emacs" single ((:keywords "nose" "python" "testing")) "melpa"])
  (notmuch . [(20140924 1055) nil "No description available." tar nil "melpa"])
  ...
  (nu-mode . [(20141023 1521) ((undo-tree (0 6 5)) (helm (20140902 1005))) "Modern Emacs Prompts Based Keybinding." tar nil "melpa"])
  ...
  (omnisharp . [(20141015 1241) ((json (1 2)) (dash (1 8 0)) (popup (0 5)) (auto-complete (1 4)) (flycheck (0 19)) (csharp-mode (0 8 6))) "Omnicompletion (intellisense) and more for C#" single ((:url . "https://github.com/sp3ctum/omnisharp-emacs") (:keywords "csharp" "c#" "ide" "auto-complete" "intellisense")) "melpa"])
  ...
  (org-toc . [(20141017 2139) nil "add table of contents to org-mode files" single ((:url . "https://github.com/snosov1/org-toc") (:keywords "org-mode" "org" "toc" "table" "of" "contents")) "melpa"])
  ...
  (organic-green-theme . [(20140925 739) nil "Low-contrast green color theme." single nil "melpa"])
  ...
  (pallet . [(20140819 1256) ((cask (0 6))) "A package management tool for Emacs, using Cask." tar nil "melpa"])
  ...
  (pcmpl-homebrew . [(20141023 446) nil "pcomplete for homebrew" single ((:keywords "pcomplete" "homebrew" "tools")) "melpa"])
  (pcmpl-pip . [(20141023 528) nil "pcomplete for pip" single ((:keywords "pcomplete" "pip" "python" "tools")) "melpa"])
  ...
  (php-mode . [(20141022 2216) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (projectile . [(20141023 47) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20141008 100) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (quickrun . [(20141018 557) nil "Run commands quickly" single ((:url . "https://github.com/syohex/emacs-quickrun")) "melpa"])
  ...
  (rainbow-delimiters . [(20141017 929) nil "Highlight nested parens, brackets, braces a different color at each depth." single ((:url . "http://github.com/jlr/rainbow-delimiters/raw/master/rainbow-delimiters.el") (:keywords "faces" "convenience" "lisp" "matching" "tools" "rainbow" "rainbow parentheses" "rainbow parens")) "melpa"])
  (rainbow-identifiers . [(20140916 1123) ((emacs (24))) "Highlight identifiers according to their names" single ((:url . "https://github.com/Fanael/rainbow-identifiers")) "melpa"])
  ...
  (rtags . [(20141020 958) nil "No description available." tar nil "melpa"])
  ...
  (sage-shell-mode . [(20141011 1831) ((cl-lib (0 5)) (deferred (0 3 2))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (scheme-here . [(20140802 2326) nil "cmuscheme extension for multiple inferior processes" single ((:url . "https://github.com/kaihaosw/scheme-here") (:keywords "scheme")) "melpa"])
  ...
  (slime . [(20141010 1357) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (sly . [(20141020 628) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (soothe-theme . [(20141023 644) ((emacs (24 1))) "a dark colorful theme for Emacs24." single ((:url . "https://github.com/jasonm23/emacs-soothe-theme")) "melpa"])
  ...
  (speechd-el . [(20141022 2057) nil "Client to speech synthesizers and Braille displays." tar nil "melpa"])
  ...
  (tuareg . [(20140914 1853) ((caml (3 12 0 1))) "OCaml mode for Emacs." tar ((:url . "http://forge.ocamlcore.org/projects/tuareg/") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (vc-auto-commit . [(20140808 229) nil "Auto-committing feature for your repository" tar ((:url . "http://github.com/thisirs/vc-auto-commit.git") (:keywords "vc" "convenience")) "melpa"])
  (vc-check-status . [(20140808 225) nil "Warn you when quitting emacs and leaving repo dirty." tar ((:url . "https://github.com/thisirs/vc-check-status") (:keywords "vc" "convenience")) "melpa"])
  ...
  (warm-night-theme . [(20141023 1124) ((emacs (24))) "Emacs 24 theme with a dark background." single nil "melpa"])
  ...
  (web-mode . [(20141023 1315) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (ycmd . [(20141018 117) ((emacs (24)) (anaphora (1 0 0)) (request (0 2 0)) (deferred (0 3 2)) (request-deferred (0 2 0)) (popup (0 5 0))) "emacs bindings to the ycmd completion server ;" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (zlc . [(20141023 830) nil "Provides zsh like completion system to Emacs" single ((:keywords "matching" "convenience")) "melpa"])
