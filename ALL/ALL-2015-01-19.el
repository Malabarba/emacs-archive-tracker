'(
  ...
  (ac-html . [(20150118 1742) ((auto-complete (1 4))) "auto complete source for html tags and attributes" tar ((:url . "https://github.com/cheunghy/ac-html") (:keywords "html" "auto-complete" "rails" "ruby")) "melpa"])
  ...
  (ac-html-csswatcher . [(20150118 1116) ((ac-html (0 3))) "css/less class,id completion with `ac-html'" single ((:url . "https://github.com/osv/ac-html-csswatcher") (:keywords "html" "css" "less" "auto-complete")) "melpa"])
  ...
  (alchemist . [(20150116 1236) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (bundler . [(20141208 154) ((inf-ruby (2 1))) "Interact with Bundler from Emacs" single ((:url . "http://github.com/tobiassvn/") (:keywords "bundler" "ruby")) "melpa"])
  ...
  (chinese-pyim . [(20150118 857) ((cl-lib (0 5))) "Chinese pinyin input method" tar ((:url . "https://github.com/tumashu/chinese-pyim") (:keywords "convenience" "chinese" "pinyin" "input-method")) "melpa"])
  ...
  (cider . [(20150118 421) ((clojure-mode (4 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clang-format . [(20150113 35) ((cl-lib (0 3))) "Format code using clang-format" single ((:keywords "tools" "c")) "melpa"])
  ...
  (company-cabal . [(20150117 116) ((cl-lib (0 5)) (company (0 8 0)) (emacs (24))) "company-mode cabal backend" tar ((:url . "https://github.com/iquiw/company-cabal")) "melpa"])
  ...
  (dyalog-mode . [(20150115 543) ((cl-lib (0 2))) "Major mode for editing Dyalog APL source code" tar ((:url . "https://bitbucket.org/harsman/dyalog-mode/") (:keywords "languages")) "melpa"])
  ...
  (ebib . [(20150107 1459) ((dash (2 5 0)) (parsebib (1 0)) (emacs (24 3))) "a BibTeX database manager" tar ((:keywords "text" "bibtex")) "melpa"])
  ...
  (el-get . [(20150114 1429) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (emacsshot . [(20150118 721) nil "Snapshot a frame or window from within Emacs" single ((:url . "https://github.com/marcowahl/emacsshot") (:keywords "convenience")) "melpa"])
  ...
  (ensime . [(20150117 107) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (evil-escape . [(20150117 2111) ((emacs (24)) (evil (1 0 9))) "Escape from anything with a customizable key sequence" single ((:url . "https://github.com/syl20bnr/evil-escape") (:keywords "convenience" "editing" "evil")) "melpa"])
  ...
  (evil-lisp-state . [(20150111 1959) ((evil (1 0 9)) (evil-leader (0 4 3)) (smartparens (1 6 1))) "An evil state to edit Lisp code" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  ...
  (fingers . [(20141225 635) nil "Modal editing with universal text manipulation helpers." tar ((:url . "http://github.com/fgeller/fingers.el") (:keywords "fingers" "modal" "editing" "workman")) "melpa"])
  ...
  (gnus-summary-ext . [(20141222 2031) nil "Extra limit and process mark commands for the gnus summary buffer" single ((:url . "https://github.com/vapniks/gnus-summary-ext") (:keywords "comm")) "melpa"])
  ...
  (grizzl . [(20150117 2338) ((cl-lib (0 5)) (emacs (24 3))) "Fast fuzzy search index for Emacs." single ((:url . "https://github.com/grizzl/grizzl") (:keywords "convenience" "usability")) "melpa"])
  ...
  (helm . [(20150118 1237) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ls-git . [(20141205 2335) ((helm (1 5))) "list git files." single nil "melpa"])
  ...
  (lentic . [(20150117 1538) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (lispy . [(20150117 615) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (org-dotemacs . [(20150118 1931) ((org (7 9 3)) (cl-lib (1 0))) "Store your emacs config as an org file, and choose which bits to load." single ((:url . "https://github.com/vapniks/org-dotemacs") (:keywords "local")) "melpa"])
  ...
  (osx-dictionary . [(20150111 425) ((cl-lib (0 5)) (chinese-word-at-point (0 1))) "Interface for OSX Dictionary.app" tar ((:url . "https://github.com/xuchunyang/osx-dictionary.el") (:keywords "dictionary")) "melpa"])
  ...
  (overseer . [(20150111 2136) ((emacs (24)) (dash (2 10 0)) (pkg-info (0 4))) "Ert-runner Integration Into Emacs" single ((:url . "http://www.github.com/tonini/overseer.el")) "melpa"])
  ...
  (parsebib . [(20150102 215) ((emacs (24 3))) "A library for parsing bib files" single ((:keywords "text" "bibtex")) "melpa"])
  ...
  (realgud . [(20150118 1923) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (rope-read-mode . [(20150117 1411) nil "Rearrange lines to read text smoothly" single ((:url . "https://github.com/marcowahl/rope-read-mode") (:keywords "convenience")) "melpa"])
  ...
  (serverspec . [(20150118 1744) ((dash (2 6 0)) (s (1 9 0)) (f (0 16 2)) (helm (1 6 1))) "Serverspec minor mode" tar ((:url . "http://101000lab.org")) "melpa"])
  ...
  (speed-type . [(20150116 1123) ((cl-lib (0 3))) "Practice touch and speed typing" single ((:url . "https://github.com/hagleitn/speed-type") (:keywords "games")) "melpa"])
  ...
  (sx . [(20150117 738) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (org . [(20150112) nil "Outline-based notes management and organizer" tar nil "gnu"])
