'(
  ...
  (addressbook-bookmark . [(20141114 1316) ((emacs (24))) "An address book based on Standard Emacs bookmarks." single ((:url . "https://github.com/thierryvolpiatto/addressbook-bookmark")) "melpa"])
  ...
  (ag . [(20141114 1652) ((dash (2 8 0)) (s (1 9 0))) "A front-end for ag ('the silver searcher'), the C ack replacement." single nil "melpa"])
  (aggressive-indent . [(20141113 239) ((emacs (24 1)) (names (0 5)) (cl-lib (0 5))) "Minor mode to aggressively keep your code always indented" single ((:url . "http://github.com/Bruce-Connor/aggressive-indent-mode") (:keywords "indent" "lisp" "maint" "tools")) "melpa"])
  ...
  (alchemist . [(20141115 420) ((emacs (24)) (pkg-info (0 5))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (anaconda-mode . [(20141110 1219) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (auto-complete . [(20141111 2346) ((popup (0 5 0))) "Auto Completion for GNU Emacs" tar nil "melpa"])
  ...
  (bog . [(20141112 2017) ((dash (2 5 0))) "Extensions for research notes in Org mode" single ((:url . "https://github.com/kyleam/bog") (:keywords "bib" "outlines")) "melpa"])
  (bongo . [(20140514 847) nil "play music with Emacs" tar nil "melpa"])
  (bookmark+ . [(20141115 2050) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (cider . [(20141116 1221) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (cider-profile . [(20141114 550) ((cider (0 8 0))) "CIDER profiling support" single ((:url . "http://github.com/thunknyc/nrepl-profile") (:keywords "cider" "clojure" "profiling")) "melpa"])
  ...
  (clj-refactor . [(20141114 2334) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 6 0))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (coffee-mode . [(20141110 608) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (company . [(20141116 1245) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-ghc . [(20141114 2128) ((cl-lib (0 5)) (company (0 8 0)) (ghc (4 1 1)) (emacs (24))) "company-mode ghc-mod backend" single ((:url . "https://github.com/iquiw/company-ghc") (:keywords "haskell" "completion")) "melpa"])
  ...
  (company-math . [(20141116 1258) ((company (0 8 0)) (math-symbol-lists (1 0))) "Completion back-ends for for math unicode symbols and latex tags" single ((:url . "https://github.com/vspinu/company-math") (:keywords "unicode" "symbols" "completion")) "melpa"])
  ...
  (company-ycmd . [(20141111 2144) ((ycmd (0 1)) (company (0 8 3)) (deferred (0 2 0))) "company-mode backend for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (ebib . [(20141113 1048) ((dash (2 5 0)) (emacs (24 3))) "a BibTeX database manager" tar ((:keywords "text" "bibtex")) "melpa"])
  ...
  (eide . [(20141110 525) nil "IDE interface" tar nil "melpa"])
  ...
  (el-get . [(20141114 1900) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (emmet-mode . [(20141114 800) nil "Unofficial Emmet's support for emacs" single ((:url . "https://github.com/smihica/emmet-mode") (:keywords "convenience")) "melpa"])
  ...
  (ess . [(20141114 1503) nil "No description available." tar nil "melpa"])
  ...
  (esup . [(20141116 947) nil "the Emacs StartUp Profiler (ESUP)" tar ((:url . "http://github.com/jschaf/esup") (:keywords "convenience" "processes")) "melpa"])
  ...
  (eval-in-repl . [(20141112 1901) ((dash (0 0 0)) (paredit (0 0 0))) "Consistent ESS-like eval interface for various REPLs" tar nil "melpa"])
  ...
  (evil . [(20141112 2116) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-escape . [(20141110 1144) ((emacs (24)) (evil (1 0 9)) (key-chord (0 6))) "Customizable key sequence to escape from insert state and everything else." single ((:url . "https://github.com/syl20bnr/evil-escape") (:keywords "convenience" "editing" "evil")) "melpa"])
  ...
  (evil-lisp-state . [(20141115 2047) ((evil (1 0 9)) (smartparens (1 6 1))) "An evil state to navigate Lisp code and modify it with smartparens" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  ...
  (eww-lnum . [(20141111 157) nil "Operations using link numbers" single ((:url . "https://github.com/m00natic/eww-lnum") (:keywords "eww" "browse" "conkeror")) "melpa"])
  ...
  (expand-region . [(20141115 1025) nil "Increase selected region by semantic units." tar nil "melpa"])
  ...
  (feature-mode . [(20141114 456) nil "Major mode for editing Gherkin (i.e. Cucumber) user stories" tar nil "melpa"])
  ...
  (floobits . [(20141114 1633) ((json (1 2)) (highlight (0))) "Floobits plugin for real-time collaborative editing" tar ((:url . "http://github.com/Floobits/floobits-emacs") (:keywords "comm" "tools")) "melpa"])
  ...
  (fountain-mode . [(20141110 245) ((s (1 9 0))) "Major mode for screenwriting in Fountain markup" single ((:url . "https://github.com/rnkn/fountain-mode") (:keywords "wp")) "melpa"])
  ...
  (fsharp-mode . [(20141111 906) ((auto-complete (1 4)) (popup (0 5)) (pos-tip (0 4 5)) (s (1 3 1)) (dash (1 1 0))) "F# mode for Emacs" tar nil "melpa"])
  ...
  (ggtags . [(20141112 2234) ((emacs (24)) (cl-lib (0 5))) "emacs frontend to GNU Global source code tagging system" single ((:url . "https://github.com/leoliu/ggtags") (:keywords "tools" "convenience")) "melpa"])
  ...
  (gitlab . [(20141114 455) ((s (1 9 0)) (dash (2 9 0)) (pkg-info (0 5 0)) (request (0 1 0))) "Emacs client for Gitlab" tar ((:url . "https://github.com/nlamirault/emacs-gitlab") (:keywords "gitlab")) "melpa"])
  ...
  (gnu-apl-mode . [(20141112 2317) ((emacs (24))) "Integrate GNU APL with Emacs" tar nil "melpa"])
  ...
  (haskell-mode . [(20141111 109) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141114 2229) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20141115 1822) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-bibtex . [(20141115 1545) ((helm (1 5 5)) (ebib (1 15)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-cmd-t . [(20141110 432) nil "cmd-t style completion" tar ((:url . "https://github.com/lewang/helm-cmd-t") (:keywords "helm" "project-management" "completion" "convenience" "cmd-t" "textmate")) "melpa"])
  ...
  (helm-ls-git . [(20141111 928) ((helm (1 5))) "list git files." single nil "melpa"])
  ...
  (helm-projectile . [(20141116 1114) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (help-fns+ . [(20141112 2351) nil "Extensions to `help-fns.el'." single ((:url . "http://www.emacswiki.org/help-fns+.el") (:keywords "help" "faces" "characters" "packages" "description")) "melpa"])
  ...
  (hl-anything . [(20141115 30) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more." single nil "melpa"])
  ...
  (icicles . [(20141117 59) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (js2-mode . [(20141116 1824) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (julia-mode . [(20141115 904) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (karma . [(20141112 102) nil "Karma Test Runner Emacs Integration" single ((:url . "http://github.com/tonini/karma.el") (:keywords "javascript" "js" "karma" "testing")) "melpa"])
  ...
  (ledger-mode . [(20141115 2036) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  ...
  (lispy . [(20141114 513) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97))) "vi-like Paredit" tar nil "melpa"])
  ...
  (m-buffer . [(20141116 1447) ((dash (2 8 0)) (emacs (24 3))) "Buffer Manipulation Functions" single nil "melpa"])
  ...
  (magit-gh-pulls . [(20141113 1252) ((emacs (24)) (gh (0 4 3)) (magit (1 1 0)) (pcache (0 2 3)) (s (1 6 1))) "GitHub pull requests extension for Magit" single ((:url . "https://github.com/sigma/magit-gh-pulls") (:keywords "tools")) "melpa"])
  ...
  (mandoku . [(20141114 1533) ((org (8 0))) "A tool to access repositories of premodern Chinese texts" tar nil "melpa"])
  (mandoku-meta-zb . [(20141112 2155) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (math-symbol-lists . [(20141116 1252) nil "Lists of Unicode mathematical symbols and latex commands" single ((:url . "https://github.com/vspinu/math-symbol-lists") (:keywords "unicode" "symbols" "mathematics")) "melpa"])
  ...
  (maven-test-mode . [(20141116 1636) nil "No description available." single nil "melpa"])
  ...
  (monokai-theme . [(20141111 2234) nil "A fruity color theme for Emacs." single ((:url . "http://github.com/oneKelvinSmith/monokai-emacs")) "melpa"])
  ...
  (niflheim-theme . [(20141116 556) nil "A port of the Nifleim theme to Emacs" single ((:url . "https://github.com/niflheim-theme/emacs") (:keywords "themes")) "melpa"])
  ...
  (org . [(20141110) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-vcard . [(20141111 1839) nil "org-mode support for vCard export and import." tar ((:keywords "outlines" "org" "vcard")) "melpa"])
  ...
  (orgtbl-aggregate . [(20141110 601) ((cl-lib (0 5))) "Create an aggregated Org table from another one" tar ((:keywords "org" "table" "aggregation" "filtering")) "melpa"])
  ...
  (origami . [(20141116 1009) ((s (1 9 0)) (dash (2 5 0)) (emacs (24))) "Flexible text folding" tar ((:url . "https://github.com/gregsexton/") (:keywords "folding")) "melpa"])
  ...
  (outshine . [(20141110 311) nil "outline with outshine outshines outline" single ((:url . "https://github.com/tj64/outshine")) "melpa"])
  ...
  (ox-reveal . [(20141112 644) ((org (8 0))) "reveal.js Presentation Back-End for Org Export Engine" single ((:keywords "outlines" "hypermedia" "slideshow" "presentation")) "melpa"])
  ...
  (pandoc-mode . [(20141112 1521) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (paxedit . [(20141115 1212) ((cl-lib (0 5)) (paredit (23))) "Structured, Context Driven LISP Editing and Refactoring" single ((:url . "https://github.com/promethial/paxedit") (:keywords "lisp" "refactoring" "context")) "melpa"])
  ...
  (perspective . [(20141114 1656) ((cl-lib (0 5))) "switch between named \"perspectives\" of the editor" single ((:url . "http://github.com/nex3/perspective-el") (:keywords "workspace" "convenience" "frames")) "melpa"])
  ...
  (projectile . [(20141114 1118) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (punctuality-logger . [(20141114 939) nil "Punctuality logger for Emacs" single ((:url . "https://gitlab.com/elzair/punctuality-logger") (:keywords "reminder" "calendar")) "melpa"])
  ...
  (racket-mode . [(20141112 1440) nil "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (realgud . [(20141116 819) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (relative-buffers . [(20141110 1235) ((cl-lib (0 5)) (dash (2 6 0)) (s (1 9 0)) (f (0 16 2))) "Emacs buffers naming convention" single ((:url . "https://github.com/proofit404/relative-buffers")) "melpa"])
  ...
  (rust-mode . [(20141111 1026) nil "A major emacs mode for editing Rust source code" single ((:url . "https://github.com/rust-lang/rust") (:keywords "languages")) "melpa"])
  ...
  (scala-outline-popup . [(20141114 102) ((dash (2 9 0)) (popup (20141002 320)) (scala-mode2 (0 22))) "scala file summary popup" single ((:url . "https://github.com/ancane/scala-outline-popup.el") (:keywords "scala" "structure" "summary")) "melpa"])
  ...
  (slime . [(20141116 1533) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (sly . [(20141115 931) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (snakemake-mode . [(20141115 2144) ((emacs (24))) "Major mode for editing Snakemake files" single ((:url . "https://github.com/kyleam/snakemake-mode") (:keywords "tools")) "melpa"])
  ...
  (solarized-theme . [(20141113 2338) ((dash (2 6 0))) "The Solarized color theme, ported to Emacs." tar nil "melpa"])
  ...
  (term-alert . [(20141114 1325) ((term-cmd (1 0)) (alert (1 1))) "Get notifications when commands complete in the Emacs terminal emulator" single ((:url . "https://github.com/CallumCameron/term-alert") (:keywords "notifications" "processes")) "melpa"])
  ...
  (tern-django . [(20141113 1452) ((emacs (24)) (tern (0 0 1)) (f (0 17 1))) "Create tern projects for django applications." tar ((:url . "https://github.com/proofit404/tern-django")) "melpa"])
  ...
  (travis . [(20141114 1403) ((s (1 9 0)) (dash (2 9 0)) (pkg-info (0 5 0)) (request (0 1 0))) "Emacs client for Travis" tar ((:url . "https://github.com/nlamirault/emacs-travis") (:keywords "travis")) "melpa"])
  ...
  (vc-darcs . [(20141115 1126) nil "a VC backend for darcs" single ((:keywords "vc")) "melpa"])
  ...
  (web-mode . [(20141112 2327) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (ycmd . [(20141114 603) ((emacs (24)) (anaphora (1 0 0)) (deferred (0 3 2)) (popup (0 5 0))) "emacs bindings to the ycmd completion server" tar ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
