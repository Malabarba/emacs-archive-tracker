'(
  ...
  (web-mode . [(20140921 1206) nil "major mode for editing html templates" tar ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
