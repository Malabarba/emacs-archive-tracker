'(
  ...
  (helm . [(20140704 239) nil "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
...
highlighter, flymake for projects" tar nil "melpa"])
  ...
  (realgud . [(20140704 242) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
