'(
  ...
  (magit . [(90141214) ((cl-lib (0 3)) (git-commit-mode (0 14 0)) (git-rebase-mode (0 14 0))) "control Git from Emacs" tar ((:keywords "vc" "tools")) "melpa-stable"])
  (magit-stgit . [(90141214) ((cl-lib (0 3)) (magit (1 3 0))) "StGit plug-in for Magit" single ((:keywords "vc" "tools")) "melpa-stable"])
  (magit-svn . [(90141214) ((cl-lib (0 3)) (magit (1 3 0))) "git-svn plug-in for Magit" single ((:keywords "vc" "tools")) "melpa-stable"])
  (magit-topgit . [(90141214) ((cl-lib (0 3)) (magit (1 3 0))) "topgit plug-in for Magit" single ((:keywords "vc" "tools")) "melpa-stable"])
  ...
  (ac-html . [(20141218 1924) ((auto-complete (1 4))) "auto complete source for html tags and attributes" tar ((:url . "https://github.com/cheunghy/ac-html") (:keywords "html" "auto-complete" "rails" "ruby")) "melpa"])
  ...
  (ace-window . [(20141217 927) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  ...
  (alchemist . [(20141222 20) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (auto-complete . [(20141208 809) ((popup (0 5 0))) "Auto Completion for GNU Emacs" tar nil "melpa"])
  ...
  (cider . [(20141223 804) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clj-refactor . [(20141223 248) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 8 1))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (company-restclient . [(20141225 715) ((cl-lib (0 5)) (company (0 8 0)) (emacs (24)) (know-your-http-well (0 2 0))) "company-mode completion back-end for restclient-mode" single ((:url . "https://github.com/iquiw/company-restclient")) "melpa"])
  ...
  (ddskk . [(20141221 1331) ((cdb (20141201 754))) "Simple Kana to Kanji conversion program." tar nil "melpa"])
  ...
  (egison-mode . [(20141130 2036) nil "Egison editing mode" single ((:url . "https://github.com/egisatoshi/egison3/blob/master/elisp/egison-mode.el")) "melpa"])
  ...
  (ein . [(20141219 1424) ((websocket (1 3)) (request (0 2)) (auto-complete (1 4))) "Emacs IPython Notebook" tar nil "melpa"])
  ...
  (elixir-mode . [(20141225 914) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (ensime . [(20141222 1950) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (ert-runner . [(20140610 729) ((s (1 6 1)) (dash (1 8 0)) (f (0 10 0)) (commander (0 2 0)) (ansi (0 1 0)) (shut-up (0 1 0))) "Opinionated Ert testing workflow" tar ((:url . "http://github.com/rejeep/ert-runner.el") (:keywords "test")) "melpa"])
  ...
  (ess . [(20141210 1932) nil "No description available." tar nil "melpa"])
  ...
  (esup . [(20141130 1710) nil "the Emacs StartUp Profiler (ESUP)" tar ((:url . "http://github.com/jschaf/esup") (:keywords "convenience" "processes")) "melpa"])
  ...
  (evil . [(20141224 419) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (flx-isearch . [(20141207 2108) ((emacs (24)) (flx (20140821)) (cl-lib (0 5))) "Fuzzy incremental searching for emacs" single ((:url . "https://github.com/pythonnut/flx-isearch") (:keywords "convenience" "search" "flx")) "melpa"])
  ...
  (flycheck-package . [(20141223 914) ((cl-lib (0 5)) (flycheck (0 22 -3 1)) (emacs (24))) "A Flycheck checker for elisp package authors" single ((:keywords "lisp")) "melpa"])
  ...
  (flycheck-ycmd . [(20141217 2220) ((emacs (24)) (flycheck (0 22)) (ycmd (20141217 453))) "flycheck integration for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (gh . [(20141216 1139) ((eieio (1 3)) (pcache (0 2 4)) (logito (0 1))) "A GitHub library for Emacs" tar nil "melpa"])
  ...
  (gnuplot . [(20140317 1950) nil "drive gnuplot from within emacs" tar ((:keywords "gnuplot" "plotting")) "melpa"])
  ...
  (grails-projectile-mode . [(20141218 1403) ((projectile (0 10 0)) (emacs (24)) (cl-lib (0 5))) "Grails mode with Projectile for projects management." single ((:keywords "grails" "projectile")) "melpa"])
  ...
  (haskell-mode . [(20141224 1358) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141225 14) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-bibtex . [(20141216 1929) ((helm (1 5 5)) (parsebib (1 0)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-cmd-t . [(20141215 1825) nil "cmd-t style completion" tar ((:url . "https://github.com/lewang/helm-cmd-t") (:keywords "helm" "project-management" "completion" "convenience" "cmd-t" "textmate")) "melpa"])
  ...
  (js2-mode . [(20141224 347) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  (js2-refactor . [(20141224 153) ((js2-mode (20101228)) (s (1 9 0)) (multiple-cursors (1 0 0)) (dash (1 0 0)) (s (1 0 0)) (yasnippet (20130218))) "A JavaScript refactoring library for emacs." tar nil "melpa"])
  ...
  (ledger-mode . [(20141218 456) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  ...
  (lentic . [(20141223 528) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (leuven-theme . [(20141124 559) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (lispy . [(20141223 731) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (malabar-mode . [(20141220 1235) ((fringe-helper (1 0 1))) "A better Java mode for Emacs" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "language" "malabar")) "melpa"])
  ...
  (mandoku-meta-zb . [(20141224 2044) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (multiple-cursors . [(20141222 1413) nil "Multiple cursors for Emacs." tar nil "melpa"])
  ...
  (org-dotemacs . [(20141223 1539) ((org (7 9 3)) (cl-lib (1 0))) "Store your emacs config as an org file, and choose which bits to load." single ((:url . "https://github.com/vapniks/org-dotemacs") (:keywords "local")) "melpa"])
  ...
  (ox-twbs . [(20141224 1437) nil "Bootstrap compatible HTML Back-End for Org" single ((:url . "https://github.com/marsmining/ox-twbs") (:keywords "org" "html" "publish" "twitter" "bootstrap")) "melpa"])
  ...
  (paradox . [(20141225 757) ((emacs (24 1)) (dash (2 6 0)) (cl-lib (0 5)) (json (1 3))) "A modern Packages Menu. Colored, with package ratings, and customizable." tar ((:url . "http://github.com/Bruce-Connor/paradox") (:keywords "package" "packages" "mode-line")) "melpa"])
  ...
  (popwin . [(20141213 1820) nil "Popup Window Manager." single ((:keywords "convenience")) "melpa"])
  ...
  (projectile . [(20141222 433) ((s (1 6 0)) (f (0 17 1)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20141213 1107) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (quickrun . [(20141103 630) ((emacs (24)) (cl-lib (0 5))) "Run commands quickly" single ((:url . "https://github.com/syohex/emacs-quickrun")) "melpa"])
  ...
  (racket-mode . [(20141221 1304) ((emacs (24 3))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (realgud . [(20141224 1742) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (rtags . [(20141217 1323) nil "No description available." tar nil "melpa"])
  ...
  (shelltest-mode . [(20141223 1540) nil "Major mode for shelltestrunner" single ((:url . "https://github.com/rtrn/shelltest-mode") (:keywords "languages")) "melpa"])
  ...
  (sly . [(20141208 507) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (smart-mode-line . [(20141219 448) ((emacs (24 3)) (dash (2 2 0)) (rich-minority (0 1))) "A color coded smart mode-line." tar ((:url . "http://github.com/Bruce-Connor/smart-mode-line") (:keywords "mode-line" "faces" "theme" "themes")) "melpa"])
  ...
  (sx . [(20141223 1955) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 1))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes." tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (ujelly-theme . [(20141222 757) nil "Ujelly theme for GNU Emacs 24 (deftheme)" single ((:url . "http://github.com/marktran/color-theme-ujelly")) "melpa"])
  ...
  (vlf . [(20141216 1546) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (web-mode . [(20141225 339) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (widget-mvc . [(20141223 2028) nil "MVC framework for the emacs widgets" single ((:keywords "lisp" "widget")) "melpa"])
  ...
  (ycmd . [(20141224 136) ((emacs (24)) (f (0 17 1)) (dash (1 2 0)) (deferred (0 3 2)) (popup (0 5 0))) "emacs bindings to the ycmd completion server" tar ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (org2jekyll . [(0 0 8) ((dash (2 10 0)) (s (1 9 0))) "Minor mode to publish org-mode post to jekyll without specific yaml" single "marmalade"])
  ...
  (org . [(20141222) nil "Outline-based notes management and organizer" tar nil "gnu"])
