'(
  ...
  (ergoemacs-mode . [(20140502 905) nil "Emacs mode based on common modern software interface and ergonomics." tar ((:keywords "convenience")) "melpa"])
  ...
  (popup-switcher . [(20140502 406) ((popup (0 5 0))) "switch to other buffers and files via popup." single ((:url . "https://github.com/kostafey/popup-switcher") (:keywords "popup" "switch" "buffers" "functions")) "melpa"])
