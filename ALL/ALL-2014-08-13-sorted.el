'(
  ...
  (better-registers . [(20140812 1546) nil "facilities for more powerful registers" single ((:keywords "register" "macro")) "melpa"])
  ...
  (browse-kill-ring . [(20140811 1309) nil "interactively insert items from kill-ring" single ((:url . "https://github.com/browse-kill-ring/browse-kill-ring") (:keywords "convenience")) "melpa"])
  ...
  (cider . [(20140812 953) ((clojure-mode (2 0 0)) (cl-lib (0 3)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clojure-mode . [(20140812 938) nil "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "lisp")) "melpa"])
  ...
  (coffee-mode . [(20140805 2337) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (color-theme-sanityinc-tomorrow . [(20140811 215) nil "A version of Chris Kempson's various Tomorrow themes" tar nil "melpa"])
  ...
  (el-get . [(20140812 1256) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (ensime . [(20140730 1034) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (epresent . [(20140727 2103) nil "Simple presentation mode for Emacs Org-mode" single ((:keywords "gui")) "melpa"])
  ...
  (ergoemacs-mode . [(20140812 715) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  ...
  (flycheck . [(20140812 1041) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  (flycheck-cask . [(20140725 453) ((flycheck (0 14)) (dash (2 4 0))) "Cask support in Flycheck" single ((:url . "https://github.com/flycheck/flycheck-cask") (:keywords "tools" "convenience")) "melpa"])
  ...
  (flycheck-dmd-dub . [(20140716 948) nil "Sets flycheck-dmd-include-paths from dub package information" single ((:url . "http://github.com/atilaneves/flycheck-dmd-dub") (:keywords "languages")) "melpa"])
  ...
  (ggtags . [(20140807 653) ((emacs (24)) (cl-lib (0 5))) "emacs frontend to GNU Global source code tagging system" single ((:url . "https://github.com/leoliu/ggtags") (:keywords "tools" "convenience")) "melpa"])
  (gh . [(20140706 1506) ((eieio (1 3)) (pcache (0 2 4)) (logito (0 1))) "A GitHub library for Emacs" tar nil "melpa"])
  (ghc . [(20140806 450) nil "Sub mode for Haskell mode" tar nil "melpa"])
  ...
  (git-commit-mode . [(20140605 520) nil "Major mode for editing git commit messages" single ((:url . "https://github.com/magit/git-modes") (:keywords "convenience" "vc" "git")) "melpa"])
  ...
  (github-clone . [(20140807 2217) ((gh (0 7 2)) (magit (1 2 0)) (emacs (24))) "Fork and clone github repos" single ((:url . "https://github.com/dgtized/github-clone.el") (:keywords "vc" "tools")) "melpa"])
  ...
  (gnu-apl-mode . [(20140812 357) ((emacs (24))) "Integrate GNU APL with Emacs" tar nil "melpa"])
  ...
  (graphene . [(20140729 124) ((feature-mode (20140416)) (markdown-mode (20131210)) (scss-mode (20130105)) (exec-path-from-shell (20140219)) (project-persist (20131030)) (sr-speedbar (20140505)) (smex (20140425)) (web-mode (20140505)) (smartparens (20140427)) (flycheck (20140422)) (auto-complete (20140414))) "Friendly Emacs defaults" tar nil "melpa"])
  ...
  (helm . [(20140810 2335) nil "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-bibtex . [(20140804 1209) ((helm (1 5 5)) (ebib (1 15)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-dash . [(20140727 1126) ((helm (0 0 0))) "Helm extension to search dash docsets" single ((:keywords "docs")) "melpa"])
  ...
  (helm-flycheck . [(20140803 803) ((dash (2 4 0)) (flycheck (0 20 -3)) (helm (1 5 7))) "Show flycheck errors with helm" single ((:url . "https://github.com/yasuyk/helm-flycheck") (:keywords "helm" "flycheck")) "melpa"])
  ...
  (helm-projectile . [(20140812 1146) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (icicles . [(20140812 225) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (io-mode . [(20140812 1154) nil "Major mode to edit Io language files in Emacs" single ((:url . "https://github.com/superbobry/io-mode") (:keywords "languages" "io")) "melpa"])
  ...
  (jabber . [(20140812 1417) nil "A Jabber client for Emacs." tar nil "melpa"])
  ...
  (julia-mode . [(20140812 1220) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (merlin . [(20140812 907) nil "Mode for Merlin, an assistant for OCaml." single ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (monokai-theme . [(20140811 735) nil "A fruity color theme for Emacs." single ((:url . "http://github.com/oneKelvinSmith/monokai-emacs")) "melpa"])
  ...
  (org-trello . [(20140608 1036) ((db (0 0 6)) (s (1 7 0)) (esxml (0 3 0)) (elnode (0 9 9 7 6)) (request (0 2 0)) (dash (2 5 0))) "Minor mode to synchronize org-mode buffer and trello board" tar nil "melpa"])
  ...
  (paradox . [(20140728 427) ((emacs (24 1)) (tabulated-list (1 0)) (package (1 0)) (dash (2 6 0)) (cl-lib (1 0)) (json (1 3))) "A modern Packages Menu. Colored, with package ratings, and customizable." tar ((:url . "http://github.com/Bruce-Connor/paradox") (:keywords "package" "packages" "mode-line")) "melpa"])
  ...
  (php-mode . [(20140721 1613) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (pretty-mode . [(20140805 1318) nil "Redisplay parts of the buffer as pretty symbols." single ((:url . "https://github.com/akatov/pretty-mode") (:keywords "pretty" "unicode" "symbols")) "melpa"])
  ...
  (rspec-mode . [(20140617 936) ((ruby-mode (1 0)) (cl-lib (0 4))) "Enhance ruby-mode for RSpec" tar ((:url . "http://github.com/pezra/rspec-mode") (:keywords "rspec" "ruby")) "melpa"])
  ...
  (shm . [(20140804 151) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (sqlup-mode . [(20140812 1216) nil "Upcase SQL words for you" single ((:url . "https://github.com/trevoke/sqlup-mode.el") (:keywords "sql" "tools")) "melpa"])
  ...
  (swift-mode . [(20140722 737) ((emacs (24 1))) "Major-mode for Apple's Swift programming language." single nil "melpa"])
  ...
  (tern . [(20140727 2325) ((json (1 2)) (cl-lib (0 5)) (emacs (24))) "Tern-powered JavaScript integration" single ((:url . "http://ternjs.net/")) "melpa"])
  ...
  (vs-emulation-mode . [(20140806 956) ((emacs (24)) (cl-lib (0 5))) "Emulate a certain proprietary IDE" single ((:url . "https://github.com/Fanael/vs-emulation-mode")) "melpa"])
  ...
  (web-mode . [(20140812 1250) nil "major mode for editing html templates" tar ((:url . "http://web-mode.org") (:keywords "html" "template" "php" "javascript" "js" "css" "web" "django" "jsp" "asp" "erb" "twig" "jinja" "blade" "dust" "closure" "freemarker" "mustache" "velocity" "cheetah" "smarty")) "melpa"])
  ...
  (websocket . [(20140810 1439) nil "Emacs WebSocket client and server" single ((:keywords "communication" "websocket" "server")) "melpa"])
