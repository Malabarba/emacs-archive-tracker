'(
  ...
  (calfw . [(20141030 300) nil "Calendar view framework on Emacs" tar ((:keywords "calendar")) "melpa"])
  ...
  (web-mode . [(20141030 552) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
