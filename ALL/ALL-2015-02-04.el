'(
  ...
  (async . [(20141229 2221) nil "Asynchronous processing in Emacs" tar nil "melpa"])
  ...
  (bog . [(20150128 2200) ((dash (2 5 0))) "Extensions for research notes in Org mode" single ((:url . "https://github.com/kyleam/bog") (:keywords "bib" "outlines")) "melpa"])
  (bongo . [(20150114 1745) nil "play music with Emacs" tar nil "melpa"])
  (bookmark+ . [(20150203 2142) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (chatwork . [(20150203 711) nil "ChatWork client for Emacs" single ((:url . "https://github.com/ataka/chatwork") (:keywords "web")) "melpa"])
  ...
  (clocker . [(20150123 2139) ((projectile (0 11 0)) (dash (2 10))) "Note taker and clock-in enforcer" single ((:keywords "org")) "melpa"])
  ...
  (company . [(20150202 907) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (dired-fdclone . [(20150202 1945) nil "dired functions and settings to mimic FDclone" single ((:url . "https://github.com/knu/dired-fdclone.el") (:keywords "unix" "directories" "dired")) "melpa"])
  ...
  (el-init . [(20150203 10) ((emacs (24)) (cl-lib (0 5)) (anaphora (1 0 0))) "A loader inspired by init-loader" single nil "melpa"])
  ...
  (evil-dvorak . [(20150202 930) ((evil (1 0 8))) "evil keybindings for that work with dvorak mode" tar nil "melpa"])
  ...
  (helm . [(20150203 444) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-mt . [(20150201 915) ((emacs (24)) (helm (0 0)) (multi-term (0 0)) (cl-lib (0 5))) "helm multi-term management." single ((:url . "https://github.com/dfdeshom/helm-mt") (:keywords "helm" "multi-term")) "melpa"])
  ...
  (helm-projectile . [(20150120 2256) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (hydra . [(20150203 909) ((cl-lib (0 5))) "Make bindings that stick around" tar ((:url . "https://github.com/abo-abo/hydra") (:keywords "bindings")) "melpa"])
  ...
  (image+ . [(20150202 51) nil "Image manupulation extensions for Emacs" single ((:url . "http://github.com/mhayashi1120/Emacs-imagex/raw/master/image+.el") (:keywords "multimedia" "extensions")) "melpa"])
  ...
  (imenu-anywhere . [(20141218 1159) ((cl-lib (0 5))) "ido/helm imenu tag selection across all buffers with the same mode" single ((:url . "https://github.com/vitoshka/imenu-anywhere") (:keywords "ido" "imenu" "tags")) "melpa"])
  ...
  (js2-mode . [(20150201 1925) ((emacs (24 1)) (cl-lib (0 5))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (kanji-mode . [(20141205 1028) nil "View stroke order for kanji characters at cursor" tar ((:url . "http://github.com/wsgac/kanji-mode ")) "melpa"])
  ...
  (lentic . [(20150203 1455) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0)) (f (0 17 2))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (leuven-theme . [(20150116 442) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (lispy . [(20150203 213) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0)) (hydra (0 4 1))) "vi-like Paredit" tar nil "melpa"])
  ...
  (nim-mode . [(20150203 802) ((emacs (24))) "A major mode for the Nim programming language" single ((:keywords "nim" "languages")) "melpa"])
  ...
  (ob-http . [(20150202 344) ((s (1 9 0))) "http request in org-mode babel" tar ((:url . "http://github.com/zweifisch/ob-http")) "melpa"])
  ...
  (package-safe-delete . [(20150116 807) ((emacs (24)) (epl (0 7 -3))) "Safely delete package.el packages" single ((:url . "https://github.com/Fanael/package-safe-delete")) "melpa"])
  ...
  (pdf-tools . [(20150129 1435) ((emacs (24 3)) (tablist (0 50))) "Support library for PDF documents." tar ((:keywords "files" "multimedia")) "melpa"])
  ...
  (pinyin-search . [(20150203 852) nil "Search Chinese by Pinyin" single ((:url . "https://github.com/xuchunyang/pinyin-search.el") (:keywords "chinese")) "melpa"])
  ...
  (projectile-speedbar . [(20150113 1022) nil "No description available." single nil "melpa"])
  ...
  (racket-mode . [(20150125 2029) ((emacs (24 3))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (realgud . [(20150126 138) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (rtags . [(20150126 1210) nil "No description available." tar nil "melpa"])
  ...
  (stock-ticker . [(20150121 1451) ((s (1 9 0)) (request (0 2 0))) "Show stock prices in mode line" single ((:url . "https://github.com/hagleitn/stock-ticker") (:keywords "comms")) "melpa"])
  ...
  (swift-mode . [(20150121 314) ((emacs (24 1))) "Major-mode for Apple's Swift programming language." single ((:keywords "languages" "swift")) "melpa"])
  ...
  (sx . [(20150129 736) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tuareg . [(20150203 538) ((caml (3 12 0 1))) "OCaml mode for Emacs." tar ((:url . "https://github.com/ocaml/tuareg") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (web-mode . [(20150201 1311) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (org . [(20150126) nil "Outline-based notes management and organizer" tar nil "gnu"])
