'(
  ...
  (ac-cider . [(20141013 1019) ((cider (0 8 0)) (auto-complete (1 4)) (cl-lib (0 3))) "Clojure auto-complete sources using CIDER" single ((:url . "https://github.com/clojure-emacs/ac-cider") (:keywords "languages" "clojure" "nrepl" "cider" "compliment")) "melpa"])
  ...
  (ac-haskell-process . [(20141023 619) ((auto-complete (1 4)) (haskell-mode (13))) "Haskell auto-complete source which uses the current haskell process" single ((:keywords "languages")) "melpa"])
  ...
  (ace-window . [(20141107 10) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  (achievements . [(20140915 2128) ((keyfreq (0 0 3))) "Achievements for emacs usage." tar nil "melpa"])
  ...
  (ag . [(20141106 1411) ((dash (2 8 0)) (s (1 9 0))) "A front-end for ag ('the silver searcher'), the C ack replacement." single nil "melpa"])
  (aggressive-indent . [(20141104 1553) ((emacs (24 1)) (names (0 5)) (cl-lib (0 5))) "Minor mode to aggressively keep your code always indented" single ((:url . "http://github.com/Bruce-Connor/aggressive-indent-mode") (:keywords "indent" "lisp" "maint" "tools")) "melpa"])
  ...
  (alchemist . [(20141107 627) ((emacs (24)) (pkg-info (0 5))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  (alect-themes . [(20141105 947) nil "Configurable color themes (light, dark and black) for Emacs 24" tar nil "melpa"])
  ...
  (anaconda-mode . [(20141014 1303) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (android-mode . [(20140716 2347) nil "Minor mode for Android application development" single ((:url . "https://github.com/remvee/android-mode") (:keywords "tools" "processes")) "melpa"])
  ...
  (ansible . [(20140904 2151) ((s (1 9 0)) (f (0 16 2))) "Ansible minor mode" tar ((:url . "http://101000lab.org")) "melpa"])
  (ansible-doc . [(20140911 427) ((emacs (24 1))) "Ansible documentation Minor Mode" single ((:url . "https://github.com/lunaryorn/ansible-doc.el") (:keywords "tools" "help")) "melpa"])
  (ant . [(20131227 2307) nil "helpers for compiling with ant" single ((:keywords "compilation" "ant" "java")) "melpa"])
  (anti-zenburn-theme . [(20140812 1326) nil "Low-contrast Zenburn-inverted theme" single ((:url . "https://github.com/m00natic/anti-zenburn-theme")) "melpa"])
  ...
  (anzu . [(20141005 1955) ((cl-lib (0 5)) (emacs (24))) "Show number of matches in mode-line while searching" single ((:url . "https://github.com/syohex/emacs-anzu")) "melpa"])
  ...
  (auto-complete . [(20141103 105) ((popup (0 5 0))) "Auto Completion for GNU Emacs" tar nil "melpa"])
  ...
  (bison-mode . [(20141018 1019) nil "Major mode for editing bison, yacc and lex files." single ((:keywords "bison-mode" "yacc-mode")) "melpa"])
  ...
  (bog . [(20141031 2223) ((dash (2 5 0))) "Extensions for research notes in Org mode" single ((:url . "https://github.com/kyleam/bog") (:keywords "bib" "outlines")) "melpa"])
  (bongo . [(20140514 847) nil "play music with Emacs" tar nil "melpa"])
  (bookmark+ . [(20141028 2319) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  (boon . [(20141105 434) ((emacs (24 3)) (expand-region (0 10 0))) "Ergonomic Command Mode for Emacs." tar nil "melpa"])
  ...
  (cask . [(20141026 1127) ((s (1 8 0)) (dash (2 2 0)) (f (0 16 0)) (epl (0 5)) (shut-up (0 1 0)) (cl-lib (0 3)) (package-build (0 1))) "Cask: Project management for Emacs package development" tar ((:url . "http://github.com/cask/cask") (:keywords "speed" "convenience")) "melpa"])
  ...
  (cd-compile . [(20140716 1634) nil "run compile in a specific directory" single nil "melpa"])
  ...
  (cedit . [(20140727 905) nil "paredit-like commands for c-like languages" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (chicken-scheme . [(20141014 2237) nil "Scheme-mode extensions for Chicken Scheme" single ((:url . "http://github.com/dleslie/chicken-scheme")) "melpa"])
  ...
  (chruby . [(20141008 925) nil "Emacs integration for chruby" single ((:url . "http://www.emacswiki.org/emacs/ChrubyEl") (:keywords "ruby" "chruby")) "melpa"])
  (cider . [(20141106 658) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clj-refactor . [(20141013 37) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 6 0))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (clojure-mode . [(20141101 1) ((emacs (24 1))) "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "clojure" "clojurescript" "lisp")) "melpa"])
  ...
  (coffee-mode . [(20141106 1931) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (color-theme-sanityinc-solarized . [(20140906 332) nil "A version of Ethan Schoonover's Solarized themes" tar nil "melpa"])
  (color-theme-sanityinc-tomorrow . [(20141105 824) nil "A version of Chris Kempson's various Tomorrow themes" tar nil "melpa"])
  (color-theme-solarized . [(20140408 1309) ((color-theme (6 5 5))) "Solarized themes for Emacs" tar nil "melpa"])
  (colorsarenice-theme . [(20141105 1404) ((emacs (24))) "A colorful color theme." tar nil "melpa"])
  ...
  (company . [(20141107 552) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-auctex . [(20140714 2229) ((yasnippet (0 8 0)) (company (0 8 0)) (auctex (11 87))) "Company-mode auto-completion for AUCTeX" single ((:url . "https://github.com/alexeyr/company-auctex/")) "melpa"])
  ...
  (company-edbi . [(20140930 1215) ((company (0 8 5)) (edbi (0 1 3)) (cl-lib (0 5 0)) (s (1 9 0))) "Edbi backend for company-mode" single ((:url . "https://github.com/proofit404/company-edbi")) "melpa"])
  (company-ghc . [(20141030 704) ((cl-lib (0 5)) (company (0 8 0)) (ghc (4 1 1)) (emacs (24))) "company-mode ghc-mod backend" single ((:url . "https://github.com/iquiw/company-ghc") (:keywords "haskell" "completion")) "melpa"])
  ...
  (company-ycmd . [(20141107 1029) ((ycmd (0 1)) (company (0 8 3)) (deferred (0 2 0))) "company-mode backend for ycmd ;" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (cpputils-cmake . [(20141104 409) nil "Easy real time C++ syntax check and intellisense if you use CMake" tar nil "melpa"])
  ...
  (darcula-theme . [(20141022 652) nil "Inspired by IntelliJ's Darcula theme" single ((:url . "https://github.com/fommil/darcula-theme-emacs") (:keywords "faces")) "melpa"])
  ...
  (dash . [(20141106 455) nil "A modern list library for Emacs" single ((:keywords "lists")) "melpa"])
  ...
  (deferred . [(20140816 2205) nil "Simple asynchronous functions for emacs lisp" single ((:url . "https://github.com/kiwanami/emacs-deferred") (:keywords "deferred" "async")) "melpa"])
  ...
  (demangle-mode . [(20140912 1425) ((emacs (24)) (cl-lib (0 1))) "Automatically demangle C++ symbols" single ((:url . "https://github.com/liblit/demangle-mode") (:keywords "c" "tools")) "melpa"])
  ...
  (dic-lookup-w3m . [(20141021 556) ((w3m (20120723 324)) (stem (20120826))) "look up dictionaries on the Internet" tar ((:keywords "emacs-w3m" "w3m" "dictionary")) "melpa"])
  ...
  (diff-hl . [(20141107 331) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  ...
  (dired-avfs . [(20140719 454) ((dash (2 5 0)) (dired-hacks-utils (0 0 1))) "AVFS support for dired" single ((:keywords "files")) "melpa"])
  ...
  (dired-filter . [(20141012 925) ((dash (2 5 0)) (dired-hacks-utils (0 0 1))) "Ibuffer-like filtering for dired" single ((:keywords "files")) "melpa"])
  ...
  (dired-k . [(20141024 827) ((cl-lib (0 5)) (emacs (24))) "highlight dired buffer by file size, modified time, git status" tar ((:url . "https://github.com/syohex/emacs-dired-k")) "melpa"])
  ...
  (drupal-mode . [(20140916 1406) ((php-mode (1 5 0))) "Advanced minor mode for Drupal development" tar ((:url . "https://github.com/arnested/drupal-mode") (:keywords "programming" "php" "drupal")) "melpa"])
  ...
  (dvorak-mode . [(20141016 1419) nil "Switch to dvorak layout easily" single ((:url . "https://github.com/proofit404/dvorak-mode")) "melpa"])
  ...
  (e2wm . [(20140828 2356) ((window-layout (1 2))) "simple window manager for emacs" tar ((:keywords "tools" "window manager")) "melpa"])
  ...
  (ebib . [(20140827 700) nil "a BibTeX database manager" tar ((:keywords "text" "bibtex")) "melpa"])
  ...
  (edbi-database-url . [(20140831 1139) ((emacs (24)) (edbi (0 1 3))) "Run edbi with database url" single ((:url . "https://github.com/proofit404/edbi-database-url")) "melpa"])
  (edbi-django . [(20141010 1411) ((emacs (24)) (edbi (0 1 3)) (f (0 17 1))) "Run edbi with django settings" tar ((:url . "https://github.com/proofit404/edbi-django")) "melpa"])
  (edbi-sqlite . [(20140923 40) ((emacs (24)) (edbi (0 1 3))) "Open sqlite files with edbi" single ((:url . "https://github.com/proofit404/edbi-sqlite")) "melpa"])
  ...
  (edts . [(20141003 236) ((auto-complete (1 3 1)) (auto-highlight-symbol (1 53)) (dash (1 5 0)) (eproject (1 5)) (erlang (2 4 1)) (f (0 16 0)) (popup (0 4))) "Erlang Development Tool Suite" tar nil "melpa"])
  ...
  (eide . [(20141105 850) nil "IDE interface" tar nil "melpa"])
  ...
  (el-get . [(20141106 2207) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elixir-mix . [(20141003 632) nil "Emacs integration for Elixir's mix" single ((:url . "http://github.com/tonini/elixir-mix.el") (:keywords "elixir" "mix" "elixir-mix")) "melpa"])
  (elixir-mode . [(20141102 649) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (emmet-mode . [(20141025 1540) nil "Unofficial Emmet's support for emacs" single ((:url . "https://github.com/smihica/emmet-mode") (:keywords "convenience")) "melpa"])
  (emms . [(20141104 1238) nil "The Emacs Multimedia System" tar ((:keywords "emms" "mp3" "mpeg" "multimedia")) "melpa"])
  ...
  (ensime . [(20141101 910) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (erc-tweet . [(20140827 1056) ((erc (5 3))) "shows text of a tweet when an url is posted in erc buffers" single ((:keywords "extensions")) "melpa"])
  ...
  (es-mode . [(20141104 750) nil "A major mode for editing Elasticsearch queries" tar ((:url . "http://www.github.com/dakrone/es-mode") (:keywords "elasticsearch")) "melpa"])
  ...
  (eshell-prompt-extras . [(20140821 54) nil "Display extra information for your eshell prompt." single ((:keywords "eshell" "prompt")) "melpa"])
  ...
  (ess . [(20141107 1321) nil "No description available." tar nil "melpa"])
  ...
  (esup . [(20141017 1345) nil "the Emacs StartUp Profiler (ESUP)" single ((:url . "http://github.com/jschaf/esup") (:keywords "emacs-lisp" "elisp" "profile" "startup")) "melpa"])
  ...
  (eval-in-repl . [(20140913 1443) ((dash (0 0 0)) (paredit (0 0 0))) "Consistent ESS-like eval interface for various REPLs" tar nil "melpa"])
  ...
  (evil . [(20141105 106) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-jumper . [(20141027 809) ((evil (0))) "Jump like vimmers do!" single ((:url . "https://github.com/bling/evil-jumper") (:keywords "evil" "vim" "jumplist" "jump" "list")) "melpa"])
  ...
  (evil-lisp-state . [(20141105 1854) ((evil (1 0 9)) (smartparens (1 6 1))) "An evil state to navigate Lisp code and modify it with smartparens" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  (evil-matchit . [(20141021 646) nil "Vim matchit ported into Emacs (requires EVIL)" tar nil "melpa"])
  (evil-nerd-commenter . [(20141031 316) nil "Comment/uncomment lines efficiently. Like Nerd Commenter in Vim" tar nil "melpa"])
  ...
  (expand-region . [(20140610 1519) nil "Increase selected region by semantic units." tar nil "melpa"])
  ...
  (eyebrowse . [(20141013 2355) ((dash (2 7 0))) "Easy window config switching" single ((:url . "https://github.com/wasamasa/eyebrowse") (:keywords "convenience")) "melpa"])
  ...
  (fasm-mode . [(20140907 933) nil "Fasm major mode" single ((:url . "https://github.com/Fanael/fasm-mode")) "melpa"])
  (fastnav . [(20120211 657) nil "Fast navigation and editing routines." single ((:keywords "nav" "fast" "fastnav" "navigation")) "melpa"])
  (feature-mode . [(20141018 646) nil "Major mode for editing Gherkin (i.e. Cucumber) user stories" tar nil "melpa"])
  ...
  (find-temp-file . [(20140808 223) nil "Open quickly a temporary file" single ((:url . "https://github.com/thisirs/find-temp-file.git") (:keywords "convenience")) "melpa"])
  ...
  (floobits . [(20141017 1333) ((json (1 2)) (highlight (0))) "Floobits plugin for real-time collaborative editing" tar ((:url . "http://github.com/Floobits/floobits-emacs") (:keywords "comm" "tools")) "melpa"])
  ...
  (flycheck . [(20141102 652) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  (flycheck-cask . [(20140814 116) ((emacs (24 1)) (flycheck (0 14)) (dash (2 4 0))) "Cask support in Flycheck" single ((:url . "https://github.com/flycheck/flycheck-cask") (:keywords "tools" "convenience")) "melpa"])
  ...
  (flycheck-d-unittest . [(20140829 854) ((flycheck (0 21 -3 1)) (dash (1 4 0))) "Add D unittest support to flycheck" single ((:url . "https://github.com/tom-tan/flycheck-d-unittest/") (:keywords "flycheck" "d")) "melpa"])
  ...
  (font-lock-studio . [(20141017 1433) ((emacs (24 3))) "interactive debugger for Font Lock keywords." single ((:url . "https://github.com/Lindydancer/font-lock-studio") (:keywords "faces" "tools")) "melpa"])
  ...
  (fortpy . [(20140911 1533) ((epc (0 1 0)) (auto-complete (1 4)) (python-environment (0 0 2)) (pos-tip (0 4 5))) "a Fortran auto-completion for Emacs" tar nil "melpa"])
  (fountain-mode . [(20141012 2235) ((s (1 9 0))) "Major mode for screenwriting in Fountain markup" single ((:url . "https://github.com/rnkn/fountain-mode") (:keywords "wp")) "melpa"])
  ...
  (fsharp-mode . [(20141030 413) ((auto-complete (1 4)) (popup (0 5)) (pos-tip (0 4 5)) (s (1 3 1)) (dash (1 1 0))) "F# mode for Emacs" tar nil "melpa"])
  (fuel . [(20141104 740) ((cl-lib (0 2)) (emacs (24 2))) "Major mode for the Factor programming language." tar nil "melpa"])
  ...
  (function-args . [(20141016 750) nil "C++ completion for GNU Emacs" single ((:url . "https://github.com/abo-abo/function-args")) "melpa"])
  ...
  (ggtags . [(20141106 1940) ((emacs (24)) (cl-lib (0 5))) "emacs frontend to GNU Global source code tagging system" single ((:url . "https://github.com/leoliu/ggtags") (:keywords "tools" "convenience")) "melpa"])
  (gh . [(20140706 1506) ((eieio (1 3)) (pcache (0 2 4)) (logito (0 1))) "A GitHub library for Emacs" tar nil "melpa"])
  (ghc . [(20141102 1545) nil "Sub mode for Haskell mode" tar nil "melpa"])
  ...
  (git-gutter . [(20141025 606) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (gitlab . [(20141106 1206) ((s (1 9 0)) (dash (2 9 0)) (pkg-info (0 5 0)) (request (0 1 0))) "Emacs client for Gitlab" tar ((:url . "https://github.com/nlamirault/emacs-gitlab") (:keywords "gitlab")) "melpa"])
  ...
  (gnu-apl-mode . [(20141105 2328) ((emacs (24))) "Integrate GNU APL with Emacs" tar nil "melpa"])
  ...
  (go-eldoc . [(20140921 1825) ((go-mode (0)) (cl-lib (0 5))) "eldoc for go-mode" single ((:url . "https://github.com/syohex/emacs-go-eldoc")) "melpa"])
  (go-errcheck . [(20140107 1046) nil "errcheck integration for go-mode" single nil "melpa"])
  (go-mode . [(20141025 219) nil "Major mode for the Go programming language" tar ((:url . "https://github.com/dominikh/go-mode.el") (:keywords "languages" "go")) "melpa"])
  (go-play . [(20120914 1248) nil "Paste to play.golang.org" single nil "melpa"])
  (go-projectile . [(20141105 2108) ((projectile (0 10 0)) (go-mode (0)) (go-eldoc (0 16))) "Go add-ons for Projectile" single ((:url . "https://github.com/dougm/go-projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (google-translate . [(20141006 1505) nil "Emacs interface to Google Translate." tar nil "melpa"])
  ...
  (gotham-theme . [(20141013 2347) nil "A very dark Emacs color theme." single ((:url . "https://github.com/wasamasa/gotham-theme")) "melpa"])
  ...
  (grails-projectile-mode . [(20141020 219) ((projectile (0 10 0)) (emacs (24)) (cl-lib (0 5))) "Grails mode with Projectile for projects management." single ((:keywords "grails" "projectile")) "melpa"])
  ...
  (guide-key . [(20140828 807) ((popwin (0 3 0))) "Guide the following key bindings automatically and dynamically" single ((:url . "https://github.com/kai2nenobu/guide-key") (:keywords "help" "convenience")) "melpa"])
  ...
  (haml-mode . [(20141106 456) ((ruby-mode (1 0))) "Major mode for editing Haml files" single ((:url . "http://github.com/nex3/haml/tree/master") (:keywords "markup" "language" "html")) "melpa"])
  ...
  (haskell-mode . [(20141104 1247) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141107 351) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20141021 2049) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-bibtex . [(20141029 1724) ((helm (1 5 5)) (ebib (1 15)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-bind-key . [(20141007 2041) ((bind-key (1 0)) (helm (1 6 4))) "helm-source for for bind-key." single ((:keywords "convenience" "emulation")) "melpa"])
  ...
  (helm-cmd-t . [(20140828 412) nil "cmd-t style completion" tar ((:url . "https://github.com/lewang/helm-cmd-t") (:keywords "helm" "project-management" "completion" "convenience" "cmd-t" "textmate")) "melpa"])
  ...
  (helm-dash . [(20141031 709) ((helm (0 0 0))) "Offline documentation browser for +150 APIs using Dash docsets." single ((:url . "http://github.com/areina/helm-dash") (:keywords "docs")) "melpa"])
  ...
  (helm-gitlab . [(20141107 843) ((s (1 9 0)) (dash (2 9 0)) (helm (1 0)) (gitlab (0))) "Helm interface to Gitlab" single ((:url . "https://github.com/nlamirault/emacs-gitlab") (:keywords "gitlab" "helm")) "melpa"])
  ...
  (helm-gtags . [(20141103 609) ((helm (1 5 6)) (cl-lib (0 5))) "GNU GLOBAL helm interface" single ((:url . "https://github.com/syohex/emacs-helm-gtags")) "melpa"])
  ...
  (helm-idris . [(20140718 1429) ((helm (0 0 0)) (idris-mode (0 9 14))) "A Helm datasource for Idris documentation, queried from the compiler" single ((:keywords "languages" "helm")) "melpa"])
  ...
  (helm-ls-git . [(20141013 2357) ((helm (1 5))) "list git files." single nil "melpa"])
  ...
  (helm-projectile . [(20141107 441) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (helm-sage . [(20141005 413) ((cl-lib (0 5)) (helm (1 5 6)) (sage-shell-mode (0 0 1))) "A helm extension for sage-shell-mode." single ((:url . "https://github.com/stakemori/helm-sage") (:keywords "sage" "math" "helm")) "melpa"])
  ...
  (helm-swoop . [(20141019 2330) ((helm (1 0)) (emacs (24))) "Efficiently hopping squeezed lines powered by helm interface" single ((:url . "https://github.com/ShingoFukuyama/helm-swoop") (:keywords "helm" "swoop" "inner" "buffer" "search")) "melpa"])
  (helm-themes . [(20140909 657) ((helm (1 0))) "Color theme selection with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-themes")) "melpa"])
  ...
  (highlight-stages . [(20140929 1003) nil "highlight staged (quasi-quoted) expressions" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (hl-anything . [(20141107 246) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more" single nil "melpa"])
  ...
  (hookify . [(20140914 447) ((s (1 9 0)) (dash (1 5 0))) "Interactive commands to create temporary hooks" single ((:url . "https://github.com/Silex/hookify") (:keywords "hook" "convenience")) "melpa"])
  ...
  (icicles . [(20141028 641) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (ido-ubiquitous . [(20140904 1547) ((emacs (24 1))) "Use ido (nearly) everywhere." single ((:url . "https://github.com/DarwinAwardWinner/ido-ubiquitous") (:keywords "convenience" "completion" "ido")) "melpa"])
  ...
  (ids-edit . [(20141103 556) ((emacs (24 3))) "IDS (Ideographic Description Sequence) editing tool" tar ((:url . "http://github.com/kawabata/ids-edit") (:keywords "text")) "melpa"])
  ...
  (impatient-mode . [(20140908 2000) ((cl-lib (0 3)) (simple-httpd (1 4 0)) (htmlize (1 40))) "Serve buffers live over HTTP" tar ((:url . "https://github.com/netguy204/imp.el")) "melpa"])
  ...
  (indent-guide . [(20140913 435) nil "show vertical lines to guide indentation" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (insert-shebang . [(20140721 522) nil "Insert shebang line automatically." single ((:url . "http://github.com/psachin/insert-shebang") (:keywords "shebang" "tool" "convenience")) "melpa"])
  ...
  (irony . [(20141030 1555) ((cl-lib (0 5))) "C/C++ minor mode powered by libclang" tar ((:url . "https://github.com/Sarcasm/irony-mode") (:keywords "c" "convenience" "tools")) "melpa"])
  ...
  (js2-mode . [(20141105 154) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  (js2-refactor . [(20141002 905) ((js2-mode (20101228)) (s (1 9 0)) (multiple-cursors (1 0 0)) (dash (1 0 0)) (s (1 0 0)) (yasnippet (20130218))) "A JavaScript refactoring library for emacs." tar nil "melpa"])
  ...
  (json-reformat . [(20141028 712) nil "Reformatting tool for JSON" single ((:url . "https://github.com/gongo/json-reformat") (:keywords "json")) "melpa"])
  ...
  (julia-mode . [(20141105 2212) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (ledger-mode . [(20141010 2202) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  ...
  (leuven-theme . [(20141104 1403) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (linked-buffer . [(20141023 150) ((emacs (24)) (m-buffer (0 5)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (lispy . [(20141106 1300) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97))) "vi-like Paredit" tar nil "melpa"])
  ...
  (lui . [(20141107 407) ((tracking (0))) "Linewise User Interface" tar nil "melpa"])
  ...
  (m-buffer . [(20140929 1327) ((dash (2 5 0)) (emacs (24 3))) "Buffer Manipulation Functions" single nil "melpa"])
  ...
  (magit-gerrit . [(20141102 2233) ((magit (1 2 0))) "Magit plugin for Gerrit Code Review" single ((:url . "https://github.com/terranpro/magit-gerrit")) "melpa"])
  ...
  (magma-mode . [(20141006 1426) ((cl-lib (0 3)) (dash (2 6 0)) (f (0 17 1))) "Magma mode for Emacs" tar nil "melpa"])
  (magnatune . [(20141028 705) ((dash (2 9 0)) (s (1 9 0))) "browse to magnatune's music catalog" single nil "melpa"])
  ...
  (make-it-so . [(20140916 137) ((helm (1 5 3)) (emacs (24))) "Transform files with Makefile recipes." tar ((:url . "https://github.com/abo-abo/make-it-so") (:keywords "make" "dired")) "melpa"])
  ...
  (malabar-mode . [(20140903 1347) ((fringe-helper (1 0 1))) "A better Java mode for Emacs" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "language" "malabar")) "melpa"])
  (malinka . [(20141106 934) ((s (1 9 0)) (dash (2 4 0)) (f (0 11 0)) (cl-lib (0 3)) (rtags (0 0)) (projectile (0 11 0))) "A C/C++ project configuration package for Emacs" single ((:url . "https://github.com/LefterisJP/malinka") (:keywords "c" "c++" "project-management")) "melpa"])
  ...
  (mandoku . [(20141027 130) ((org (8 0))) "A tool to access repositories of premodern Chinese texts" tar nil "melpa"])
  (mandoku-meta-zb . [(20141105 2222) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (matlab-mode . [(20141105 1643) nil "No description available." tar nil "melpa"])
  (maude-mode . [(20140212 302) nil "Emacs mode for the programming language Maude" single ((:keywords "maude")) "melpa"])
  (maven-test-mode . [(20141104 903) nil "No description available." single nil "melpa"])
  ...
  (mbe . [(20141106 1442) ((emacs (24)) (cl-lib (0 5))) "Macros by Example" single ((:keywords "tools")) "melpa"])
  ...
  (merlin . [(20141105 330) nil "Mode for Merlin, an assistant for OCaml." tar ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (misc-cmds . [(20141029 2242) nil "Miscellaneous commands (interactive functions)." single ((:url . "http://www.emacswiki.org/misc-cmds.el") (:keywords "internal" "unix" "extensions" "maint" "local")) "melpa"])
  ...
  (moe-theme . [(20141106 125) nil "A colorful eye-candy theme. Moe, moe, kyun!" tar nil "melpa"])
  ...
  (monokai-theme . [(20141106 2250) nil "A fruity color theme for Emacs." single ((:url . "http://github.com/oneKelvinSmith/monokai-emacs")) "melpa"])
  (monroe . [(20141027 456) nil "Yet another client for nREPL" single ((:url . "http://www.github.com/sanel/monroe") (:keywords "languages" "clojure" "nrepl" "lisp")) "melpa"])
  ...
  (mpages . [(20141030 544) nil "An Emacs buffer for quickly writing your Morning Pages" single ((:url . "https://github.com/slevin/mpages")) "melpa"])
  ...
  (names . [(20141104 1033) ((emacs (24 1)) (cl-lib (0 5))) "Namespaces for emacs-lisp. Works like C++ namespaces to avoid name clobbering." tar ((:url . "http://github.com/Bruce-Connor/names") (:keywords "extensions" "lisp")) "melpa"])
  ...
  (navorski . [(20140915 1323) ((s (1 9 0)) (dash (1 5 0)) (multi-term (0 8 14))) "Helping you live in the terminal, like Viktor did." single ((:keywords "terminal")) "melpa"])
  ...
  (neotree . [(20141006 649) nil "A tree plugin like NerdTree for Vim" single ((:url . "https://github.com/jaypei/emacs-neotree")) "melpa"])
  ...
  (niflheim-theme . [(20140827 1130) nil "A port of the Nifleim theme to Emacs" single ((:url . "https://github.com/niflheim-theme/emacs") (:keywords "themes")) "melpa"])
  ...
  (noccur . [(20140905 512) ((projectile (0 10 0))) "Run multi-occur on project/dired files" single ((:keywords "convenience")) "melpa"])
  ...
  (notmuch . [(20141031 954) nil "No description available." tar nil "melpa"])
  ...
  (nu-mode . [(20141107 1359) ((undo-tree (0 6 5)) (helm (20140902 1005))) "Modern Emacs Prompts Based Keybinding." tar nil "melpa"])
  (number . [(20140719 239) nil "Working with numbers at point." single nil "melpa"])
  ...
  (ocp-indent . [(20140826 429) nil "automatic indentation with ocp-indent" single ((:url . "http://www.typerex.org/ocp-indent.html") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (omnisharp . [(20141104 851) ((json (1 2)) (dash (1 8 0)) (popup (0 5)) (auto-complete (1 4)) (flycheck (0 19)) (csharp-mode (0 8 6))) "Omnicompletion (intellisense) and more for C#" single ((:url . "https://github.com/sp3ctum/omnisharp-emacs") (:keywords "csharp" "c#" "ide" "auto-complete" "intellisense")) "melpa"])
  ...
  (org-eldoc . [(20141101 711) ((org (8))) "display org header and src block info using eldoc" single ((:url . "https://bitbucket.org/ukaszg/org-eldoc") (:keywords "eldoc" "outline" "breadcrumb" "org" "babel" "minibuffer")) "melpa"])
  ...
  (org-toc . [(20141104 127) nil "add table of contents to org-mode files" single ((:url . "https://github.com/snosov1/org-toc") (:keywords "org-mode" "org" "toc" "table" "of" "contents")) "melpa"])
  (org-toodledo . [(20140331 606) nil "Toodledo integration for Emacs Org mode" tar ((:keywords "outlines" "data")) "melpa"])
  (org-trello . [(20141104 1446) ((request-deferred (0 1 0)) (deferred (0 3 2)) (s (1 9 0)) (dash (2 8 0)) (emacs (24))) "Minor mode to synchronize org-mode buffer and trello board" tar nil "melpa"])
  (org-vcard . [(20140916 437) nil "org-mode support for vCard export and import." tar ((:keywords "outlines" "org" "vcard")) "melpa"])
  (org-wc . [(20141031 2320) nil "Count words in org mode trees." single nil "melpa"])
  (org2blog . [(20141105 1122) ((org (8 1)) (xml-rpc (1 6 8)) (metaweblog (0 1))) "Blog from Org mode to wordpress" tar nil "melpa"])
  ...
  (outshine . [(20141014 1001) nil "outline with outshine outshines outline" single ((:url . "https://github.com/tj64/outshine")) "melpa"])
  ...
  (ox-reveal . [(20141016 840) ((org (8 0))) "reveal.js Presentation Back-End for Org Export Engine" single ((:keywords "outlines" "hypermedia" "slideshow" "presentation")) "melpa"])
  ...
  (p4 . [(20141009 801) nil "Simple Perforce-Emacs Integration" single ((:url . "https://github.com/gareth-rees/p4.el")) "melpa"])
  (pabbrev . [(20141021 1434) nil "Predictive abbreviation expansion" single nil "melpa"])
  (package+ . [(20141028 244) nil "Extensions for the package library." single ((:url . "TBA") (:keywords "extensions" "tools")) "melpa"])
  (package-build . [(20141022 1058) ((cl-lib (0 2))) "Tools for assembling a package archive" single ((:keywords "tools")) "melpa"])
  ...
  (packed . [(20140913 1531) ((cl-lib (0 5))) "package manager agnostic Emacs Lisp package utilities" single ((:url . "https://github.com/tarsius/packed") (:keywords "compile" "convenience" "lisp" "package" "library")) "melpa"])
  ...
  (pandoc-mode . [(20141021 717) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (paradox . [(20141023 236) ((emacs (24 1)) (dash (2 6 0)) (cl-lib (0 5)) (json (1 3))) "A modern Packages Menu. Colored, with package ratings, and customizable." tar ((:url . "http://github.com/Bruce-Connor/paradox") (:keywords "package" "packages" "mode-line")) "melpa"])
  ...
  (paren-face . [(20141023 952) nil "a face for parentheses in lisp modes" single ((:url . "http://github.com/tarsius/paren-face")) "melpa"])
  ...
  (passthword . [(20140717 557) ((cl-lib (0 5))) "Simple password manager" single nil "melpa"])
  ...
  (persp-mode . [(20141107 1233) nil "\"perspectives\" + save/load + shared among frames - bugs." single ((:url . "https://github.com/Bad-ptr/persp-mode.el") (:keywords "perspectives" "session")) "melpa"])
  ...
  (perspective . [(20140606 1246) nil "switch between named \"perspectives\" of the editor" single ((:url . "http://github.com/nex3/perspective-el") (:keywords "workspace" "convenience" "frames")) "melpa"])
  ...
  (phi-search . [(20141106 544) nil "another incremental search command, compatible with \"multiple-cursors\"" tar ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (php-mode . [(20141027 353) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (popup . [(20141002 320) ((cl-lib (0 3))) "Visual Popup User Interface" single ((:keywords "lisp")) "melpa"])
  (popup-complete . [(20140917 519) ((popup (0 5 0))) "completion with popup" single ((:url . "https://github.com/syohex/emacs-popup-complete")) "melpa"])
  ...
  (pretty-mode . [(20141011 1339) nil "Redisplay parts of the buffer as pretty symbols." single ((:url . "https://github.com/akatov/pretty-mode") (:keywords "pretty" "unicode" "symbols")) "melpa"])
  ...
  (prodigy . [(20140915 1208) ((s (1 8 0)) (dash (2 4 0)) (f (0 14 0)) (emacs (24))) "Manage external services from within Emacs" single ((:url . "http://github.com/rejeep/prodigy.el")) "melpa"])
  ...
  (projectile . [(20141105 225) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20141024 1347) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  (projector . [(20140929 918) ((alert (1 1)) (projectile (0 11 0))) "Lightweight library for managing project/repository-aware shell and command buffers" single ((:url . "https://github.com/waymondo/projector")) "melpa"])
  ...
  (punctuality-logger . [(20141104 1401) nil "Punctuality logger for Emacs" single ((:url . "https://gitlab.com/elzair/punctuality-logger") (:keywords "reminder" "calendar")) "melpa"])
  ...
  (py-isort . [(20141019 11) nil "Use isort to sort the imports in a Python buffer" single ((:url . "http://paetzke.me/project/py-isort.el")) "melpa"])
  (pydoc-info . [(20110301 34) nil "Better Python support for info-lookup-symbol." tar nil "melpa"])
  (pyenv-mode . [(20141013 1304) nil "Integrate pyenv with python-mode" single ((:url . "https://github.com/proofit404/pyenv-mode")) "melpa"])
  ...
  (racket-mode . [(20141105 758) nil "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (rainbow-delimiters . [(20141107 1253) nil "Highlight nested parens, brackets, braces a different color at each depth." single ((:url . "https://github.com/Fanael/rainbow-delimiters") (:keywords "faces" "convenience" "lisp" "tools")) "melpa"])
  ...
  (realgud . [(20141106 813) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (req-package . [(20141107 504) ((use-package (1 0)) (dash (2 7 0)) (log4e (0 2 0))) "A use-package wrapper for package runtime dependencies management" single ((:url . "https://github.com/edvorg/req-package") (:keywords "dotemacs" "startup" "speed" "config" "package")) "melpa"])
  ...
  (restclient . [(20141007 1041) nil "An interactive HTTP client for Emacs" tar ((:keywords "http")) "melpa"])
  ...
  (robe . [(20140915 1700) ((inf-ruby (2 3 0))) "Code navigation, documentation lookup and completion for Ruby" tar ((:url . "https://github.com/dgutov/robe") (:keywords "ruby" "convenience" "rails")) "melpa"])
  ...
  (rspec-mode . [(20141005 1509) ((ruby-mode (1 0)) (cl-lib (0 4))) "Enhance ruby-mode for RSpec" tar ((:url . "http://github.com/pezra/rspec-mode") (:keywords "rspec" "ruby")) "melpa"])
  ...
  (rust-mode . [(20140817 756) nil "A major emacs mode for editing Rust source code" single ((:url . "https://github.com/rust-lang/rust") (:keywords "languages")) "melpa"])
  ...
  (sage-shell-mode . [(20141106 1913) ((cl-lib (0 5)) (deferred (0 3 2))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (sbt-mode . [(20141028 1023) ((scala-mode2 (0 22))) "Major mode for sbt >= 0.12 with scala >= 2.9" tar nil "melpa"])
  ...
  (scala-outline-popup . [(20141107 513) ((popup (0 5 0)) (scala-mode2 (0 22))) "scala file summary popup" single ((:url . "https://github.com/ancane/scala-outline-popup.el") (:keywords "scala" "structure" "summary")) "melpa"])
  ...
  (sekka . [(20140929 622) ((cl-lib (0 3)) (concurrent (0 3 1)) (popup (0 5 0))) "A client for Sekka IME server" single ((:url . "https://github.com/kiyoka/sekka") (:keywords "ime" "skk" "japanese")) "melpa"])
  ...
  (shm . [(20141011 508) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (skeletor . [(20141104 926) ((s (1 7 0)) (f (0 14 0)) (dash (2 2 0)) (cl-lib (0 3)) (emacs (24 1))) "Provides project skeletons for Emacs" tar nil "melpa"])
  ...
  (slime . [(20141024 937) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  (slime-annot . [(20131230 1908) ((slime (0))) "cl-annot support for SLIME" single ((:url . "https://github.com/arielnetworks/cl-annot")) "melpa"])
  (slime-company . [(20140908 514) ((slime (2 3 2)) (company (0 7))) "slime completion backend for company mode" single ((:keywords "convenience" "lisp" "abbrev")) "melpa"])
  ...
  (sly . [(20141106 401) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (smart-indent-rigidly . [(20140801 1051) nil "Smart rigid indenting" single ((:url . "https://github.com/re5et/smart-indent-rigidly") (:keywords "indenting" "coffee-mode" "haml-mode" "sass-mode")) "melpa"])
  (smart-mode-line . [(20140904 1144) ((emacs (24 3)) (dash (2 2 0)) (rich-minority (0 1))) "A color coded smart mode-line." tar ((:url . "http://github.com/Bruce-Connor/smart-mode-line") (:keywords "mode-line" "faces" "theme" "themes")) "melpa"])
  (smart-mode-line-powerline-theme . [(20140926 142) ((emacs (24 3)) (powerline (2 3)) (smart-mode-line (2 5))) "smart-mode-line theme that mimics the powerline appearance." single ((:url . "http://github.com/Bruce-Connor/smart-mode-line")) "melpa"])
  ...
  (smartparens . [(20141107 1100) ((cl-lib (0 3)) (dash (2 6 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (smex . [(20141027 245) ((emacs (24))) "M-x interface with Ido-style fuzzy matching." single ((:url . "http://github.com/nonsequitur/smex/") (:keywords "convenience" "usability")) "melpa"])
  ...
  (smyx-theme . [(20141106 933) nil "smyx Color Theme" single ((:keywords "color" "theme" "smyx")) "melpa"])
  (snakemake-mode . [(20140823 604) ((emacs (24))) "Major mode for editing Snakemake files" single ((:url . "https://github.com/kyleam/snakemake-mode") (:keywords "tools")) "melpa"])
  ...
  (solarized-theme . [(20141103 1605) ((dash (2 6 0))) "The Solarized color theme, ported to Emacs." tar nil "melpa"])
  (sonic-pi . [(20141001 235) ((cl-lib (0 5)) (osc (0 1)) (dash (2 2 0)) (emacs (24))) "A Emacs client for SonicPi" tar ((:url . "http://www.github.com/repl-electric/sonic-pi.el") (:keywords "sonicpi" "ruby")) "melpa"])
  ...
  (stan-mode . [(20141106 902) nil "Major mode for editing Stan files" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languanges")) "melpa"])
  (stan-snippets . [(20141106 902) ((yasnippet (0 8 0)) (stan-mode (2 4 2))) "Yasnippets for Stan" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languages")) "melpa"])
  ...
  (stekene-theme . [(20141101 1615) ((emacs (24))) "Low-contrast (except for strings) theme, in light and dark versions." tar nil "melpa"])
  ...
  (stripe-buffer . [(20141106 1042) ((cl-lib (1 0))) "Use a different background for even and odd lines" single ((:url . "https://github.com/sabof/stripe-buffer")) "melpa"])
  ...
  (swift-mode . [(20141107 300) ((emacs (24 1))) "Major-mode for Apple's Swift programming language." single ((:keywords "languages" "swift")) "melpa"])
  (switch-window . [(20140919 734) nil "A *visual* way to choose a window to switch to" single ((:url . "http://tapoueh.org/emacs/switch-window.html") (:keywords "window" "navigation")) "melpa"])
  ...
  (tangotango-theme . [(20140727 838) nil "Tango Palette color theme for Emacs 24." single ((:url . "https://github.com/juba/color-theme-tangotango") (:keywords "tango" "palette" "color" "theme" "emacs")) "melpa"])
  ...
  (term-alert . [(20140804 43) ((term-cmd (1 0)) (alert (1 1))) "Get notifications when commands complete in the Emacs terminal emulator" single ((:url . "https://github.com/CallumCameron/term-alert") (:keywords "notifications" "processes")) "melpa"])
  (term-cmd . [(20140803 113) nil "Send commands to Emacs from programs running under term.el" single ((:url . "https://github.com/CallumCameron/term-cmd") (:keywords "processes")) "melpa"])
  (tern . [(20141107 635) ((json (1 2)) (cl-lib (0 5)) (emacs (24))) "Tern-powered JavaScript integration" single ((:url . "http://ternjs.net/")) "melpa"])
  (tern-auto-complete . [(20140905 643) ((tern (0 0 1)) (auto-complete (1 4)) (cl-lib (0 5)) (emacs (24))) "Tern Completion by auto-complete.el" single nil "melpa"])
  (tern-django . [(20141107 101) ((emacs (24)) (tern (0 0 1)) (f (0 17 1))) "Create tern projects for django applications." tar ((:url . "https://github.com/proofit404/tern-django")) "melpa"])
  (terraform-mode . [(20140731 2228) ((cl-lib (0 5))) "Major mode for terraform configuration file" single ((:url . "https://github.com/syohex/emacs-terraform-mode")) "melpa"])
  ...
  (tracking . [(20140906 548) ((shorten (0 1))) "Buffer modification tracking" single ((:url . "https://github.com/jorgenschaefer/circe/wiki/Tracking")) "melpa"])
  ...
  (turnip . [(20140726 1241) ((dash (2 6 0)) (s (1 9 0))) "Interacting with tmux from Emacs" single ((:keywords "terminals" "tools")) "melpa"])
  ...
  (undercover . [(20141012 226) ((emacs (24)) (dash (2 0 0)) (shut-up (0 3 2))) "Test coverage library for Emacs" single ((:url . "https://github.com/sviridov/undercover.el") (:keywords "lisp" "tests" "coverage" "tools")) "melpa"])
  ...
  (vc-auto-commit . [(20141026 819) nil "Auto-committing feature for your repository" tar ((:url . "http://github.com/thisirs/vc-auto-commit.git") (:keywords "vc" "convenience")) "melpa"])
  ...
  (vc-darcs . [(20140531 645) nil "a VC backend for darcs" single ((:keywords "vc")) "melpa"])
  ...
  (vlf . [(20141015 1656) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (w3m . [(20141106 1753) nil "an Emacs interface to w3m" tar ((:keywords "w3m" "www" "hypermedia")) "melpa"])
  (wacspace . [(20140826 2232) ((dash (1 2 0)) (cl-lib (0 2))) "The WACky WorkSPACE manager for emACS" tar nil "melpa"])
  (wakatime-mode . [(20140915 1633) nil "Automatic time tracking extension based on WakaTime" single ((:keywords "calendar" "comm")) "melpa"])
  ...
  (web . [(20141102 1101) ((dash (2 9 0)) (s (1 5 0))) "useful HTTP client" single ((:url . "http://github.com/nicferrier/emacs-web") (:keywords "lisp" "http" "hypermedia")) "melpa"])
  ...
  (web-mode . [(20141102 1032) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (worf . [(20140716 510) ((helm (1 5 3)) (ace-jump-mode (2 0))) "A warrior does not press so many keys! (in org-mode)" single ((:url . "https://github.com/abo-abo/worf") (:keywords "lisp")) "melpa"])
  ...
  (xtest . [(20141106 520) ((cl-lib (0 5))) "Simple Testing with Emacs & ERT" single ((:url . "https://github.com/promethial/xtest") (:keywords "testing" "ert")) "melpa"])
  ...
  (yaml-mode . [(20140824 2132) nil "Major mode for editing YAML files" single ((:keywords "data" "yaml")) "melpa"])
  ...
  (yasnippet . [(20141102 1554) nil "Yet another snippet extension for Emacs." tar ((:url . "http://github.com/capitaomorte/yasnippet") (:keywords "convenience" "emulation")) "melpa"])
  ...
  (ycmd . [(20141106 251) ((emacs (24)) (anaphora (1 0 0)) (request (0 2 0)) (deferred (0 3 2)) (request-deferred (0 2 0)) (popup (0 5 0))) "emacs bindings to the ycmd completion server ;" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (zenburn-theme . [(20140811 754) nil "A low contrast color theme for Emacs." single ((:url . "http://github.com/bbatsov/zenburn-emacs")) "melpa"])
  ...
  (org . [(20141103) nil "Outline-based notes management and organizer" tar nil "gnu"])
