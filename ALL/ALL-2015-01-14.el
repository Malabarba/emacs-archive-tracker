'(
  ...
  (ace-isearch . [(20150112 2209) ((ace-jump-mode (2 0)) (helm-swoop (1 4)) (emacs (24))) "A seamless bridge between isearch and ace-jump-mode" single ((:url . "https://github.com/tam17aki/ace-isearch")) "melpa"])
  ...
  (ace-window . [(20150101 543) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  ...
  (atom-dark-theme . [(20150113 1441) nil "An Emacs port of the Atom Dark theme from Atom.io." single ((:url . "https://github.com/whitlockjc/atom-dark-theme-emacs") (:keywords "themes" "atom" "dark")) "melpa"])
  ...
  (auto-install . [(20150105 757) nil "Auto install elisp file" single ((:url . "http://www.emacswiki.org/emacs/download/auto-install.el") (:keywords "auto-install")) "melpa"])
  ...
  (chinese-pyim . [(20150113 644) ((cl-lib (0 5))) "Chinese pinyin input method" tar ((:url . "https://github.com/tumashu/chinese-pyim") (:keywords "convenience" "chinese" "pinyin" "input-method")) "melpa"])
  ...
  (cider . [(20150112 840) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clocker . [(20150112 1303) ((projectile (0 11 0)) (dash (2 10))) "Note taker and clock-in enforcer" single ((:keywords "org")) "melpa"])
  ...
  (dart-mode . [(20140815 1009) nil "Major mode for editing Dart files" single ((:url . "http://code.google.com/p/dart-mode") (:keywords "language")) "melpa"])
  ...
  (ddskk . [(20150113 1236) ((cdb (20141201 754))) "Simple Kana to Kanji conversion program." tar nil "melpa"])
  ...
  (diff-hl . [(20150102 1543) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  ...
  (dyalog-mode . [(20150112 822) ((cl-lib (0 2))) "Major mode for editing Dyalog APL source code" tar ((:url . "https://bitbucket.org/harsman/dyalog-mode/") (:keywords "languages")) "melpa"])
  ...
  (ein . [(20150106 437) ((websocket (1 3)) (request (0 2))) "Emacs IPython Notebook" tar nil "melpa"])
  ...
  (el-get . [(20150105 1747) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (ergoemacs-mode . [(20150113 1313) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  ...
  (floobits . [(20150104 1905) ((json (1 2)) (highlight (0))) "Floobits plugin for real-time collaborative editing" tar ((:url . "http://github.com/Floobits/floobits-emacs") (:keywords "comm" "tools")) "melpa"])
  ...
  (flycheck . [(20150112 1039) ((dash (2 4 0)) (pkg-info (0 4)) (let-alist (1 0 1)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (flycheck-clojure . [(20150110 751) ((cider (0 8 1)) (flycheck (0 22 -3 1)) (let-alist (1 0 1)) (emacs (24))) "Flycheck: Clojure support" single ((:url . "https://github.com/clojure-emacs/squiggly-clojure")) "melpa"])
  ...
  (flycheck-ghcmod . [(20150109 910) ((flycheck (0 21 -3 1)) (dash (2 0))) "A flycheck checker for Haskell using ghcmod" single ((:url . "https://github.com/scturtle/flycheck-ghcmod") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (flycheck-package . [(20150103 1322) ((cl-lib (0 5)) (flycheck (0 22)) (emacs (24))) "A Flycheck checker for elisp package authors" single ((:keywords "lisp")) "melpa"])
  ...
  (flycheck-tip . [(20141215 1441) ((flycheck (0 13)) (dash (1 2)) (emacs (24 1)) (popup (0 5 0)) (s (1 9 0))) "show flycheck's error by popup-tip" tar ((:url . "https://github.com/yuutayamada/flycheck-tip") (:keywords "flycheck")) "melpa"])
  ...
  (font-lock-menus . [(20150104 2206) nil "Font-lock menus: enhanced `font-menus.el'" single ((:url . "http://www.emacswiki.org/font-lock-menus.el") (:keywords "font" "highlighting" "syntax" "decoration")) "melpa"])
  ...
  (glsl-mode . [(20140930 1148) nil "major mode for Open GLSL shader files" single ((:url . "http://artis.inrialpes.fr/~Xavier.Decoret/resources/glsl-mode/") (:keywords "languages")) "melpa"])
  ...
  (google-translate . [(20150112 1321) nil "Emacs interface to Google Translate." tar nil "melpa"])
  ...
  (helm . [(20150113 553) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (highlight-indentation . [(20150109 1244) nil "Minor modes for highlighting indentation" single ((:url . "https://github.com/antonj/Highlight-Indentation-for-Emacs")) "melpa"])
  ...
  (hindent . [(20150111 532) ((cl-lib (0 5))) "Indent haskell code using the \"hindent\" program" single ((:url . "https://github.com/chrisdone/hindent")) "melpa"])
  ...
  (history . [(20150113 101) ((emacs (24 3))) "History utility for source code navigation" tar ((:url . "https://github.com/boyw165/history")) "melpa"])
  ...
  (hl-anything . [(20150109 2346) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more." single nil "melpa"])
  ...
  (kakapo-mode . [(20141215 1921) ((cl-lib (0 5))) "TABS (hard or soft) for indentation (leading whitespace), and SPACES for alignment." single ((:url . "https://github.com/listx/kakapo-mode") (:keywords "indentation")) "melpa"])
  ...
  (live-code-talks . [(20150111 2059) ((emacs (24)) (cl-lib (0 5)) (narrowed-page-navigation (0 1))) "Support for slides with live code in them" single ((:keywords "docs" "multimedia")) "melpa"])
  ...
  (malabar-mode . [(20150112 2049) ((fringe-helper (1 0 1))) "JVM Integration mode for EMACS" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "groovy" "language" "malabar")) "melpa"])
  ...
  (mandoku-meta-zb . [(20150113 1600) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (names . [(20150111 1757) ((emacs (24 1)) (cl-lib (0 5))) "Namespaces for emacs-lisp. Avoid name clobbering without hiding symbols." tar ((:url . "http://github.com/Bruce-Connor/names") (:keywords "extensions" "lisp")) "melpa"])
  ...
  (org-dropbox . [(20141219 1107) ((dash (2 2)) (names (0 5)) (emacs (24))) "move Dropbox notes from phone into org-mode datetree" single ((:url . "https://github.com/heikkil/org-dropbox") (:keywords "dropbox" "android" "notes" "org-mode")) "melpa"])
  ...
  (phi-search . [(20150113 636) nil "another incremental search command, compatible with \"multiple-cursors\"" tar ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (racket-mode . [(20150111 2108) ((emacs (24 3))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (sage-shell-mode . [(20150113 834) ((cl-lib (0 5)) (deferred (0 3 1))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (scala-mode2 . [(20141105 514) nil "Major mode for editing Scala >= 2.9" tar nil "melpa"])
  ...
  (setup-cygwin . [(20150105 48) ((cygwin-mount (0))) "Set up Emacs for using Cygwin" single ((:url . "http://www.emacswiki.org/setup-cygwin.el") (:keywords "os" "unix" "cygwin")) "melpa"])
  ...
  (switch-window . [(20141205 56) nil "A *visual* way to choose a window to switch to" single ((:url . "http://tapoueh.org/emacs/switch-window.html") (:keywords "window" "navigation")) "melpa"])
  ...
  (sx . [(20150112 1307) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tabbar-ruler . [(20140905 1543) ((tabbar (2 0 1))) "Pretty tabbar, autohide, use both tabbar/ruler" tar ((:url . "http://github.com/mlf176f2/tabbar-ruler.el") (:keywords "tabbar" "ruler mode" "menu" "tool bar.")) "melpa"])
  ...
  (tc . [(20150113 1633) nil "a Japanese input method with T-Code on Emacs" tar nil "melpa"])
  ...
  (undercover . [(20141212 416) ((emacs (24)) (dash (2 0 0)) (shut-up (0 3 2))) "Test coverage library for Emacs" single ((:url . "https://github.com/sviridov/undercover.el") (:keywords "lisp" "tests" "coverage" "tools")) "melpa"])
  ...
  (visual-fill-column . [(20150112 430) ((emacs (24 3))) "fill-column for visual-line-mode" single nil "melpa"])
  ...
  (web-mode . [(20150113 1542) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (writeroom-mode . [(20150112 327) ((emacs (24 1)) (visual-fill-column (1 1))) "Minor mode for distraction-free writing" tar ((:keywords "text")) "melpa"])
