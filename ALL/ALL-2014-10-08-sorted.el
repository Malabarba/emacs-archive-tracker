'(
  ...
  (ace-isearch . [(20141005 2116) ((ace-jump-mode (2 0)) (helm-swoop (1 4)) (emacs (24))) "A seamless bridge between isearch and ace-jump-mode" single ((:url . "https://github.com/tam17aki/ace-isearch")) "melpa"])
  ...
  (chruby . [(20140811 811) nil "Emacs integration for chruby" single ((:url . "http://www.emacswiki.org/emacs/ChrubyEl") (:keywords "ruby" "chruby")) "melpa"])
  (cider . [(20141007 452) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (codesearch . [(20141006 614) nil "Easy access to the codesearch tools" single ((:url . "https://github.com/abingham/codespeak.el") (:keywords "tools" "development" "search")) "melpa"])
  ...
  (company . [(20141005 619) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (dash . [(20141007 913) nil "A modern list library for Emacs" single ((:keywords "lists")) "melpa"])
  (dash-at-point . [(20140626 35) nil "Search the word at point with Dash" single ((:url . "https://github.com/stanaka/dash-at-point")) "melpa"])
  (dash-functional . [(20140811 523) ((dash (2 0 0)) (emacs (24))) "Collection of useful combinators for Emacs Lisp" single ((:keywords "lisp" "functions" "combinators")) "melpa"])
  ...
  (el-get . [(20141007 1718) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (flatui-theme . [(20140930 153) nil "A color theme for Emacs based on flatuicolors.com" single ((:url . "https://github.com/john2x/flatui-theme.el")) "melpa"])
  ...
  (function-args . [(20140930 811) nil "C++ completion for GNU Emacs" single ((:url . "https://github.com/abo-abo/function-args")) "melpa"])
  ...
  (git-gutter . [(20140917 2102) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (haskell-mode . [(20141007 429) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141007 426) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20140913 2053) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-ghq . [(20140820 840) ((helm (1 6 2))) "ghq with helm interface" single ((:url . "https://github.com/masutaka/emacs-helm-ghq")) "melpa"])
  ...
  (helm-projectile . [(20141007 518) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (isearch+ . [(20141001 1527) nil "Extensions to `isearch.el' (incremental search)." single ((:url . "http://www.emacswiki.org/isearch+.el") (:keywords "help" "matching" "internal" "local")) "melpa"])
  ...
  (json-mode . [(20140611 1845) ((json-reformat (20140301 39)) (json-snatcher (20131110 1107))) "Major mode for editing JSON files" single ((:url . "https://github.com/joshwnj/json-mode")) "melpa"])
  ...
  (lispy . [(20140918 524) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97))) "vi-like Paredit" tar nil "melpa"])
  ...
  (marmalade-upload . [(20141003 1643) ((web (0 4 2)) (kv (0 0 19))) "upload client for marmalade from emacs" single ((:keywords "lisp")) "melpa"])
  ...
  (merlin . [(20141007 522) nil "Mode for Merlin, an assistant for OCaml." tar ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (nu-mode . [(20141007 1431) ((undo-tree (0 6 5)) (helm (20140902 1005))) "Modern Emacs Prompts Based Keybinding." tar nil "melpa"])
  ...
  (org-jira . [(20140907 452) nil "Syncing between Jira and Org-mode." tar ((:url . "https://github.com/baohaojun/org-jira")) "melpa"])
  ...
  (p4 . [(20141002 559) nil "Simple Perforce-Emacs Integration" single ((:url . "https://github.com/gareth-rees/p4.el")) "melpa"])
  ...
  (projectile . [(20141002 1125) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20140929 254) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (sage-shell-mode . [(20141005 1903) ((cl-lib (0 5))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (sekka . [(20140815 2331) ((cl-lib (0 3)) (concurrent (0 3 1)) (popup (0 5 0))) "A client for Sekka IME server" single ((:url . "https://github.com/kiyoka/sekka") (:keywords "ime" "skk" "japanese")) "melpa"])
  ...
  (sly . [(20141006 610) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (smartparens . [(20141004 228) ((cl-lib (0 3)) (dash (2 6 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (smyx-theme . [(20141005 1159) nil "smyx Color Theme" single ((:keywords "color" "theme" "smyx")) "melpa"])
  ...
  (undercover . [(20141006 2338) ((emacs (24)) (shut-up (0 3 2))) "Test coverage library for Emacs" single ((:url . "https://github.com/sviridov/undercover.el") (:keywords "lisp" "tests" "coverage" "tools")) "melpa"])
  ...
  (vlf . [(20141007 418) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (yasnippet . [(20141007 657) nil "Yet another snippet extension for Emacs." tar ((:url . "http://github.com/capitaomorte/yasnippet") (:keywords "convenience" "emulation")) "melpa"])
