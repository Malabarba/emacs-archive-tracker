'(
  ...
  (aes . [(20150116 904) nil "Implementation of AES" single ((:url . "https://github.com/gaddhi/aes") (:keywords "data" "tools")) "melpa"])
  ...
  (auto-compile . [(20140913 1532) ((cl-lib (0 5)) (packed (0 3 5))) "automatically compile Emacs Lisp libraries" single ((:url . "https://github.com/tarsius/auto-compile") (:keywords "compile" "convenience" "lisp")) "melpa"])
  ...
  (bookmark+ . [(20150105 2152) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (chinese-pyim . [(20150116 514) ((cl-lib (0 5))) "Chinese pinyin input method" single ((:url . "https://github.com/tumashu/chinese-pyim") (:keywords "convenience" "chinese" "pinyin" "input-method")) "melpa"])
  ...
  (cider . [(20150114 512) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (csharp-mode . [(20141204 2302) nil "C# mode derived mode" single ((:url . "https://github.com/josteink/csharp-mode") (:keywords "c#" "languages" "oop" "mode")) "melpa"])
  ...
  (edts . [(20150108 1030) ((auto-complete (1 3 1)) (auto-highlight-symbol (1 53)) (dash (1 5 0)) (eproject (1 5)) (erlang (2 4 1)) (f (0 16 0)) (popup (0 4))) "Erlang Development Tool Suite" tar nil "melpa"])
  ...
  (ein . [(20150114 1636) ((websocket (1 3)) (request (0 2))) "Emacs IPython Notebook" tar nil "melpa"])
  ...
  (ensime . [(20150115 537) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (flycheck . [(20150115 1159) ((dash (2 4 0)) (pkg-info (0 4)) (let-alist (1 0 1)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (grizzl . [(20150113 2315) ((cl-lib (0 1))) "Fuzzy Search Library & Completing Read" tar nil "melpa"])
  ...
  (haskell-emacs . [(20150116 1503) nil "write emacs extensions in haskell" tar ((:url . "https://github.com/knupfer/haskell-emacs") (:keywords "haskell" "emacs" "ffi")) "melpa"])
  ...
  (helm . [(20150116 652) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20150116 1638) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-gtags . [(20150108 1941) ((helm (1 5 6)) (cl-lib (0 5))) "GNU GLOBAL helm interface" single ((:url . "https://github.com/syohex/emacs-helm-gtags")) "melpa"])
  ...
  (helm-projectile . [(20150111 2324) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (indent-guide . [(20141125 301) nil "show vertical lines to guide indentation" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (lentic . [(20150116 258) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (lispy . [(20150110 1219) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (mmm-mode . [(20141105 457) nil "Allow Multiple Major Modes in a buffer" tar ((:url . "https://github.com/purcell/mmm-mode") (:keywords "convenience" "faces" "languages" "tools")) "melpa"])
  ...
  (notmuch . [(20150116 7) nil "No description available." tar nil "melpa"])
  ...
  (org-cliplink . [(20150104 1238) nil "insert org-mode link for URL from the clipboard" single ((:url . "http://github.com/rexim/org-cliplink")) "melpa"])
  ...
  (packed . [(20150101 829) ((cl-lib (0 5))) "package manager agnostic Emacs Lisp package utilities" single ((:url . "https://github.com/tarsius/packed") (:keywords "compile" "convenience" "lisp" "package" "library")) "melpa"])
  ...
  (phi-search . [(20150116 910) nil "another incremental search & replace, compatible with \"multiple-cursors\"" tar ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (realgud . [(20150113 417) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (rope-read-mode . [(20150115 343) nil "Rearrange lines to read text smoothly" single ((:url . "https://github.com/marcowahl/rope-read-mode") (:keywords "convenience")) "melpa"])
  ...
  (smartparens . [(20150116 45) ((cl-lib (0 3)) (dash (2 10 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (sx . [(20150116 628) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (ujelly-theme . [(20141225 1833) nil "Ujelly theme for GNU Emacs 24 (deftheme)" single ((:url . "http://github.com/marktran/color-theme-ujelly")) "melpa"])
  ...
  (visual-fill-column . [(20150115 1815) ((emacs (24 3))) "fill-column for visual-line-mode" single nil "melpa"])
  ...
  (web-mode . [(20150115 2310) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (writeroom-mode . [(20150115 2313) ((emacs (24 1)) (visual-fill-column (1 1))) "Minor mode for distraction-free writing" tar ((:keywords "text")) "melpa"])
