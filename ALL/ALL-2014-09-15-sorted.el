'(
  ...
  (ac-nrepl . [(20140805 646) ((cider (0 1)) (auto-complete (1 4))) "auto-complete sources for Clojure using nrepl completions" single ((:url . "https://github.com/purcell/ac-nrepl") (:keywords "languages" "clojure" "nrepl")) "melpa"])
  ...
  (ace-window . [(20140721 752) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  (achievements . [(20140910 746) ((keyfreq (0 0 3))) "Achievements for emacs usage." tar nil "melpa"])
  ...
  (ample-theme . [(20140801 1205) nil "Calm Dark Theme for Emacs" tar ((:url . "https://github.com/jordonbiondo/ample-theme") (:keywords "theme" "dark")) "melpa"])
  ...
  (anaconda-mode . [(20140901 1158) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (anzu . [(20140905 1752) ((cl-lib (0 5)) (emacs (24))) "Show number of matches in mode-line while searching" single ((:url . "https://github.com/syohex/emacs-anzu")) "melpa"])
  ...
  (async . [(20140912 517) nil "Asynchronous processing in Emacs" tar nil "melpa"])
  ...
  (browse-kill-ring . [(20140914 848) nil "interactively insert items from kill-ring" single ((:url . "https://github.com/browse-kill-ring/browse-kill-ring") (:keywords "convenience")) "melpa"])
  ...
  (cider . [(20140914 1100) ((clojure-mode (2 0 0)) (cl-lib (0 3)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  (cider-browse-ns . [(20140725 2249) ((cider (0 7 0))) "Browse Clojure namespaces with ease" single ((:url . "https://github.com/jxa/cider-browse-ns") (:keywords "clojure" "cider")) "melpa"])
  ...
  (clojure-mode . [(20140914 556) ((emacs (24 1))) "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "clojure" "clojurescript" "lisp")) "melpa"])
  ...
  (codesearch . [(20140720 656) nil "Easy access to the codesearch tools" single ((:url . "https://github.com/abingham/codespeak.el") (:keywords "tools" "development" "search")) "melpa"])
  ...
  (comment-dwim-2 . [(20140906 929) nil "An all-in-one comment command to rule them all" single ((:url . "https://github.com/remyferre/comment-dwim-2") (:keywords "convenience")) "melpa"])
  (company . [(20140914 4) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-cider . [(20140806 716) ((company (0 6 13)) (cider (0 6 0))) "company-mode completion back-end for Cider" single ((:url . "https://github.com/clojure-emacs/company-cider") (:keywords "company-mode" "completion" "backend" "cider" "clojure")) "melpa"])
  (company-cmake . [(0 1) ((company (0 6 8))) "company-mode completion back-end for CMake" single "marmalade"])
  (company-ghc . [(20140914 609) ((cl-lib (0 5)) (company (0 8 0)) (ghc (4 1 1)) (emacs (24))) "company-mode ghc-mod backend" single ((:url . "https://github.com/iquiw/company-ghc") (:keywords "haskell" "completion")) "melpa"])
  ...
  (company-ycmd . [(20140909 506) ((ycmd (0 1)) (company (0 8 3))) "company-mode backend for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (cpputils-cmake . [(20140906 705) nil "Easy real time C++ syntax check and intellisense if you use CMake" tar nil "melpa"])
  ...
  (d-mode . [(20140825 717) nil "D Programming Language mode for (X)Emacs" single ((:keywords "d" "programming" "language" "emacs" "cc-mode")) "melpa"])
  ...
  (diff-hl . [(20140810 1704) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  (diffscuss-mode . [(20140709 707) nil "Major mode for diffscuss files." single ((:keywords "tools")) "melpa"])
  (digistar-mode . [(20140914 1522) nil "major mode for Digistar scripts" single ((:keywords "languages")) "melpa"])
  ...
  (dired+ . [(20140914 1811) nil "Extensions to Dired." single ((:url . "http://www.emacswiki.org/dired+.el") (:keywords "unix" "mouse" "directories" "diredp" "dired")) "melpa"])
  ...
  (drupal-mode . [(20140905 557) ((php-mode (1 5 0))) "Advanced minor mode for Drupal development" tar ((:url . "https://github.com/arnested/drupal-mode") (:keywords "programming" "php" "drupal")) "melpa"])
  ...
  (el-get . [(20140914 1222) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elfeed . [(20140911 1603) ((emacs (24 1))) "an Emacs Atom/RSS feed reader" tar nil "melpa"])
  ...
  (ergoemacs-mode . [(20140913 835) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  (erlang . [(20140605 1648) nil "Erlang major mode" tar nil "melpa"])
  ...
  (es-mode . [(20140911 400) nil "A major mode for editing Elasticsearch queries" tar ((:url . "http://www.github.com/dakrone/es-mode") (:keywords "elasticsearch")) "melpa"])
  ...
  (evil . [(20140910 441) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (flatui-theme . [(20140813 233) nil "A color theme for Emacs based on flatuicolors.com" single ((:url . "https://github.com/john2x/flatui-theme.el")) "melpa"])
  ...
  (flycheck . [(20140914 133) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (git-gutter . [(20140913 2354) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (go-eldoc . [(20140608 1938) ((go-mode (0)) (cl-lib (0 5))) "eldoc for go-mode" single ((:url . "https://github.com/syohex/emacs-go-eldoc")) "melpa"])
  ...
  (haskell-mode . [(20140913 1647) nil "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20140910 1226) nil "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-flycheck . [(20140912 1946) ((dash (2 4 0)) (flycheck (0 20 -3)) (helm (1 5 7))) "Show flycheck errors with helm" single ((:url . "https://github.com/yasuyk/helm-flycheck") (:keywords "helm" "flycheck")) "melpa"])
  ...
  (helm-projectile . [(20140913 1002) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (highlight-blocks . [(20140907 934) ((emacs (24))) "Highlight the blocks point is in" single ((:url . "https://github.com/Fanael/highlight-blocks")) "melpa"])
  ...
  (highlight-defined . [(20140914 1401) ((emacs (24))) "Syntax highlighting of known Elisp symbols" single ((:url . "https://github.com/Fanael/highlight-defined")) "melpa"])
  ...
  (highlight-numbers . [(20140907 935) ((emacs (24)) (parent-mode (2 0))) "Highlight numbers in source code" single ((:url . "https://github.com/Fanael/highlight-numbers")) "melpa"])
  ...
  (highlight-quoted . [(20140907 936) ((emacs (24))) "Highlight Lisp quotes and quoted symbols" single ((:url . "https://github.com/Fanael/highlight-quoted")) "melpa"])
  ...
  (icicles . [(20140912 1727) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (ids-edit . [(20140906 2224) ((emacs (24 3))) "IDS (Ideographic Description Sequence) editing tool" tar ((:url . "http://github.com/kawabata/ids-edit") (:keywords "text")) "melpa"])
  ...
  (jump-char . [(20140716 815) nil "navigation by char" single ((:url . "https://github.com/lewang/jump-char")) "melpa"])
  ...
  (ledger-mode . [(20140913 1824) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  ...
  (leuven-theme . [(20140912 1304) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (linked-buffer . [(20140904 727) ((emacs (24)) (m-buffer (0 4)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (lispy . [(20140723 616) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97))) "vi-like Paredit" tar nil "melpa"])
  ...
  (m-buffer . [(20140819 910) ((dash (2 5 0)) (emacs (24 3))) "Buffer Manipulation Functions" single nil "melpa"])
  ...
  (magit-gh-pulls . [(20140829 629) ((emacs (24)) (gh (0 4 3)) (magit (1 1 0)) (pcache (0 2 3)) (s (1 6 1))) "GitHub pull requests extension for Magit" single ((:url . "https://github.com/sigma/magit-gh-pulls") (:keywords "tools")) "melpa"])
  ...
  (make-it-so . [(20140715 527) ((helm (1 5 3)) (emacs (24))) "Transform files with Makefile recipes." tar ((:url . "https://github.com/abo-abo/make-it-so") (:keywords "make" "dired")) "melpa"])
  ...
  (merlin . [(20140813 234) nil "Mode for Merlin, an assistant for OCaml." single ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (narrow-indirect . [(20140714 2202) nil "Narrow using an indirect buffer that is a clone" single ((:url . "http://www.emacswiki.org/narrow-indirect.el") (:keywords "narrow" "indirect" "buffer" "clone" "view" "multiple-modes")) "melpa"])
  ...
  (nu-mode . [(20140914 1312) ((undo-tree (0 6 5)) (helm (20140902 1005))) "Modern Emacs Prompts Based Keybinding." tar nil "melpa"])
  ...
  (om-mode . [(20140914 1013) nil "Insert Om component template with life cycle." single ((:keywords "clojurescript")) "melpa"])
  ...
  (org . [(20140908) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-journal . [(20140908 133) nil "a simple org-mode based journaling mode" single ((:url . "http://github.com/bastibe/emacs-journal")) "melpa"])
  ...
  (org-trello . [(20140914 1003) ((request-deferred (0 1 0)) (deferred (0 3 2)) (s (1 9 0)) (dash (2 8 0)) (emacs (24))) "Minor mode to synchronize org-mode buffer and trello board" tar nil "melpa"])
  (org-vcard . [(20140911 154) nil "org-mode support for vCard export and import." tar ((:keywords "outlines" "org" "vcard")) "melpa"])
  ...
  (persp-mode . [(20140824 311) ((workgroups (0 2 0))) "\"perspectives\" + save/load + shared among frames - bugs." single ((:url . "https://github.com/Bad-ptr/persp-mode.el") (:keywords "perspectives" "session")) "melpa"])
  ...
  (pretty-mode . [(20140821 2121) nil "Redisplay parts of the buffer as pretty symbols." single ((:url . "https://github.com/akatov/pretty-mode") (:keywords "pretty" "unicode" "symbols")) "melpa"])
  ...
  (prodigy . [(20140914 1052) ((s (1 8 0)) (dash (2 4 0)) (f (0 14 0)) (emacs (24))) "Manage external services from within Emacs" single ((:url . "http://github.com/rejeep/prodigy.el")) "melpa"])
  (professional-theme . [(20140911 222) nil "Emacs port of Vim's professional theme" single ((:url . "https://github.com/juanjux/professional-theme") (:keywords "theme" "light" "professional")) "melpa"])
  ...
  (rainbow-delimiters . [(20140914 1120) nil "Highlight nested parens, brackets, braces a different color at each depth." single ((:url . "http://github.com/jlr/rainbow-delimiters/raw/master/rainbow-delimiters.el") (:keywords "faces" "convenience" "lisp" "matching" "tools" "rainbow" "rainbow parentheses" "rainbow parens")) "melpa"])
  (rainbow-identifiers . [(20140907 937) ((emacs (24))) "Highlight identifiers according to their names" single ((:url . "https://github.com/Fanael/rainbow-identifiers")) "melpa"])
  ...
  (realgud . [(20140914 920) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (robe . [(20140808 102) ((inf-ruby (2 3 0))) "Code navigation, documentation lookup and completion for Ruby" tar ((:url . "https://github.com/dgutov/robe") (:keywords "ruby" "convenience" "rails")) "melpa"])
  ...
  (rtags . [(20140911 31) nil "No description available." tar nil "melpa"])
  ...
  (sage-shell-mode . [(20140914 555) ((cl-lib (0 5))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (sly . [(20140914 735) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (sqlup-mode . [(20140819 2059) nil "Upcase SQL words for you" single ((:url . "https://github.com/trevoke/sqlup-mode.el") (:keywords "sql" "tools")) "melpa"])
  (sr-speedbar . [(20140914 1521) nil "Same frame speedbar" single ((:url . "http://www.emacswiki.org/emacs/download/sr-speedbar.el") (:keywords "speedbar" "sr-speedbar.el")) "melpa"])
  ...
  (tronesque-theme . [(20140910 901) nil "Color Theme based on Tron universe." single ((:url . "https://github.com/aurelienbottazini/tronesque")) "melpa"])
  ...
  (tuareg . [(20140914 1001) ((caml (3 12 0 1))) "OCaml mode for Emacs." tar ((:url . "http://forge.ocamlcore.org/projects/tuareg/") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (use-package . [(20140914 626) ((bind-key (1 0)) (diminish (0 44))) "A use-package declaration for simplifying your .emacs" single ((:url . "https://github.com/jwiegley/use-package") (:keywords "dotemacs" "startup" "speed" "config" "package")) "melpa"])
  ...
  (web-mode . [(20140914 1315) nil "major mode for editing html templates" tar ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (yasnippet . [(20140909 1250) nil "Yet another snippet extension for Emacs." tar ((:url . "http://github.com/capitaomorte/yasnippet") (:keywords "convenience" "emulation")) "melpa"])
  ...
  (ycmd . [(20140908 2327) ((request (0 2 0))) "emacs bindings to the ycmd completion server" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (zotxt . [(20140729 2349) nil "Tools to integrate emacs with Zotero via the zotxt plugin." tar nil "melpa"])
