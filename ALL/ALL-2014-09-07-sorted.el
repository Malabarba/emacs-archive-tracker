'(
  ...
  (ac-dcd . [(20140825 1252) ((auto-complete (1 3 1)) (flycheck-dmd-dub (0 7))) "Auto Completion source for dcd for GNU Emacs" single ((:url . "http://github.com/atilaneves/ac-dcd") (:keywords "languages")) "melpa"])
  ...
  (browse-kill-ring . [(20140906 1503) nil "interactively insert items from kill-ring" single ((:url . "https://github.com/browse-kill-ring/browse-kill-ring") (:keywords "convenience")) "melpa"])
  ...
  (cask . [(20140815 26) ((s (1 8 0)) (dash (2 2 0)) (f (0 16 0)) (epl (0 5)) (shut-up (0 1 0)) (cl-lib (0 3)) (package-build (0 1))) "Cask: Project management for Emacs package development" tar ((:url . "http://github.com/cask/cask") (:keywords "speed" "convenience")) "melpa"])
  ...
  (company . [(20140902 1656) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (dired+ . [(20140726 2132) nil "Extensions to Dired." single ((:url . "http://www.emacswiki.org/dired+.el") (:keywords "unix" "mouse" "directories" "diredp" "dired")) "melpa"])
  ...
  (edts . [(20140730 154) ((auto-complete (1 3 1)) (auto-highlight-symbol (1 53)) (dash (1 5 0)) (eproject (1 5)) (erlang (2 4 1)) (f (0 16 0)) (popup (0 4))) "Erlang Development Tool Suite" tar nil "melpa"])
  ...
  (el-get . [(20140906 236) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elmacro . [(20140902 220) ((s (1 9 0)) (dash (1 5 0)) (cl-lib (0 5))) "Convert keyboard macros to elisp" single ((:url . "https://github.com/Silex/elmacro") (:keywords "macro" "elisp" "convenience")) "melpa"])
  ...
  (ergoemacs-mode . [(20140906 1156) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  ...
  (evil . [(20140901 1327) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (fasm-mode . [(20140902 944) nil "Fasm major mode" single ((:url . "https://github.com/Fanael/fasm-mode")) "melpa"])
  ...
  (flycheck . [(20140829 853) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (helm . [(20140905 129) nil "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-projectile . [(20140903 2) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (highlight-blocks . [(20140903 1047) ((emacs (24))) "Highlight the blocks point is in" single ((:url . "https://github.com/Fanael/highlight-blocks")) "melpa"])
  ...
  (highlight-defined . [(20140822 1017) ((emacs (24))) "Syntax highlighting of known Elisp symbols" single ((:url . "https://github.com/Fanael/highlight-defined")) "melpa"])
  ...
  (highlight-quoted . [(20140820 1649) ((emacs (24))) "Highlight Lisp quotes and quoted symbols" single ((:url . "https://github.com/Fanael/highlight-quoted")) "melpa"])
  ...
  (ids-edit . [(20140829 1111) ((emacs (24 3))) "IDS (Ideographic Description Sequence) editing tool" tar ((:url . "http://github.com/kawabata/ids-edit") (:keywords "text")) "melpa"])
  ...
  (js2-mode . [(20140803 2031) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (kfg . [(20140720 640) nil "an emacs configuration system" single ((:url . "https://github.com/abingham/kfg")) "melpa"])
  ...
  (magit . [(20140901 51) ((cl-lib (0 3)) (git-commit-mode (0 14 0)) (git-rebase-mode (0 14 0))) "control Git from Emacs" tar ((:keywords "vc" "tools")) "melpa"])
  ...
  (magit-find-file . [(20140906 1402) ((magit (1 2 0)) (dash (2 8 0))) "completing-read over all files in Git" single ((:url . "https://github.com/bradleywright/magit-find-file.el") (:keywords "git")) "melpa"])
  ...
  (neotree . [(20140906 803) nil "A tree plugin like NerdTree for Vim" single ((:url . "https://github.com/jaypei/emacs-neotree")) "melpa"])
  ...
  (notmuch . [(20140816 1744) nil "No description available." tar nil "melpa"])
  ...
  (nu-mode . [(20140906 1450) ((undo-tree (0 6 5))) "Modern Emacs Prompts Based Keybinding." tar nil "melpa"])
  ...
  (org . [(20140901) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-journal . [(20140806 101) nil "a simple org-mode based journaling mode" single ((:url . "http://github.com/bastibe/emacs-journal")) "melpa"])
  ...
  (org-vcard . [(20140902 258) nil "org-mode support for vCard export and import." tar ((:keywords "outlines" "org" "vcard")) "melpa"])
  ...
  (py-autopep8 . [(20140906 1157) nil "Use autopep8 to beautify a Python buffer" single ((:url . "http://paetzke.me/project/py-autopep8.el")) "melpa"])
  ...
  (py-isort . [(20140906 1248) nil "Use isort to sort the imports in a Python buffer" single ((:url . "http://paetzke.me/project/py-isort.el")) "melpa"])
  ...
  (rainbow-delimiters . [(20140902 948) nil "Highlight nested parens, brackets, braces a different color at each depth." single ((:url . "http://github.com/jlr/rainbow-delimiters/raw/master/rainbow-delimiters.el") (:keywords "faces" "convenience" "lisp" "matching" "tools" "rainbow" "rainbow parentheses" "rainbow parens")) "melpa"])
  (rainbow-identifiers . [(20140822 1019) ((emacs (24))) "Highlight identifiers according to their names" single ((:url . "https://github.com/Fanael/rainbow-identifiers")) "melpa"])
  ...
  (relative-line-numbers . [(20140712 1300) ((emacs (24))) "Display relative line numbers on the margin" single ((:url . "https://github.com/Fanael/relative-line-numbers")) "melpa"])
  ...
  (rtags . [(20140904 2158) nil "No description available." tar nil "melpa"])
  ...
  (simple-httpd . [(20140613 955) ((cl-lib (0 3))) "pure elisp HTTP server" single ((:url . "https://github.com/skeeto/emacs-http-server")) "melpa"])
  ...
  (slime . [(20140902 42) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (slime-company . [(20140903 406) ((slime (2 3 2)) (company (0 7))) "slime completion backend for company mode" single ((:keywords "convenience" "lisp" "abbrev")) "melpa"])
  ...
  (stekene-theme . [(20140906 1047) ((emacs (24))) "The stekene dark and light color themes." tar nil "melpa"])
  ...
  (vlf . [(20140822 1409) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (vs-emulation-mode . [(20140813 1330) ((emacs (24)) (cl-lib (0 5))) "Emulate a certain proprietary IDE" single ((:url . "https://github.com/Fanael/vs-emulation-mode")) "melpa"])
  ...
  (web-mode . [(20140829 628) nil "major mode for editing html templates" tar ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (ycmd . [(20140906 811) ((request (0 2 0))) "emacs bindings to the ycmd completion server" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
