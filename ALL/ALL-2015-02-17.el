'(
  ...
  (ac-clang . [(20150216 1114) ((emacs (24)) (cl-lib (0 5)) (auto-complete (1 4 0)) (yasnippet (0 8 0))) "Auto Completion source by libclang for GNU Emacs" tar ((:url . "https://github.com/yaruopooner/ac-clang") (:keywords "completion" "convenience" "intellisense")) "melpa"])
  ...
  (ac-html-bootstrap . [(20150201 959) ((ac-html (0 3 0))) "auto complete bootstrap3 classes, tags and attributes" tar ((:url . "https://github.com/osv/ac-html-bootstrap") (:keywords "html" "auto-complete" "bootstrap" "cssx")) "melpa"])
  (ac-html-csswatcher . [(20150203 539) ((ac-html (0 3))) "css/less class/id completion with `ac-html'" single ((:url . "https://github.com/osv/ac-html-csswatcher") (:keywords "html" "css" "less" "auto-complete")) "melpa"])
  ...
  (ace-link . [(20150108 1324) ((ace-jump-mode (2 0))) "Quickly follow links using `ace-jump-mode'" single ((:url . "https://github.com/abo-abo/ace-link") (:keywords "convenience" "links")) "melpa"])
  (ace-window . [(20150216 221) ((ace-jump-mode (2 0))) "Quickly switch windows using `ace-jump-mode'." single ((:url . "https://github.com/abo-abo/ace-window") (:keywords "cursor" "window" "location")) "melpa"])
  ...
  (ahg . [(20150212 754) nil "Alberto's Emacs interface for Mercurial (Hg)" single ((:url . "https://bitbucket.org/agriggio/ahg")) "melpa"])
  ...
  (ample-theme . [(20141103 816) nil "Calm Dark Theme for Emacs" tar ((:url . "https://github.com/jordonbiondo/ample-theme") (:keywords "theme" "dark")) "melpa"])
  ...
  (anaconda-mode . [(20150213 1059) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (anzu . [(20150212 2125) ((cl-lib (0 5)) (emacs (24))) "Show number of matches in mode-line while searching" single ((:url . "https://github.com/syohex/emacs-anzu")) "melpa"])
  ...
  (auto-complete . [(20150201 150) ((popup (0 5 0))) "Auto Completion for GNU Emacs" tar nil "melpa"])
  ...
  (auto-yasnippet . [(20150203 2306) ((yasnippet (0 8 0))) "Quickly create disposable yasnippets" single ((:url . "https://github.com/abo-abo/auto-yasnippet")) "melpa"])
  ...
  (basic-theme . [(20150131 1111) ((emacs (24))) "Minimalistic light color theme" single ((:url . "http://github.com/fgeller/basic-theme.el") (:keywords "fingers" "modal" "editing" "workman")) "melpa"])
  ...
  (bog . [(20150215 1915) ((dash (2 5 0))) "Extensions for research notes in Org mode" single ((:url . "https://github.com/kyleam/bog") (:keywords "bib" "outlines")) "melpa"])
  (bongo . [(20150114 1745) nil "play music with Emacs" tar nil "melpa"])
  (bookmark+ . [(20150215 1910) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (calfw . [(20150206 1648) nil "Calendar view framework on Emacs" tar ((:keywords "calendar")) "melpa"])
  ...
  (chinese-pyim . [(20150123 653) ((cl-lib (0 5))) "Chinese pinyin input method" tar ((:url . "https://github.com/tumashu/chinese-pyim") (:keywords "convenience" "chinese" "pinyin" "input-method")) "melpa"])
  ...
  (cider . [(20150215 730) ((clojure-mode (4 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (circe . [(20150208 1020) ((lui (0)) (lcs (0))) "Client for IRC in Emacs" tar nil "melpa"])
  ...
  (clj-refactor . [(20150201 411) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 8 1))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (cmm-mode . [(20150207 159) nil "Major mode for C-- source code" single nil "melpa"])
  ...
  (coffee-mode . [(20150214 2240) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (color-theme-sanityinc-solarized . [(20150207 349) nil "A version of Ethan Schoonover's Solarized themes" tar nil "melpa"])
  (color-theme-sanityinc-tomorrow . [(20150207 349) nil "A version of Chris Kempson's various Tomorrow themes" tar nil "melpa"])
  ...
  (company . [(20150212 535) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (csharp-mode . [(20150125 708) nil "C# mode derived mode" single ((:url . "https://github.com/josteink/csharp-mode") (:keywords "c#" "languages" "oop" "mode")) "melpa"])
  ...
  (ddskk . [(20150205 547) ((ccc (1 43)) (cdb (20141201 754))) "Simple Kana to Kanji conversion program." tar nil "melpa"])
  ...
  (diff-hl . [(20150113 2113) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  ...
  (dired+ . [(20150203 521) nil "Extensions to Dired." single ((:url . "http://www.emacswiki.org/dired+.el") (:keywords "unix" "mouse" "directories" "diredp" "dired")) "melpa"])
  ...
  (dired-fdclone . [(20150215 918) nil "dired functions and settings to mimic FDclone" single ((:url . "https://github.com/knu/dired-fdclone.el") (:keywords "unix" "directories" "dired")) "melpa"])
  ...
  (drupal-mode . [(20141223 102) ((php-mode (1 5 0))) "Advanced minor mode for Drupal development" tar ((:url . "https://github.com/arnested/drupal-mode") (:keywords "programming" "php" "drupal")) "melpa"])
  ...
  (dyalog-mode . [(20150124 812) ((cl-lib (0 2))) "Major mode for editing Dyalog APL source code" tar ((:url . "https://bitbucket.org/harsman/dyalog-mode/") (:keywords "languages")) "melpa"])
  ...
  (e2ansi . [(20150202 1457) nil "Syntax highlighting support for `less', powered by Emacs." tar ((:url . "https://github.com/Lindydancer/e2ansi") (:keywords "faces" "languages")) "melpa"])
  ...
  (eide . [(20150213 1250) nil "IDE interface" tar nil "melpa"])
  (eimp . [(20140630 1447) nil "Emacs Image Manipulation Package" single nil "melpa"])
  (ein . [(20150215 934) ((websocket (1 3)) (request (0 2))) "Emacs IPython Notebook" tar nil "melpa"])
  ...
  (el-get . [(20150121 1912) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  (el-init . [(20150211 2314) ((emacs (24)) (cl-lib (0 5)) (anaphora (1 0 0))) "A loader inspired by init-loader" single nil "melpa"])
  (el-init-viewer . [(20150212 253) ((emacs (24)) (cl-lib (0 5)) (ctable (0 1 2)) (dash (2 10 0)) (anaphora (1 0 0)) (el-init (0 1 4))) "Record viewer for el-init" single nil "melpa"])
  ...
  (elfeed . [(20150206 1247) ((emacs (24 1))) "an Emacs Atom/RSS feed reader" tar nil "melpa"])
  ...
  (elpy . [(20150206 1012) ((company (0 8 2)) (find-file-in-project (3 3)) (highlight-indentation (0 5 0)) (pyvenv (1 3)) (yasnippet (0 8 0))) "Emacs Python Development Environment" tar nil "melpa"])
  ...
  (ensime . [(20150216 1402) ((s (1 3 0)) (dash (2 10 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3)) (company (0 8 7)) (yasnippet (0 8 0))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (erc-social-graph . [(20150214 8) nil "A social network graph module for ERC." single ((:url . "https://github.com/vibhavp/erc-social-graph") (:keywords "erc" "graph")) "melpa"])
  ...
  (ergoemacs-mode . [(20150211 829) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  ...
  (ess . [(20150209 1232) nil "No description available." tar nil "melpa"])
  ...
  (esup . [(20141227 758) ((cl-lib (0 5)) (emacs (24))) "the Emacs StartUp Profiler (ESUP)" tar ((:url . "http://github.com/jschaf/esup") (:keywords "convenience" "processes")) "melpa"])
  ...
  (evil . [(20150216 1306) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-escape . [(20150127 2023) ((emacs (24)) (evil (1 0 9))) "Escape from anything with a customizable key sequence" single ((:url . "https://github.com/syl20bnr/evil-escape") (:keywords "convenience" "editing" "evil")) "melpa"])
  ...
  (evil-lisp-state . [(20150120 2028) ((evil (1 0 9)) (evil-leader (0 4 3)) (smartparens (1 6 1))) "An evil state to edit Lisp code" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  ...
  (evil-smartparens . [(20150216 338) ((evil (1 0)) (cl-lib (0 3)) (emacs (24 4)) (smartparens (1 6 3))) "Evil support for smartparens" single ((:url . "https://www.github.com/expez/evil-smartparens") (:keywords "evil" "smartparens")) "melpa"])
  (evil-snipe . [(20150130 1719) ((evil (1 0 9))) "emulate vim-sneak & vim-seek" single ((:url . "https://github.com/hlissner/evil-snipe") (:keywords "emulation" "vim" "evil" "sneak" "seek")) "melpa"])
  ...
  (f . [(20150211 626) ((s (1 7 0)) (dash (2 2 0))) "Modern API for working with files and directories" single ((:url . "http://github.com/rejeep/f.el") (:keywords "files" "directories")) "melpa"])
  ...
  (fingers . [(20150131 1049) nil "Modal editing with universal text manipulation helpers." tar ((:url . "http://github.com/fgeller/fingers.el") (:keywords "fingers" "modal" "editing" "workman")) "melpa"])
  ...
  (fixmee . [(20140609 551) ((button-lock (1 0 0)) (nav-flash (1 0 0)) (back-button (0 6 0)) (smartrep (0 0 3)) (string-utils (0 3 2)) (tabulated-list (0))) "Quickly navigate to FIXME notices in code" single ((:url . "http://github.com/rolandwalker/fixmee") (:keywords "navigation" "convenience")) "melpa"])
  ...
  (flatui-theme . [(20141223 1722) nil "A color theme for Emacs based on flatuicolors.com" single ((:url . "https://github.com/john2x/flatui-theme.el")) "melpa"])
  ...
  (fountain-mode . [(20150101 19) ((s (1 9 0))) "Major mode for screenwriting in Fountain markup" single ((:url . "https://github.com/rnkn/fountain-mode") (:keywords "wp")) "melpa"])
  ...
  (geeknote . [(20150215 1950) ((emacs (24))) "Use Evernote in Emacs through geeknote" single ((:url . "http://github.com/avendael/emacs-geeknote") (:keywords "evernote" "geeknote" "note" "emacs-evernote" "evernote-mode")) "melpa"])
  ...
  (go-eldoc . [(20141218 2036) ((go-mode (0)) (cl-lib (0 5))) "eldoc for go-mode" single ((:url . "https://github.com/syohex/emacs-go-eldoc")) "melpa"])
  (go-errcheck . [(20141127 2216) nil "errcheck integration for go-mode" single nil "melpa"])
  (go-mode . [(20150129 313) nil "Major mode for the Go programming language" tar ((:url . "https://github.com/dominikh/go-mode.el") (:keywords "languages" "go")) "melpa"])
  ...
  (google-this . [(20140925 142) ((emacs (24 1))) "A set of functions and bindings to google under point." single ((:url . "http://github.com/Bruce-Connor/emacs-google-this") (:keywords "convenience" "hypermedia")) "melpa"])
  ...
  (haskell-emacs . [(20150216 1557) nil "write emacs extensions in haskell" tar ((:url . "https://github.com/knupfer/haskell-emacs") (:keywords "haskell" "emacs" "ffi")) "melpa"])
  (haskell-mode . [(20150216 407) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20150216 11) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20150216 728) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-bibtex . [(20150213 1528) ((helm (1 5 5)) (parsebib (1 0)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-ghq . [(20141212 2339) ((helm (1 6 5))) "ghq with helm interface" single ((:url . "https://github.com/masutaka/emacs-helm-ghq")) "melpa"])
  ...
  (helm-projectile . [(20150207 237) ((helm (1 4 0)) (projectile (0 11 0)) (dash (1 5 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (hexrgb . [(20150104 2217) nil "Functions to manipulate colors, including RGB hex strings." single ((:url . "http://www.emacswiki.org/hexrgb.el") (:keywords "number" "hex" "rgb" "color" "background" "frames" "display")) "melpa"])
  ...
  (hindent . [(20150120 615) ((cl-lib (0 5))) "Indent haskell code using the \"hindent\" program" single ((:url . "https://github.com/chrisdone/hindent")) "melpa"])
  ...
  (history . [(20150212 2004) ((emacs (24 3))) "History utility for source code navigation" tar ((:url . "https://github.com/boyw165/history")) "melpa"])
  ...
  (hl-anything . [(20150211 1950) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more." tar nil "melpa"])
  ...
  (hydra . [(20150215 723) ((cl-lib (0 5))) "Make bindings that stick around" tar ((:url . "https://github.com/abo-abo/hydra") (:keywords "bindings")) "melpa"])
  ...
  (icicles . [(20150208 1710) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (idris-mode . [(20150215 1244) ((emacs (24))) "Major mode for editing Idris code" tar ((:url . "https://github.com/idris-hackers/idris-mode") (:keywords "languages")) "melpa"])
  ...
  (image-archive . [(20141229 1934) ((emacs (24)) (cl-lib (0 5))) "Image thumbnails in archive file with non-blocking" single ((:url . "https://github.com/mhayashi1120/Emacs-image-archive/raw/master/image-archive.el") (:keywords "multimedia")) "melpa"])
  (image-dired+ . [(20150125 414) ((cl-lib (0 3))) "Image-dired extensions" single ((:url . "https://github.com/mhayashi1120/Emacs-image-diredx/raw/master/image-dired+.el") (:keywords "extensions" "multimedia")) "melpa"])
  ...
  (indent-guide . [(20150116 2012) nil "show vertical lines to guide indentation" single ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (inf-ruby . [(20150208 2313) nil "Run a Ruby process in a buffer" single ((:url . "http://github.com/nonsequitur/inf-ruby") (:keywords "languages" "ruby")) "melpa"])
  ...
  (irony . [(20150215 1357) ((cl-lib (0 5)) (json (1 2))) "C/C++ minor mode powered by libclang" tar ((:url . "https://github.com/Sarcasm/irony-mode") (:keywords "c" "convenience" "tools")) "melpa"])
  ...
  (isearch+ . [(20150105 10) nil "Extensions to `isearch.el' (incremental search)." single ((:url . "http://www.emacswiki.org/isearch+.el") (:keywords "help" "matching" "internal" "local")) "melpa"])
  ...
  (isearch-prop . [(20150105 12) nil "Search text-property or overlay-property contexts." single ((:url . "http://www.emacswiki.org/isearch-prop.el") (:keywords "search" "matching" "invisible" "thing" "help")) "melpa"])
  ...
  (jedi . [(20150203 706) ((epc (0 1 0)) (auto-complete (1 4)) (python-environment (0 0 2))) "Python auto-completion for Emacs" tar nil "melpa"])
  ...
  (jg-quicknav . [(20150212 744) ((s (1 9 0)) (cl-lib (0 5))) "Quickly navigate the file system to find a file." single ((:url . "https://github.com/jeffgran/jg-quicknav") (:keywords "navigation")) "melpa"])
  ...
  (js2-mode . [(20150207 1027) ((emacs (24 1)) (cl-lib (0 5))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (kaesar . [(20150130 804) ((cl-lib (0 3))) "Another AES algorithm encrypt/decrypt string with password." single ((:url . "https://github.com/mhayashi1120/Emacs-kaesar/raw/master/kaesar.el") (:keywords "data")) "melpa"])
  ...
  (kaesar-mode . [(20150130 804) ((kaesar (0 1 4)) (cl-lib (0 3))) "Encrypt/Decrypt buffer by AES with password." single ((:url . "https://github.com/mhayashi1120/Emacs-kaesar/raw/master/cipher/kaesar-mode.el") (:keywords "data" "convenience")) "melpa"])
  ...
  (keyset . [(20150109 2039) ((dash (2 8 0)) (cl-lib (0 5))) "A small library for structuring key bindings." single nil "melpa"])
  ...
  (lentic . [(20150216 722) ((emacs (24 4)) (m-buffer (0 9)) (dash (2 5 0)) (f (0 17 2))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (leuven-theme . [(20150213 522) nil "Awesome Emacs color theme on white background" single ((:url . "https://github.com/fniessen/emacs-leuven-theme") (:keywords "color" "theme")) "melpa"])
  ...
  (linum-relative . [(20140731 730) nil "display relative line number in emacs." single ((:url . "http://github.com/coldnew/linum-relative") (:keywords "converience")) "melpa"])
  ...
  (lispy . [(20150216 728) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0)) (hydra (0 4 1)) (ace-window (0 7 0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (load-relative . [(20141216 1331) nil "relative file load (within a multi-file Emacs package)" tar ((:url . "http://github.com/rocky/emacs-load-relative") (:keywords "internal")) "melpa"])
  ...
  (loc-changes . [(20141216 1346) nil "Helps users and programs keep track of positions even after buffer changes." single ((:url . "http://github.com/rocky/emacs-loc-changes")) "melpa"])
  ...
  (lua-mode . [(20141025 1746) nil "a major-mode for editing Lua scripts" single ((:url . "http://immerrr.github.com/lua-mode") (:keywords "languages" "processes" "tools")) "melpa"])
  (lui . [(20150129 40) ((tracking (0))) "Linewise User Interface" tar nil "melpa"])
  ...
  (malabar-mode . [(20150115 1017) ((fringe-helper (1 0 1))) "JVM Integration mode for EMACS" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "groovy" "language" "malabar")) "melpa"])
  ...
  (mc-extras . [(20150122 2118) ((multiple-cursors (1 2 1))) "Extra functions for multiple-cursors mode." tar ((:url . "https://github.com/knu/mc-extras.el") (:keywords "editing" "cursors")) "melpa"])
  ...
  (minitest . [(20150211 617) ((dash (1 0 0))) "An Emacs mode for ruby minitest files" tar ((:url . "https://github.com/arthurnn/minitest-emacs")) "melpa"])
  ...
  (mpv . [(20150216 1030) ((cl-lib (0 5)) (emacs (24)) (json (1 3)) (names (0 5 4)) (org (8 0))) "control mpv for easy note-taking" single ((:url . "https://github.com/kljohann/mpv.el") (:keywords "tools" "multimedia")) "melpa"])
  ...
  (multi-term . [(20141203 1658) nil "Managing multiple terminal buffers in Emacs." single ((:url . "http://www.emacswiki.org/emacs/download/multi-term.el") (:keywords "term" "terminal" "multiple buffer")) "melpa"])
  ...
  (neotree . [(20150206 1900) nil "A tree plugin like NerdTree for Vim" tar ((:url . "https://github.com/jaypei/emacs-neotree")) "melpa"])
  ...
  (niflheim-theme . [(20150118 1422) nil "A port of the Nifleim theme to Emacs" single ((:url . "https://github.com/niflheim-theme/emacs") (:keywords "themes")) "melpa"])
  ...
  (ob-cypher . [(20150214 1525) ((s (1 9 0)) (cypher-mode (0 0 6)) (dash (2 10 0)) (dash-functional (1 2 0))) "query neo4j using cypher in org-mode blocks" single ((:url . "http://github.com/zweifisch/ob-cypher") (:keywords "org" "babel" "cypher" "neo4j")) "melpa"])
  ...
  (org-cliplink . [(20150117 739) nil "insert org-mode link for URL from the clipboard" single ((:url . "http://github.com/rexim/org-cliplink")) "melpa"])
  ...
  (org-pomodoro . [(20150216 1312) ((alert (0 5 10))) "Pomodoro implementation for org-mode." tar nil "melpa"])
  ...
  (org-projectile . [(20150130 1414) ((projectile (0 11 0))) "Repository todo management for org-mode" single ((:url . "https://github.com/IvanMalison/org-projectile") (:keywords "org" "projectile" "todo")) "melpa"])
  ...
  (org-tree-slide . [(20150214 2330) nil "A presentation tool for org-mode" single ((:keywords "org-mode" "presentation" "narrowing")) "melpa"])
  ...
  (page-break-lines . [(20141228 1130) nil "Display ugly ^L page breaks as tidy horizontal lines" single ((:url . "https://github.com/purcell/page-break-lines") (:keywords "convenience" "faces")) "melpa"])
  ...
  (pandoc-mode . [(20150205 648) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (paredit . [(20150213 1427) nil "minor mode for editing parentheses" single ((:keywords "lisp")) "melpa"])
  ...
  (pbcopy . [(20150114 303) nil "Emacs Interface to pbcopy" single ((:url . "https://github.com/jkp/pbcopy.el") (:keywords "mac" "osx" "pbcopy")) "melpa"])
  ...
  (persp-mode . [(20150104 527) nil "\"perspectives\" + save/load + shared among frames - bugs." single ((:url . "https://github.com/Bad-ptr/persp-mode.el") (:keywords "perspectives" "session")) "melpa"])
  (persp-projectile . [(20141207 115) ((perspective (1 9)) (projectile (0 11 0)) (cl-lib (0 3))) "Perspective integration with Projectile" single ((:keywords "project" "convenience")) "melpa"])
  ...
  (phi-search-mc . [(20150122 2209) ((phi-search (2 0 0)) (multiple-cursors (1 2 1))) "multiple-cursors extension for phi-search" single ((:url . "https://github.com/knu/phi-search-mc.el") (:keywords "search" "cursors")) "melpa"])
  ...
  (picolisp-mode . [(20150211 1951) nil "Major mode for PicoLisp programming." single ((:url . "https://github.com/flexibeast/picolisp-mode") (:keywords "picolisp" "lisp" "programming")) "melpa"])
  ...
  (pos-tip . [(20141122 512) nil "Show tooltip at point" single ((:keywords "tooltip")) "melpa"])
  ...
  (processing-mode . [(20141016 1321) nil "Major mode for Processing 2.0" single ((:url . "https://github.com/ptrv/processing2-emacs") (:keywords "languages" "snippets")) "melpa"])
  ...
  (projectile . [(20150216 843) ((dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20150216 835) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0)) (rake (0 3 2))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (pungi . [(20150215 915) ((jedi (0 2 0 -3 2)) (pyvenv (1 5))) "Integrates jedi with virtualenv and buildout python environments" single ((:keywords "convenience")) "melpa"])
  ...
  (purpose . [(20150215 1017) ((cl-lib (0 5)) (let-alist (1 0 3))) "Handle buffers and windows by their purposes" tar ((:url . "https://github.com/bmag/emacs-purpose") (:keywords "frames")) "melpa"])
  ...
  (python-mode . [(20150210 143) nil "Python major mode" tar nil "melpa"])
  (pyvenv . [(20150110 421) nil "Python virtual environment interface" single ((:url . "http://github.com/jorgenschaefer/pyvenv") (:keywords "python" "virtualenv" "tools")) "melpa"])
  ...
  (quickrun . [(20150128 1525) ((emacs (24)) (cl-lib (0 5))) "Run commands quickly" single ((:url . "https://github.com/syohex/emacs-quickrun")) "melpa"])
  ...
  (racket-mode . [(20150213 1416) ((emacs (24 3)) (dash (2 10 0)) (faceup (0 0 2)) (s (1 9 0))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (realgud . [(20150213 1824) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (robe . [(20150126 808) ((inf-ruby (2 3 0))) "Code navigation, documentation lookup and completion for Ruby" tar ((:url . "https://github.com/dgutov/robe") (:keywords "ruby" "convenience" "rails")) "melpa"])
  ...
  (rtags . [(20150214 1033) nil "No description available." tar nil "melpa"])
  ...
  (rust-mode . [(20150215 1646) nil "A major emacs mode for editing Rust source code" single ((:url . "https://github.com/rust-lang/rust") (:keywords "languages")) "melpa"])
  ...
  (sage-shell-mode . [(20150126 1652) ((cl-lib (0 5)) (deferred (0 3 1))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (seethru . [(20150111 1929) ((shadchen (1 4))) "Easily change Emacs' transparency" single ((:url . "http://github.com/benaiah/seethru") (:keywords "lisp" "tools" "alpha" "transparency")) "melpa"])
  ...
  (shell-toggle . [(20150105 2241) nil "Toggle to and from the shell buffer" single ((:url . "https://github.com/knu/shell-toggle.el") (:keywords "processes")) "melpa"])
  ...
  (shm . [(20150205 1544) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (simplenote2 . [(20150216 543) ((request-deferred (0 2 0))) "Interact with simple-note.appspot.com" single ((:keywords "simplenote")) "melpa"])
  ...
  (slime . [(20150212 314) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (smartparens . [(20150214 1019) ((cl-lib (0 3)) (dash (2 10 0))) "Automatic insertion, wrapping and paredit-like navigation with user defined pairs." tar nil "melpa"])
  ...
  (smotitah . [(20141023 1218) nil "Modular emacs configuration framework" tar nil "melpa"])
  ...
  (solarized-theme . [(20150211 935) ((dash (2 6 0))) "The Solarized color theme, ported to Emacs." tar nil "melpa"])
  ...
  (sparql-mode . [(20150212 205) nil "Edit and interactively evaluate SPARQL queries." tar ((:url . "https://github.com/ljos/sparql-mode")) "melpa"])
  ...
  (srefactor . [(20150216 956) nil "A refactoring tool based on Semantic parser framework" tar ((:keywords "c" "languages" "tools")) "melpa"])
  ...
  (sublime-themes . [(20141011 1134) nil "A collection of themes based on Sublime Text" tar ((:keywords "faces")) "melpa"])
  (sublimity . [(20140831 2216) nil "smooth-scrolling, minimap and distraction-free mode" tar ((:url . "http://hins11.yu-yake.com/")) "melpa"])
  ...
  (sunshine . [(20150207 940) ((cl-lib (0 5))) "Provide weather and forecast information." single ((:url . "https://github.com/aaronbieber/sunshine.el") (:keywords "tools" "weather")) "melpa"])
  ...
  (swift-mode . [(20150204 1317) ((emacs (24 1))) "Major-mode for Apple's Swift programming language." single ((:keywords "languages" "swift")) "melpa"])
  ...
  (sx . [(20150214 1631) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tramp-hdfs . [(20150206 555) nil "Tramp access functions for hdfs file system" single ((:keywords "tramp" "emacs" "hdfs" "hadoop")) "melpa"])
  ...
  (unicode-fonts . [(20140812 735) ((font-utils (0 7 2)) (ucs-utils (0 8 0)) (list-utils (0 4 2)) (persistent-soft (0 8 8)) (pcache (0 2 3))) "Configure Unicode fonts" single ((:url . "http://github.com/rolandwalker/unicode-fonts") (:keywords "i18n" "faces" "frames" "wp" "interface")) "melpa"])
  ...
  (unify-opening . [(20150213 929) ((emacs (24 4))) "Make everything use the same mechanism to open files" single ((:url . "https://github.com/DamienCassou/unify-opening") (:keywords "dired" "org" "mu4e" "open" "runner" "extension" "file")) "melpa"])
  ...
  (wandbox . [(20150110 57) ((emacs (24)) (json (1 3))) "Wandbox API Library for Emacs" single ((:url . "https://github.com/kosh04/emacs-wandbox") (:keywords "c" "programming" "tools")) "melpa"])
  (wanderlust . [(20150211 509) ((semi (1 14 7))) "Yet Another Message Interface on Emacsen" tar nil "melpa"])
  ...
  (web-mode . [(20150214 137) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (youdao-dictionary . [(20150205 1149) ((popup (0 5 0)) (chinese-word-at-point (0 2)) (names (0 5)) (emacs (24))) "Youdao Dictionary interface for Emacs" single ((:url . "https://github.com/xuchunyang/youdao-dictionary.el") (:keywords "convenience" "chinese" "dictionary")) "melpa"])
  ...
  (org . [(20150216) nil "Outline-based notes management and organizer" tar nil "gnu"])
