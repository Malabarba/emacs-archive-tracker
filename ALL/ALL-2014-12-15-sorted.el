'(
  ...
  (ac-html . [(20141211 109) ((auto-complete (1 4))) "auto complete source for html tags and attributes" tar ((:url . "https://github.com/cheunghy/ac-html") (:keywords "html" "auto-complete" "rails" "ruby")) "melpa"])
  ...
  (ag . [(20141204 1045) ((dash (2 8 0)) (s (1 9 0))) "A front-end for ag ('the silver searcher'), the C ack replacement." single nil "melpa"])
  ...
  (alchemist . [(20141214 421) ((emacs (24))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  (alect-themes . [(20141129 2323) nil "Configurable color themes (light, dark and black) for Emacs 24" tar nil "melpa"])
  (alert . [(20141112 1044) ((gntp (0 1))) "Growl-style notification system for Emacs" single ((:url . "https://github.com/jwiegley/alert") (:keywords "notification" "emacs" "message")) "melpa"])
  ...
  (android-mode . [(20141210 1150) nil "Minor mode for Android application development" single ((:url . "https://github.com/remvee/android-mode") (:keywords "tools" "processes")) "melpa"])
  ...
  (async . [(20141001 151) nil "Asynchronous processing in Emacs" tar nil "melpa"])
  ...
  (bind-key . [(20140620 1343) nil "A simple way to manage personal keybindings" single ((:url . "https://github.com/jwiegley/use-package") (:keywords "keys" "keybinding" "config" "dotemacs")) "melpa"])
  ...
  (bookmark+ . [(20141205 319) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (cider . [(20141208 941) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (circe . [(20141212 241) ((lui (0)) (lcs (0))) "Client for IRC in Emacs" tar nil "melpa"])
  ...
  (clj-refactor . [(20141125 1556) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 8 1))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (clojure-mode . [(20141212 720) ((emacs (24 1))) "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "clojure" "clojurescript" "lisp")) "melpa"])
  ...
  (clojure-quick-repls . [(20141209 310) ((cider (0 8 1))) "Quickly create Clojure and ClojureScript repls for a project." single ((:url . "https://github.com/symfrog/clojure-quick-repls") (:keywords "languages" "clojure" "cider" "clojurescript")) "melpa"])
  ...
  (coffee-mode . [(20141207 500) ((emacs (24 1)) (cl-lib (0 5))) "Major mode to edit CoffeeScript files in Emacs" single ((:url . "http://github.com/defunkt/coffee-mode") (:keywords "coffeescript" "major" "mode")) "melpa"])
  ...
  (color-moccur . [(20141108 1730) nil "multi-buffer occur (grep) mode" single ((:url . "http://www.bookshelf.jp/elc/color-moccur.el") (:keywords "convenience")) "melpa"])
  ...
  (company . [(20141214 1155) ((emacs (24 1)) (cl-lib (0 5))) "Modular text completion framework" tar ((:url . "http://company-mode.github.io/") (:keywords "abbrev" "convenience" "matching")) "melpa"])
  ...
  (company-ycmd . [(20141208 2350) ((ycmd (0 1)) (company (0 8 3)) (deferred (0 2 0)) (s (1 0 0))) "company-mode backend for ycmd" single ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
  ...
  (cpputils-cmake . [(20141209 1737) nil "Easy real time C++ syntax check and intellisense if you use CMake" tar nil "melpa"])
  ...
  (csharp-mode . [(20141204 2302) nil "C# mode derived mode" tar ((:url . "https://github.com/josteink/csharp-mode") (:keywords "c#" "languages" "oop" "mode")) "melpa"])
  ...
  (dash . [(20141210 817) nil "A modern list library for Emacs" single ((:keywords "lists")) "melpa"])
  ...
  (diff-hl . [(20141212 1040) ((cl-lib (0 2))) "Highlight uncommitted changes" tar ((:url . "https://github.com/dgutov/diff-hl") (:keywords "vc" "diff")) "melpa"])
  ...
  (dired-filter . [(20141207 1059) ((dash (2 10 0)) (dired-hacks-utils (0 0 1))) "Ibuffer-like filtering for dired" single ((:keywords "files")) "melpa"])
  ...
  (drupal-mode . [(20141116 515) ((php-mode (1 5 0))) "Advanced minor mode for Drupal development" tar ((:url . "https://github.com/arnested/drupal-mode") (:keywords "programming" "php" "drupal")) "melpa"])
  ...
  (e2wm . [(20141118 43) ((window-layout (1 2))) "simple window manager for emacs" tar ((:keywords "tools" "window manager")) "melpa"])
  ...
  (ebib . [(20141214 1224) ((dash (2 5 0)) (emacs (24 3))) "a BibTeX database manager" tar ((:keywords "text" "bibtex")) "melpa"])
  ...
  (elisp-slime-nav . [(20141120 1509) ((cl-lib (0 2))) "Make M-. and M-, work in elisp like they do in slime" single ((:url . "https://github.com/purcell/elisp-slime-nav") (:keywords "navigation" "slime" "elisp" "emacs-lisp")) "melpa"])
  (elixir-mix . [(1 0 0) nil "Emacs integration for Elixir's mix" single "marmalade"])
  (elixir-mode . [(20141213 943) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (elscreen-persist . [(20141212 1) ((elscreen (1 4 6)) (revive (2 19))) "persist the elscreen across sessions" single ((:keywords "elscreen" "frames")) "melpa"])
  ...
  (emacsql . [(20141206 1123) ((emacs (24 3)) (cl-lib (0 3)) (finalize (1 0 0)) (pg (0 12))) "high-level SQL database front-end" tar ((:url . "https://github.com/skeeto/emacsql")) "melpa"])
  ...
  (emmet-mode . [(20141126 548) nil "Unofficial Emmet's support for emacs" single ((:url . "https://github.com/smihica/emmet-mode") (:keywords "convenience")) "melpa"])
  ...
  (ensime . [(20141212 2054) ((s (1 3 0)) (dash (2 8 0)) (popup (0 5 0)) (auto-complete (1 4 0)) (scala-mode2 (0 21)) (sbt-mode (0 3))) "ENhanced Scala Interaction Mode for Emacs" tar nil "melpa"])
  ...
  (es-mode . [(20141209 352) nil "A major mode for editing Elasticsearch queries" tar ((:url . "http://www.github.com/dakrone/es-mode") (:keywords "elasticsearch")) "melpa"])
  ...
  (evil . [(20141211 1233) ((undo-tree (0 6 3)) (goto-chg (1 6))) "Extensible Vi layer for Emacs." tar nil "melpa"])
  ...
  (evil-iedit-state . [(20141212 1950) ((evil (1 0 9)) (iedit (0 97))) "Evil states to interface iedit mode." single ((:url . "https://github.com/syl20bnr/evil-iedit-state") (:keywords "convenience" "editing" "evil" "iedit" "mnemonic")) "melpa"])
  ...
  (evil-jumper . [(20141213 1242) ((evil (0))) "Jump like vimmers do!" single ((:url . "https://github.com/bling/evil-jumper") (:keywords "evil" "vim" "jumplist" "jump" "list")) "melpa"])
  ...
  (expand-region . [(20141209 1857) nil "Increase selected region by semantic units." tar nil "melpa"])
  ...
  (find-file-in-project . [(20140603 1619) nil "Find files in a project quickly." single ((:url . "http://www.emacswiki.org/cgi-bin/wiki/FindFileInProject") (:keywords "project" "convenience")) "melpa"])
  (find-file-in-repository . [(20140920 1914) nil "Quickly find files in a git, mercurial or other repository" single ((:url . "https://github.com/hoffstaetter/find-file-in-repository") (:keywords "files" "convenience" "repository" "project" "source control")) "melpa"])
  ...
  (fingers . [(20141210 2313) nil "Modal editing with universal text manipulation helpers." tar ((:url . "http://github.com/fgeller/fingers.el") (:keywords "fingers" "modal" "editing" "workman")) "melpa"])
  ...
  (flycheck . [(20141212 1359) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://www.flycheck.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (flycheck-ocaml . [(20141210 436) ((emacs (24 1)) (flycheck (0 22 -3 1)) (merlin (2 0))) "Flycheck: OCaml support" single ((:url . "https://github.com/flycheck/flycheck-ocaml") (:keywords "convenience" "tools" "languages")) "melpa"])
  ...
  (flycheck-rust . [(20141211 129) ((emacs (24 1)) (flycheck (0 20)) (dash (2 4 0))) "Flycheck: Rust additions and Cargo support" single ((:url . "https://github.com/flycheck/flycheck-rust") (:keywords "tools" "convenience")) "melpa"])
  ...
  (fountain-mode . [(20141214 526) ((s (1 9 0))) "Major mode for screenwriting in Fountain markup" single ((:url . "https://github.com/rnkn/fountain-mode") (:keywords "wp")) "melpa"])
  ...
  (function-args . [(20141213 611) nil "C++ completion for GNU Emacs" single ((:url . "https://github.com/abo-abo/function-args")) "melpa"])
  ...
  (git-gutter . [(20141112 2120) ((cl-lib (0 5)) (emacs (24))) "Port of Sublime Text plugin GitGutter" single ((:url . "https://github.com/syohex/emacs-git-gutter")) "melpa"])
  ...
  (go-eldoc . [(20141202 555) ((go-mode (0)) (cl-lib (0 5))) "eldoc for go-mode" single ((:url . "https://github.com/syohex/emacs-go-eldoc")) "melpa"])
  ...
  (haskell-mode . [(20141213 848) ((cl-lib (0 5))) "A Haskell editing mode" tar nil "melpa"])
  ...
  (helm . [(20141214 1045) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-bibtex . [(20141214 1529) ((helm (1 5 5)) (parsebib (1 0)) (s (1 9 0)) (dash (2 6 0)) (f (0 16 2)) (cl-lib (0 5))) "Helm source for managing BibTeX bibliographies" single nil "melpa"])
  ...
  (helm-cmd-t . [(20141206 1717) nil "cmd-t style completion" tar ((:url . "https://github.com/lewang/helm-cmd-t") (:keywords "helm" "project-management" "completion" "convenience" "cmd-t" "textmate")) "melpa"])
  ...
  (helm-dash . [(20141208 623) ((helm (0 0 0))) "Offline documentation browser for +150 APIs using Dash docsets." single ((:url . "http://github.com/areina/helm-dash") (:keywords "docs")) "melpa"])
  ...
  (helm-projectile . [(20141208 716) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (helm-w32-launcher . [(20141214 1259) ((emacs (24)) (helm (1 6 5)) (cl-lib (0 5))) "Start Menu entry launcher using Helm" tar ((:url . "https://github.com/Fanael/helm-w32-launcher")) "melpa"])
  ...
  (hy-mode . [(20141208 630) nil "Major mode for Hy code" single ((:url . "http://github.com/hylang/hy-mode") (:keywords "languages" "lisp")) "melpa"])
  ...
  (icicles . [(20141212 1621) nil "Minibuffer input completion and cycling." tar ((:url . "http://www.emacswiki.org/icicles.el") (:keywords "extensions" "help" "abbrev" "local" "minibuffer" "keys" "apropos" "completion" "matching" "regexp" "command")) "melpa"])
  ...
  (imenu-anywhere . [(20141210 1850) ((cl-lib (0 5))) "ido/helm imenu tag selection across all buffers with the same mode" single ((:url . "https://github.com/vitoshka/imenu-anywhere") (:keywords "ido" "imenu" "tags")) "melpa"])
  ...
  (inf-clojure . [(20141212 710) ((emacs (24 1)) (clojure-mode (4 0))) "an inferior-clojure mode" single ((:url . "http://github.com/clojure-emacs/inf-clojure") (:keywords "processes" "clojure")) "melpa"])
  ...
  (irony . [(20141208 1543) ((cl-lib (0 5)) (json (1 2))) "C/C++ minor mode powered by libclang" tar ((:url . "https://github.com/Sarcasm/irony-mode") (:keywords "c" "convenience" "tools")) "melpa"])
  ...
  (javadoc-lookup . [(20141025 1524) nil "Javadoc Emacs integration with Maven" tar ((:url . "https://github.com/skeeto/javadoc-lookup")) "melpa"])
  ...
  (js2-mode . [(20141206 2147) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  (js2-refactor . [(20141201 1217) ((js2-mode (20101228)) (s (1 9 0)) (multiple-cursors (1 0 0)) (dash (1 0 0)) (s (1 0 0)) (yasnippet (20130218))) "A JavaScript refactoring library for emacs." tar nil "melpa"])
  ...
  (julia-mode . [(20141212 253) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (ledger-mode . [(20141214 828) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  (leerzeichen . [(20141213 1031) nil "Minor mode to display whitespace characters." single ((:url . "http://github.com/fgeller/leerzeichen.el") (:keywords "whitespace" "characters")) "melpa"])
  ...
  (lentic . [(20141214 1334) ((emacs (24)) (m-buffer (0 8)) (dash (2 5 0))) "One buffer as a view of another" tar nil "melpa"])
  ...
  (lispy . [(20141214 1316) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (noflet (0 0 10)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (load-relative . [(20141115 1930) nil "relative file load (within a multi-file Emacs package)" tar ((:url . "http://github.com/rocky/emacs-load-relative") (:keywords "internal")) "melpa"])
  ...
  (m-buffer . [(20141210 1433) ((dash (2 8 0)) (emacs (24 3))) "List-Oriented, Functional Buffer Manipulation" tar nil "melpa"])
  ...
  (magit-gh-pulls . [(20141128 1143) ((emacs (24)) (gh (0 4 3)) (magit (1 1 0)) (pcache (0 2 3)) (s (1 6 1))) "GitHub pull requests extension for Magit" single ((:url . "https://github.com/sigma/magit-gh-pulls") (:keywords "tools")) "melpa"])
  ...
  (malabar-mode . [(20141212 716) ((fringe-helper (1 0 1))) "A better Java mode for Emacs" tar ((:url . "http://www.github.com/m0smith/malabar-mode") (:keywords "java" "maven" "language" "malabar")) "melpa"])
  (malinka . [(20141213 432) ((s (1 9 0)) (dash (2 4 0)) (f (0 11 0)) (cl-lib (0 3)) (rtags (0 0)) (projectile (0 11 0))) "A C/C++ project configuration package for Emacs" single ((:url . "https://github.com/LefterisJP/malinka") (:keywords "c" "c++" "project-management")) "melpa"])
  ...
  (mandoku . [(20141207 1743) ((org (8 0))) "A tool to access repositories of premodern Chinese texts" tar nil "melpa"])
  (mandoku-meta-zb . [(20141210 2311) ((org (8)) (mandoku (0 5))) "Metadata for the ZB repository to be used by Mandoku" tar ((:url . "http://www.mandoku.org") (:keywords "convenience")) "melpa"])
  ...
  (maven-test-mode . [(20141209 754) ((s (1 9)) (emacs (24))) "Utilities for navigating test files and running maven test tasks." single ((:url . "http://github.com/rranelli/maven-test-mode") (:keywords "java" "maven" "test")) "melpa"])
  ...
  (merlin . [(20141210 952) nil "Mode for Merlin, an assistant for OCaml." tar ((:url . "http://github.com/the-lambda-church/merlin") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (moe-theme . [(20141213 1940) nil "A colorful eye-candy theme. Moe, moe, kyun!" tar nil "melpa"])
  ...
  (multiple-cursors . [(20141026 503) nil "Multiple cursors for Emacs." tar nil "melpa"])
  ...
  (niflheim-theme . [(20141209 1508) nil "A port of the Nifleim theme to Emacs" single ((:url . "https://github.com/niflheim-theme/emacs") (:keywords "themes")) "melpa"])
  ...
  (org . [(20141208) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-autolist . [(20141213 1007) nil "Improved list management in org-mode" single ((:url . "https://github.com/calvinwyoung/org-autolist") (:keywords "lists" "checklists" "org-mode")) "melpa"])
  ...
  (org-cliplink . [(20141208 2246) nil "insert org-mode link for URL from the clipboard" single ((:url . "http://github.com/rexim/org-cliplink")) "melpa"])
  ...
  (org-dropbox . [(20141214 210) ((dash (2 2)) (names (0 5)) (emacs (24))) "move Dropbox notes from phone into org-mode datetree" single ((:url . "https://github.com/heikkil/org-dropbox") (:keywords "dropbox" "android" "notes" "org-mode")) "melpa"])
  ...
  (org-journal . [(20141210 238) nil "a simple org-mode based journaling mode" single ((:url . "http://github.com/bastibe/org-journal")) "melpa"])
  ...
  (org-octopress . [(20141026 1700) ((org (8 0)) (orglue (0 1)) (ctable (0 1 1))) "Compose octopress articles using org-mode." tar ((:keywords "org" "jekyll" "octopress" "blog")) "melpa"])
  ...
  (org-projectile . [(20141209 2157) ((projectile (0 11 0)) (org (8 2 4))) "Repository todo management for org-mode" single ((:url . "https://github.com/IvanMalison/org-projectile") (:keywords "org" "projectile" "todo")) "melpa"])
  ...
  (org2blog . [(20141201 735) ((org (8 1)) (xml-rpc (1 6 8)) (metaweblog (0 1))) "Blog from Org mode to wordpress" tar nil "melpa"])
  ...
  (orgtbl-aggregate . [(20141210 1433) nil "Create an aggregated Org table from another one" tar ((:keywords "org" "table" "aggregation" "filtering")) "melpa"])
  ...
  (outorg . [(20141213 143) nil "Org-style comment editing" single ((:url . "https://github.com/tj64/outorg")) "melpa"])
  (outshine . [(20141213 148) ((outorg (2 0))) "outline with outshine outshines outline" single ((:url . "https://github.com/tj64/outshine")) "melpa"])
  ...
  (package-build . [(20141108 559) ((cl-lib (0 2))) "Tools for assembling a package archive" single ((:keywords "tools")) "melpa"])
  ...
  (pallet . [(20141029 1328) ((cask (0 6))) "A package management tool for Emacs, using Cask." tar nil "melpa"])
  (pandoc-mode . [(20141205 401) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (paradox . [(20141214 934) ((emacs (24 1)) (dash (2 6 0)) (cl-lib (0 5)) (json (1 3))) "A modern Packages Menu. Colored, with package ratings, and customizable." tar ((:url . "http://github.com/Bruce-Connor/paradox") (:keywords "package" "packages" "mode-line")) "melpa"])
  ...
  (parsebib . [(20141214 1222) ((emacs (24 3))) "A library for parsing bib files" single ((:keywords "text" "bibtex")) "melpa"])
  ...
  (pophint . [(20141011 732) ((popup (0 5 0)) (log4e (0 2 0)) (yaxception (0 1))) "Provide navigation using pop-up tips, like Firefox's Vimperator Hint Mode" tar ((:url . "https://github.com/aki2o/emacs-pophint") (:keywords "popup")) "melpa"])
  ...
  (popup . [(20141213 541) ((cl-lib (0 3))) "Visual Popup User Interface" single ((:keywords "lisp")) "melpa"])
  ...
  (popup-switcher . [(20140930 542) ((cl-lib (0 3)) (popup (0 5 0))) "switch to other buffers and files via popup." single ((:url . "https://github.com/kostafey/popup-switcher") (:keywords "popup" "switch" "buffers" "functions")) "melpa"])
  ...
  (projectile . [(20141207 2354) ((s (1 6 0)) (f (0 17 1)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (py-test . [(20141210 1527) ((dash (2 9 0)) (f (0 17)) (emacs (24))) "A test runner for Python code." single ((:url . "https://github.com/Bogdanp/py-test.el") (:keywords "python" "testing" "py.test")) "melpa"])
  ...
  (rainbow-delimiters . [(20141209 736) nil "Highlight nested brackets a different color at each depth" single ((:url . "https://github.com/Fanael/rainbow-delimiters") (:keywords "faces" "convenience" "lisp" "tools")) "melpa"])
  ...
  (realgud . [(20141122 1456) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (restclient . [(20141212 329) nil "An interactive HTTP client for Emacs" single ((:keywords "http")) "melpa"])
  ...
  (rich-minority . [(20141208 1201) ((cl-lib (0 5))) "Clean-up and Beautify the list of minor-modes." single ((:url . "http://github.com/Bruce-Connor/rich-minority") (:keywords "mode-line" "faces")) "melpa"])
  ...
  (shell-switcher . [(20141211 734) nil "Provide fast switching between shell buffers" tar ((:url . "https://github.com/DamienCassou/shell-switcher") (:keywords "emacs" "package" "elisp" "shell" "eshell" "term" "switcher")) "melpa"])
  ...
  (slime . [(20141214 1033) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (smart-mode-line . [(20141213 1741) ((emacs (24 3)) (dash (2 2 0)) (rich-minority (0 1))) "A color coded smart mode-line." tar ((:url . "http://github.com/Bruce-Connor/smart-mode-line") (:keywords "mode-line" "faces" "theme" "themes")) "melpa"])
  ...
  (solarized-theme . [(20141210 1408) ((dash (2 6 0))) "The Solarized color theme, ported to Emacs." tar nil "melpa"])
  ...
  (ssh-config-mode . [(20141210 1712) nil "Mode for fontification of ~/.ssh/config" single ((:url . "http://www.mahalito.net/~harley/elisp/ssh-config-mode.el") (:keywords "ssh" "config" "emacs")) "melpa"])
  (stan-mode . [(20141114 1106) nil "Major mode for editing Stan files" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languanges")) "melpa"])
  ...
  (sx . [(20141214 1614) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes." tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tabula-rasa . [(20141207 825) ((emacs (24 4))) "Distraction free writing mode" single ((:url . "https://github.com/idomagal/Tabula-Rasa/blob/master/tabula-rasa.el") (:keywords "distraction free" "writing")) "melpa"])
  ...
  (traad . [(20140910 712) ((deferred (0 3 2)) (popup (0 5 0)) (request (0 2 0)) (request-deferred (0 2 0))) "emacs interface to the traad refactoring server." tar ((:url . "https://github.com/abingham/traad")) "melpa"])
  ...
  (ubuntu-theme . [(20141213 1411) nil "A theme inspired by the default terminal colors in Ubuntu" single ((:url . "http://github.com/rocher/ubuntu-theme")) "melpa"])
  ...
  (use-package . [(20140918 1333) ((bind-key (1 0)) (diminish (0 44))) "A use-package declaration for simplifying your .emacs" single ((:url . "https://github.com/jwiegley/use-package") (:keywords "dotemacs" "startup" "speed" "config" "package")) "melpa"])
  ...
  (vlf . [(20141213 849) nil "View Large Files" tar ((:url . "https://github.com/m00natic/vlfi") (:keywords "large files" "utilities")) "melpa"])
  ...
  (wandbox . [(20141208 1043) ((emacs (24)) (json (1 3))) "Wandbox API Library for Emacs" single ((:url . "https://github.com/kosh04/emacs-wandbox") (:keywords "c" "programming" "tools")) "melpa"])
  ...
  (web-mode . [(20141214 1305) nil "major mode for editing html templates" single ((:url . "http://web-mode.org") (:keywords "html" "template" "javascript" "css" "web" "php" "django" "erb" "jsp")) "melpa"])
  ...
  (yasnippet . [(20141117 327) nil "Yet another snippet extension for Emacs." tar ((:url . "http://github.com/capitaomorte/yasnippet") (:keywords "convenience" "emulation")) "melpa"])
  ...
  (ycmd . [(20141208 2210) ((emacs (24)) (f (0 17 1)) (dash (1 2 0)) (deferred (0 3 2)) (popup (0 5 0))) "emacs bindings to the ycmd completion server" tar ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
