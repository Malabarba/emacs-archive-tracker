...
highlighter, flymake for projects" tar nil "melpa"])
  ...
  (realgud . [(20140630 1740) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
