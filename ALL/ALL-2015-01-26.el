'(
  ...
  (auto-package-update . [(20141222 1048) ((emacs (24 3)) (dash (2 1 0))) "Automatically update Emacs packages." single ((:url . "http://github.com/rranelli/auto-package-update.el") (:keywords "package" "update")) "melpa"])
  ...
  (cider . [(20150125 949) ((clojure-mode (4 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clj-refactor . [(20150104 1358) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2)) (cider (0 8 1))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (edbi-database-url . [(20150115 1101) ((emacs (24)) (edbi (0 1 3))) "Run edbi with database url" single ((:url . "https://github.com/proofit404/edbi-database-url")) "melpa"])
  ...
  (evil-commentary . [(20141220 252) ((evil (1 0 0))) "Comment stuff out. A port of vim-commentary." single ((:url . "http://github.com/linktohack/evil-commentary") (:keywords "evil" "comment" "commentary" "evil-commentary")) "melpa"])
  ...
  (gh . [(20141230 158) ((eieio (1 4)) (pcache (0 2 4)) (logito (0 1))) "A GitHub library for Emacs" tar nil "melpa"])
  ...
  (graphene . [(20141030 219) ((exec-path-from-shell (20140219)) (project-persist (20131030)) (sr-speedbar (20140505)) (smex (20140425)) (web-mode (20140505)) (smartparens (20140427)) (flycheck (20140422)) (company (20140517))) "Friendly Emacs defaults" tar nil "melpa"])
  ...
  (gruvbox-theme . [(20150118 1834) nil "A retro-groove colour theme for Emacs" single ((:url . "http://github.com/Greduan/emacs-theme-gruvbox")) "melpa"])
  ...
  (haskell-emacs . [(20150125 929) nil "write emacs extensions in haskell" tar ((:url . "https://github.com/knupfer/haskell-emacs") (:keywords "haskell" "emacs" "ffi")) "melpa"])
  ...
  (helm-ag . [(20150122 634) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (js2-mode . [(20141230 717) ((emacs (24 1)) (cl-lib (0 5))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (lispy . [(20150124 1513) ((helm (1 5 3)) (ace-jump-mode (2 0)) (s (1 4 0)) (multiple-cursors (1 3 0)) (iedit (0 97)) (highlight (0))) "vi-like Paredit" tar nil "melpa"])
  ...
  (marshal . [(20150104 433) ((eieio (1 4)) (json (1 4))) "eieio extension for automatic (un)marshalling" single ((:url . "https://github.com/sigma/marshal.el") (:keywords "eieio")) "melpa"])
  ...
  (ncl-mode . [(20150125 1253) ((emacs (24))) "Major Mode for editing NCL scripts and other goodies" tar nil "melpa"])
  ...
  (osx-dictionary . [(20150123 2229) ((cl-lib (0 5)) (chinese-word-at-point (0 1))) "Interface for OSX Dictionary.app" tar ((:url . "https://github.com/xuchunyang/osx-dictionary.el") (:keywords "dictionary")) "melpa"])
  ...
  (overseer . [(20150119 2152) ((emacs (24)) (dash (2 10 0)) (pkg-info (0 4))) "Ert-runner Integration Into Emacs" single ((:url . "http://www.github.com/tonini/overseer.el")) "melpa"])
  ...
  (pandoc-mode . [(20150123 757) nil "Minor mode for interacting with Pandoc" tar ((:keywords "text" "pandoc")) "melpa"])
  ...
  (paredit . [(20141206 954) nil "minor mode for editing parentheses" single ((:keywords "lisp")) "melpa"])
  ...
  (projectile . [(20150123 242) ((s (1 6 0)) (f (0 17 1)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  (projectile-rails . [(20150124 726) ((projectile (1 0 0 -3)) (inflections (1 1)) (inf-ruby (2 2 6)) (f (0 13 0)) (rake (0 3 2))) "Minor mode for Rails projects based on projectile-mode" single ((:url . "https://github.com/asok/projectile-rails") (:keywords "rails" "projectile")) "melpa"])
  ...
  (pylint . [(20140729 1117) nil "minor mode for running `pylint'" single ((:keywords "languages" "python")) "melpa"])
  ...
  (racket-mode . [(20150122 2124) ((emacs (24 3))) "Major mode for Racket language." tar ((:url . "https://github.com/greghendershott/racket-mode")) "melpa"])
  ...
  (realgud . [(20150125 1444) ((load-relative (1 0)) (list-utils (0 4 2)) (loc-changes (1 1)) (test-simple (1 0))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (robe . [(20141120 1919) ((inf-ruby (2 3 0))) "Code navigation, documentation lookup and completion for Ruby" tar ((:url . "https://github.com/dgutov/robe") (:keywords "ruby" "convenience" "rails")) "melpa"])
  ...
  (rtags . [(20150112 1522) nil "No description available." tar nil "melpa"])
  ...
  (ruby-electric . [(20150121 539) nil "Minor mode for electrically editing ruby code" single ((:url . "https://github.com/knu/ruby-electric.el") (:keywords "languages" "ruby")) "melpa"])
  ...
  (sage-shell-mode . [(20150125 831) ((cl-lib (0 5)) (deferred (0 3 1))) "A front-end for Sage Math" tar ((:url . "https://github.com/stakemori/sage-shell-mode") (:keywords "sage" "math")) "melpa"])
  ...
  (shm . [(20150125 815) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (sx . [(20150123 1901) ((emacs (24 1)) (cl-lib (0 5)) (json (1 3)) (markdown-mode (2 0)) (let-alist (1 0 3))) "StackExchange client. Ask and answer questions on Stack Overflow, Super User, and the likes" tar ((:url . "https://github.com/vermiculus/sx.el/") (:keywords "help" "hypermedia" "tools")) "melpa"])
  ...
  (tuareg . [(20150125 1019) ((caml (3 12 0 1))) "OCaml mode for Emacs." tar ((:url . "https://github.com/ocaml/tuareg") (:keywords "ocaml" "languages")) "melpa"])
  ...
  (web-mode . [(20150124 248) nil "major mode for editing web templates" single ((:url . "http://web-mode.org") (:keywords "languages")) "melpa"])
  ...
  (ycm . [(20150125 1147) nil "Emacs client for the YouCompleteMe auto-completion server." single ((:keywords "c" "abbrev")) "melpa"])
  ...
  (zotxt . [(20150125 1031) ((request-deferred (0 2 0))) "Tools to integrate emacs with Zotero via the zotxt plugin." tar nil "melpa"])
