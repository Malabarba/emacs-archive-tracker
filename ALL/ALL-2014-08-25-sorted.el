'(
  ...
  (ac-dcd . [(20140814 1332) ((auto-complete (1 3 1)) (flycheck-dmd-dub (0 7))) "Auto Completion source for dcd for GNU Emacs" single ((:url . "http://github.com/atilaneves/ac-dcd") (:keywords "languages")) "melpa"])
  ...
  (anaconda-mode . [(20140821 2300) ((emacs (24)) (json-rpc (0 0 1)) (cl-lib (0 5 0)) (dash (2 6 0)) (f (0 16 2))) "Code navigation, documentation lookup and completion for Python" tar ((:url . "https://github.com/proofit404/anaconda-mode")) "melpa"])
  ...
  (browse-kill-ring . [(20140820 603) nil "interactively insert items from kill-ring" single ((:url . "https://github.com/browse-kill-ring/browse-kill-ring") (:keywords "convenience")) "melpa"])
  ...
  (cider . [(20140824 212) ((clojure-mode (2 0 0)) (cl-lib (0 3)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (clj-refactor . [(20140824 22) ((s (1 8 0)) (dash (2 4 0)) (yasnippet (0 6 1)) (paredit (22)) (multiple-cursors (1 2 2))) "A collection of clojure refactoring functions" single ((:keywords "convenience")) "melpa"])
  ...
  (clojure-mode . [(20140822 755) ((emacs (24 1))) "Major mode for Clojure code" single ((:url . "http://github.com/clojure-emacs/clojure-mode") (:keywords "languages" "clojure" "clojurescript" "lisp")) "melpa"])
  ...
  (d-mode . [(20140813 1033) nil "D Programming Language mode for (X)Emacs" single ((:keywords "d" "programming" "language" "emacs" "cc-mode")) "melpa"])
  ...
  (eide . [(20140819 231) nil "IDE interface" tar nil "melpa"])
  ...
  (el-get . [(20140824 333) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (elixir-mode . [(20140820 1317) nil "Major mode for editing Elixir files" tar ((:url . "https://github.com/elixir-lang/emacs-elixir") (:keywords "languages" "elixir")) "melpa"])
  ...
  (ergoemacs-mode . [(20140823 2212) ((emacs (24 1)) (undo-tree (0 6 5))) "Emacs mode based on common modern interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
  ...
  (flycheck . [(20140824 731) ((dash (2 4 0)) (pkg-info (0 4)) (cl-lib (0 3)) (emacs (24 1))) "Modern on-the-fly syntax checking for GNU Emacs" tar ((:url . "https://flycheck.readthedocs.org") (:keywords "convenience" "languages" "tools")) "melpa"])
  ...
  (git-timemachine . [(20140819 56) ((cl-lib (0 5))) "Walk through git revisions of a file" single ((:url . "https://github.com/pidu/git-timemachine") (:keywords "git")) "melpa"])
  ...
  (helm . [(20140824 57) nil "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-gtags . [(20140820 2325) ((helm (1 5 6)) (cl-lib (0 5))) "GNU GLOBAL helm interface" single ((:url . "https://github.com/syohex/emacs-helm-gtags")) "melpa"])
  ...
  (magit . [(20140816 1125) ((cl-lib (0 3)) (git-commit-mode (0 14 0)) (git-rebase-mode (0 14 0))) "control Git from Emacs" tar ((:keywords "vc" "tools")) "melpa"])
  ...
  (marmalade-service . [(2 0 15) ((dash (1 1 0)) (s (1 6 0)) (kv (0 0 16)) (noflet (0 0 7)) (elnode (0 9 9 8 6)) (file-format (0 0 1)) (htmlize (1 3 9))) "The Marmalade package store service." tar "marmalade"])
  ...
  (org . [(20140818) nil "Outline-based notes management and organizer" tar nil "gnu"])
  ...
  (org-trello . [(20140820 1844) ((s (1 9 0)) (request (0 2 0)) (dash (2 8 0))) "Minor mode to synchronize org-mode buffer and trello board" tar nil "melpa"])
  ...
  (package-utils . [(20140820 618) ((epl (0 7))) "Extensions for package.el" single ((:url . "https://github.com/Silex/package-utils") (:keywords "package" "convenience")) "melpa"])
  ...
  (php-mode . [(20140812 1745) nil "Major mode for editing PHP code" single ((:url . "https://github.com/ejmr/php-mode")) "melpa"])
  ...
  (projectile . [(20140820 317) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (realgud . [(20140820 113) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (shm . [(20140819 336) nil "Structured Haskell Mode" tar ((:keywords "development" "haskell" "structured")) "melpa"])
  ...
  (slime . [(20140822 1604) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (visual-regexp . [(20140824 1705) ((cl-lib (0 2))) "A regexp/replace command for Emacs with interactive visual feedback" single ((:url . "https://github.com/benma/visual-regexp.el/") (:keywords "regexp" "replace" "visual" "feedback")) "melpa"])
  (visual-regexp-steroids . [(20140824 1729) ((visual-regexp (0 8))) "Extends visual-regexp to support other regexp engines" tar ((:url . "https://github.com/benma/visual-regexp-steroids.el/") (:keywords "external" "foreign" "regexp" "replace" "python" "visual" "feedback")) "melpa"])
  ...
  (yaml-mode . [(20140818 1607) nil "Major mode for editing YAML files" single ((:keywords "data" "yaml")) "melpa"])
