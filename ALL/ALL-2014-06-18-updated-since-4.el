'(
  ...
  (ergoemacs-mode . [(20140618 1155) nil "Emacs mode based on common modern software interface and ergonomics." tar ((:url . "https://github.com/ergoemacs/ergoemacs-mode") (:keywords "convenience")) "melpa"])
