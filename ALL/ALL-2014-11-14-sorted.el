'(
  ...
  (alchemist . [(20141111 2208) ((emacs (24)) (pkg-info (0 5))) "Elixir tooling integration into emacs" tar ((:url . "http://www.github.com/tonini/alchemist.el") (:keywords "languages" "mix" "elixir" "elixirc" "hex")) "melpa"])
  ...
  (bookmark+ . [(20141110 312) nil "Bookmark+: extensions to standard library `bookmark.el'." tar ((:url . "http://www.emacswiki.org/bookmark+.el") (:keywords "bookmarks" "bookmark+" "placeholders" "annotations" "search" "info" "url" "w3m" "gnus")) "melpa"])
  ...
  (cider . [(20141113 1508) ((clojure-mode (3 0 0)) (cl-lib (0 5)) (dash (2 4 1)) (pkg-info (0 4)) (emacs (24)) (queue (0 1 1))) "Clojure Integrated Development Environment and REPL" tar ((:url . "http://www.github.com/clojure-emacs/cider") (:keywords "languages" "clojure" "cider")) "melpa"])
  ...
  (cider-profile . [(20141113 1154) ((cider (0 8 0))) "CIDER support for thunknyc/nrepl-profile" single ((:url . "http://github.com/thunknyc/nrepl-profile") (:keywords "cider" "clojure" "profiling")) "melpa"])
  ...
  (company-ghc . [(20141112 741) ((cl-lib (0 5)) (company (0 8 0)) (ghc (4 1 1)) (emacs (24))) "company-mode ghc-mod backend" single ((:url . "https://github.com/iquiw/company-ghc") (:keywords "haskell" "completion")) "melpa"])
  ...
  (el-get . [(20141112 1821) nil "Manage the external elisp bits and pieces you depend upon" tar ((:url . "http://www.emacswiki.org/emacs/el-get") (:keywords "emacs" "package" "elisp" "install" "elpa" "git" "git-svn" "bzr" "cvs" "svn" "darcs" "hg" "apt-get" "fink" "pacman" "http" "http-tar" "emacswiki")) "melpa"])
  ...
  (ess . [(20141113 1318) nil "No description available." tar nil "melpa"])
  ...
  (evil-lisp-state . [(20141110 2027) ((evil (1 0 9)) (smartparens (1 6 1))) "An evil state to navigate Lisp code and modify it with smartparens" single ((:url . "https://github.com/syl20bnr/evil-lisp-state") (:keywords "convenience" "editing" "evil" "smartparens" "lisp" "mnemonic")) "melpa"])
  ...
  (floobits . [(20141113 1107) ((json (1 2)) (highlight (0))) "Floobits plugin for real-time collaborative editing" tar ((:url . "http://github.com/Floobits/floobits-emacs") (:keywords "comm" "tools")) "melpa"])
  ...
  (helm . [(20141112 946) ((emacs (24)) (cl-lib (0 5)) (async (1 2))) "Helm is an Emacs incremental and narrowing framework" tar nil "melpa"])
  ...
  (helm-ag . [(20141110 1901) ((helm (1 5 6)) (cl-lib (0 5))) "the silver searcher with helm interface" single ((:url . "https://github.com/syohex/emacs-helm-ag")) "melpa"])
  ...
  (helm-projectile . [(20141113 18) ((helm (1 4 0)) (projectile (0 11 0)) (cl-lib (0 3))) "Helm integration for Projectile" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (hl-anything . [(20141112 1810) ((emacs (24 3))) "Highlight symbols, selections, enclosing parens and more." single nil "melpa"])
  ...
  (js2-mode . [(20141113 924) ((emacs (24 1))) "Improved JavaScript editing mode" tar ((:url . "https://github.com/mooz/js2-mode/") (:keywords "languages" "javascript")) "melpa"])
  ...
  (julia-mode . [(20141111 353) nil "Major mode for editing Julia source code" single ((:url . "https://github.com/JuliaLang/julia") (:keywords "languages")) "melpa"])
  ...
  (ledger-mode . [(20141111 1854) nil "Helper code for use with the \"ledger\" command-line tool" tar nil "melpa"])
  ...
  (maven-test-mode . [(20141113 808) nil "No description available." single nil "melpa"])
  ...
  (paxedit . [(20141113 1518) ((cl-lib (0 5)) (paredit (23))) "Structured, Context Driven LISP Editing and Refactoring" single ((:url . "https://github.com/promethial/paxedit") (:keywords "lisp" "refactoring" "context")) "melpa"])
  ...
  (projectile . [(20141111 2339) ((s (1 6 0)) (dash (1 5 0)) (pkg-info (0 4))) "Manage and navigate projects in Emacs easily" single ((:url . "https://github.com/bbatsov/projectile") (:keywords "project" "convenience")) "melpa"])
  ...
  (punctuality-logger . [(20141112 749) nil "Punctuality logger for Emacs" single ((:url . "https://gitlab.com/elzair/punctuality-logger") (:keywords "reminder" "calendar")) "melpa"])
  ...
  (realgud . [(20141113 306) ((load-relative (20130410)) (list-utils (20140508)) (loc-changes (20130723)) (test-simple (20130710))) "A modular front-end for interacting with external debuggers" tar ((:url . "http://github.com/rocky/emacs-dbgr")) "melpa"])
  ...
  (scala-outline-popup . [(20141112 1235) ((dash (2 9 0)) (popup (20141106 455)) (scala-mode2 (0 22))) "scala file summary popup" single ((:url . "https://github.com/ancane/scala-outline-popup.el") (:keywords "scala" "structure" "summary")) "melpa"])
  ...
  (slime . [(20141113 1614) ((cl-lib (0 5))) "Superior Lisp Interaction Mode for Emacs" tar ((:url . "https://github.com/slime/slime") (:keywords "languages" "lisp" "slime")) "melpa"])
  ...
  (sly . [(20141110 624) ((emacs (24 3))) "Sylvester the Cat's Common Lisp IDE" tar ((:url . "https://github.com/capitaomorte/sly") (:keywords "languages" "lisp" "sly")) "melpa"])
  ...
  (stan-mode . [(20141113 1711) nil "Major mode for editing Stan files" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languanges")) "melpa"])
  (stan-snippets . [(20141113 1711) ((yasnippet (0 8 0)) (stan-mode (2 5 0))) "Yasnippets for Stan" tar ((:url . "http://github.com/stan-dev/stan-mode") (:keywords "languages")) "melpa"])
  ...
  (ycmd . [(20141111 2150) ((emacs (24)) (anaphora (1 0 0)) (deferred (0 3 2)) (popup (0 5 0))) "emacs bindings to the ycmd completion server" tar ((:url . "https://github.com/abingham/emacs-ycmd")) "melpa"])
